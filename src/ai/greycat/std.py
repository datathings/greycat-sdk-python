...
class std(GreyCat.Library):
	...
	class core:
		...
		class SamplingMode(GreyCat.Enum):
			...
			def create(greycat: GreyCat) -> std.core.SamplingMode:
				return std.core.SamplingMode(greycat.libs_by_name[std.name_].mapped[1])
		@final
		...
		class nodeTimeSingleton(GreyCat.Object):
			...
			def create(greycat: GreyCat, t: std.core.time, v: Any) -> std.core.nodeTimeSingleton:
				return std.core.nodeTimeSingleton(greycat.libs_by_name[std.name_].mapped[4], t, v)
		@final
		...
		class DurationUnit(GreyCat.Enum):
			...
			def create(greycat: GreyCat) -> std.core.DurationUnit:
				return std.core.DurationUnit(greycat.libs_by_name[std.name_].mapped[7])
		@final
		class NodeTimeInfo(GreyCat.Object):
			...
			@staticmethod
			def create(greycat: GreyCat, size: int, from_: std.core.time, to: std.core.time) -> std.core.NodeTimeInfo:
				return std.core.NodeTimeInfo(greycat.libs_by_name[std.name_].mapped[8], size, from_, to)
		@final
		...
		class ErrorCode(GreyCat.Enum):
			...
			def create(greycat: GreyCat) -> std.core.ErrorCode:
				return std.core.ErrorCode(greycat.libs_by_name[std.name_].mapped[14])
		@final
		...
		class TableColumnMeta(GreyCat.Object):
			...
			def create(greycat: GreyCat, type: str, size: int, index: bool, min: Any, max: Any, avg: Any, std: Any) -> std.core.TableColumnMeta:
				return std.core.TableColumnMeta(greycat.libs_by_name[std.name_].mapped[17], type, size, index, min, max, avg, std)
		@final
		...
		class GeoCircle(GreyCat.Object):
			...
			def create(greycat: GreyCat, center: std.core.geo, radius: float) -> std.core.GeoCircle:
				return std.core.GeoCircle(greycat.libs_by_name[std.name_].mapped[21], center, radius)
		@final
		...
		class TensorType(GreyCat.Enum):
			...
			def create(greycat: GreyCat) -> std.core.TensorType:
				return std.core.TensorType(greycat.libs_by_name[std.name_].mapped[26])
		@final
		class TimeZone(GreyCat.Enum):
			...
			def create(greycat: GreyCat) -> std.core.TimeZone:
				return std.core.TimeZone(greycat.libs_by_name[std.name_].mapped[27])
		@final
		class GeoBox(GreyCat.Object):
			...
			def create(greycat: GreyCat, sw: std.core.geo, ne: std.core.geo) -> std.core.GeoBox:
				return std.core.GeoBox(greycat.libs_by_name[std.name_].mapped[28], sw, ne)
		@final
		class Tuple(Generic[__T,__U], GreyCat.Object):
			...
			def x(self) -> T:
				return self._get(self.type_.generated_offsets[0])
			def set_x(self, v: T) -> None:
				self._set(self.type_.generated_offsets[0],v)
			def y(self) -> U:
				return self._get(self.type_.generated_offsets[1])
			def set_y(self, v: U) -> None:
				self._set(self.type_.generated_offsets[1],v)
			@staticmethod
			def create(greycat: GreyCat, x: T, y: U) -> std.core.Tuple[__T, __U]:
				return std.core.Tuple(greycat.libs_by_name[std.name_].mapped[29], x, y)
		@final
		class DatePart(GreyCat.Enum):
			...
			def create(greycat: GreyCat) -> std.core.DatePart:
				return std.core.DatePart(greycat.libs_by_name[std.name_].mapped[30])
		@final
	...
	class runtime:
		...
		class UserGroup(GreyCat.Object):
			...
			def create(greycat: GreyCat, id: int, name: str, activated: bool) -> std.runtime.UserGroup:
				return std.runtime.UserGroup(greycat.libs_by_name[std.name_].mapped[39], id, name, activated)
		@final
		class SecurityEntity(GreyCat.Object):
			...
			def create(greycat: GreyCat, id: int, name: str, activated: bool) -> std.runtime.SecurityEntity:
				return std.runtime.SecurityEntity(greycat.libs_by_name[std.name_].mapped[40], id, name, activated)
		@final
		class PeriodicTask(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, user_id: int, args: str, start: std.core.time, every: std.core.duration) -> std.runtime.PeriodicTask:
				return std.runtime.PeriodicTask(greycat.libs_by_name[std.name_].mapped[41], name, user_id, args, start, every)
		@final
		class License(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, start: std.core.time, end: std.core.time, company: str, max_workers: int, max_memory: int, extra_1: int, extra_2: int, extra_3: int, extra_4: int) -> std.runtime.License:
				return std.runtime.License(greycat.libs_by_name[std.name_].mapped[42], name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4)
		@final
		class StoreStat(GreyCat.Object):
			...
			def create(greycat: GreyCat, capacity_bytes: int, allocated_bytes: int, allocated_ratio: float, remained_bytes: int, remained_ratio: float, used_bytes: int, used_ratio: float, available_bytes: int, available_ratio: float) -> std.runtime.StoreStat:
				return std.runtime.StoreStat(greycat.libs_by_name[std.name_].mapped[43], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio)
		@final
		...
		class Task(GreyCat.Object):
			...
			def create(greycat: GreyCat, user_id: int, task_id: int, mod: str, type: str, fun: str, creation: std.core.time, status: std.runtime.TaskStatus) -> std.runtime.Task:
				return std.runtime.Task(greycat.libs_by_name[std.name_].mapped[45], user_id, task_id, mod, type, fun, creation, status)
		@final
		class OpenIDConnect(GreyCat.Object):
			...
			def create(greycat: GreyCat, url: str, clientId: str) -> std.runtime.OpenIDConnect:
				return std.runtime.OpenIDConnect(greycat.libs_by_name[std.name_].mapped[46], url, clientId)
		@final
		...
		class RuntimeInfo(GreyCat.Object):
			...
			def create(greycat: GreyCat, version: str, arch: str, timezone: std.core.TimeZone, license: std.runtime.License, io_threads: int, bg_threads: int, fg_threads: int, mem_total: int, mem_worker: int, nb_ctx: int, store_stats: std.runtime.StoreStat) -> std.runtime.RuntimeInfo:
				return std.runtime.RuntimeInfo(greycat.libs_by_name[std.name_].mapped[48], version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats)
		@final
		class User(GreyCat.Object):
			...
			def create(greycat: GreyCat, id: int, name: str, activated: bool, full_name: str, email: str, role: str, permissions_flags: int, groups: std.core.Array, groups_flags: int, external: bool) -> std.runtime.User:
				return std.runtime.User(greycat.libs_by_name[std.name_].mapped[49], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external)
		@final
		class System(GreyCat.Object):
			...
			def create(greycat: GreyCat) -> std.runtime.System:
				return std.runtime.System(greycat.libs_by_name[std.name_].mapped[50])
		@final
		...
		class UserRole(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, permissions: std.core.Array) -> std.runtime.UserRole:
				return std.runtime.UserRole(greycat.libs_by_name[std.name_].mapped[53], name, permissions)
		@final
		class SecurityPolicy(GreyCat.Object):
			...
			def create(greycat: GreyCat, entities: std.core.Array, credentials: std.core.Map, roles: std.core.Map, fields: std.runtime.SecurityFields) -> std.runtime.SecurityPolicy:
				return std.runtime.SecurityPolicy(greycat.libs_by_name[std.name_].mapped[54], entities, credentials, roles, fields)
		@final
		...
		class TaskInfo(GreyCat.Object):
			...
			def create(greycat: GreyCat, user_id: int, task_id: int, mod: str, type: str, fun: str, creation: std.core.time, status: std.runtime.TaskStatus, start: std.core.time, progress: float, remaining: std.core.duration, duration: std.core.duration, sub_waiting: int, sub_tasks_all: int) -> std.runtime.TaskInfo:
				return std.runtime.TaskInfo(greycat.libs_by_name[std.name_].mapped[56], user_id, task_id, mod, type, fun, creation, status, start, progress, remaining, duration, sub_waiting, sub_tasks_all)
		@final
		class UserGroupPolicyType(GreyCat.Enum):
			...
			def create(greycat: GreyCat) -> std.runtime.UserGroupPolicyType:
				return std.runtime.UserGroupPolicyType(greycat.libs_by_name[std.name_].mapped[57])
	@final
	class io:
		@final
		class Email(GreyCat.Object):
			...
			def create(greycat: GreyCat, from_: str, subject: str, body: str, body_is_html: bool, to: std.core.Array, cc: std.core.Array, bcc: std.core.Array) -> std.io.Email:
				return std.io.Email(greycat.libs_by_name[std.name_].mapped[58], from_, subject, body, body_is_html, to, cc, bcc)
		@final
		class Smtp(GreyCat.Object):
			...
			def create(greycat: GreyCat, host: str, port: int, mode: std.io.SmtpMode, authenticate: std.io.SmtpAuth, user: str, pass_: str) -> std.io.Smtp:
				return std.io.Smtp(greycat.libs_by_name[std.name_].mapped[59], host, port, mode, authenticate, user, pass_)
		@final
		class CsvFormat(GreyCat.Object):
			...
			def create(greycat: GreyCat, header_lines: int, infer: bool, separator: c_char, string_delimiter: c_char, decimal_separator: c_char, thousands_separator: c_char, columns: std.core.Array) -> std.io.CsvFormat:
				return std.io.CsvFormat(greycat.libs_by_name[std.name_].mapped[60], header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns)
		@final
		class CsvColumnDuration(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, mandatory: bool, unit: std.core.DurationUnit) -> std.io.CsvColumnDuration:
				return std.io.CsvColumnDuration(greycat.libs_by_name[std.name_].mapped[61], name, mandatory, unit)
		@final
		class CsvColumnInteger(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnInteger:
				return std.io.CsvColumnInteger(greycat.libs_by_name[std.name_].mapped[62], name, mandatory)
		@final
		class HttpHeader(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, value: str) -> std.io.HttpHeader:
				return std.io.HttpHeader(greycat.libs_by_name[std.name_].mapped[63], name, value)
		@final
		class SmtpMode(GreyCat.Enum):
			...
			def create(greycat: GreyCat) -> std.io.SmtpMode:
				return std.io.SmtpMode(greycat.libs_by_name[std.name_].mapped[64])
		@final
		class Url(GreyCat.Object):
			...
			def create(greycat: GreyCat, protocol: str, host: str, port: int, path: str, params: std.core.Map, hash: str) -> std.io.Url:
				return std.io.Url(greycat.libs_by_name[std.name_].mapped[65], protocol, host, port, path, params, hash)
		@final
		class CsvColumnFloat(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnFloat:
				return std.io.CsvColumnFloat(greycat.libs_by_name[std.name_].mapped[66], name, mandatory)
		@final
		class CsvColumn(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumn:
				return std.io.CsvColumn(greycat.libs_by_name[std.name_].mapped[67], name, mandatory)
		@final
		class File(GreyCat.Object):
			...
			def create(greycat: GreyCat, path: str, size: int, last_modification: std.core.time) -> std.io.File:
				return std.io.File(greycat.libs_by_name[std.name_].mapped[68], path, size, last_modification)
		@final
		class Http(GreyCat.Object):
			...
			def create(greycat: GreyCat) -> std.io.Http:
				return std.io.Http(greycat.libs_by_name[std.name_].mapped[69])
		@final
		...
		class CsvColumnDate(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, mandatory: bool, format: str, tz: std.core.TimeZone, as_time: bool) -> std.io.CsvColumnDate:
				return std.io.CsvColumnDate(greycat.libs_by_name[std.name_].mapped[72], name, mandatory, format, tz, as_time)
		@final
		class CsvColumnString(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, mandatory: bool, trim: bool, try_number: bool, try_json: bool, values: std.core.Array, encoder: std.io.TextEncoder) -> std.io.CsvColumnString:
				return std.io.CsvColumnString(greycat.libs_by_name[std.name_].mapped[73], name, mandatory, trim, try_number, try_json, values, encoder)
		@final
		class CsvColumnBoolean(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnBoolean:
				return std.io.CsvColumnBoolean(greycat.libs_by_name[std.name_].mapped[74], name, mandatory)
		@final
		class CsvColumnIgnored(GreyCat.Object):
			...
			def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnIgnored:
				return std.io.CsvColumnIgnored(greycat.libs_by_name[std.name_].mapped[75], name, mandatory)
		@final
	...
	class util:
		...
		class Assert(GreyCat.Object):
			...
			def create(greycat: GreyCat) -> std.util.Assert:
				return std.util.Assert(greycat.libs_by_name[std.name_].mapped[79])
		@final
		...
		class BoxPlotFloat(GreyCat.Object):
			...
			def create(greycat: GreyCat, min: float, max: float, whiskerLow: float, whiskerHigh: float, percentile1: float, percentile5: float, percentile25: float, percentile50: float, percentile75: float, percentile95: float, percentile99: float, countOutliersLow: int, countOutliersHigh: int, percentageOutliersLow: float, percentageOutliersHigh: float, sum: float, avg: float, std: float, size: int) -> std.util.BoxPlotFloat:
				return std.util.BoxPlotFloat(greycat.libs_by_name[std.name_].mapped[81], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size)
		@final
		class Random(GreyCat.Object):
			...
			def create(greycat: GreyCat, seed: int, v: float) -> std.util.Random:
				return std.util.Random(greycat.libs_by_name[std.name_].mapped[82], seed, v)
		@final
		...
		class ProgressTracker(GreyCat.Object):
			...
			def create(greycat: GreyCat, start: std.core.time, total: int, counter: int, duration: std.core.duration, progress: float, speed: float, remaining: std.core.duration) -> std.util.ProgressTracker:
				return std.util.ProgressTracker(greycat.libs_by_name[std.name_].mapped[85], start, total, counter, duration, progress, speed, remaining)
		@final
		...
		class Gaussian(GreyCat.Object):
			...
			def create(greycat: GreyCat, sum: float, sum_sq: float, count: int, min: float, max: float) -> std.util.Gaussian:
				return std.util.Gaussian(greycat.libs_by_name[std.name_].mapped[87], sum, sum_sq, count, min, max)
		@final
		...
		class BoxPlotInt(GreyCat.Object):
			...
			def create(greycat: GreyCat, min: int, max: int, whiskerLow: int, whiskerHigh: int, percentile1: int, percentile5: int, percentile25: int, percentile50: int, percentile75: int, percentile95: int, percentile99: int, countOutliersLow: int, countOutliersHigh: int, percentageOutliersLow: float, percentageOutliersHigh: float, sum: float, avg: float, std: float, size: int) -> std.util.BoxPlotInt:
				return std.util.BoxPlotInt(greycat.libs_by_name[std.name_].mapped[92], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size)
		@final
	...
	def configure(self, loaders: dict[str, GreyCat.Loader], factories: dict[str, GreyCat.Factory]) -> None:
		...
		factories[std.core.NodeTimeInfo.name_] = lambda type, attributes: std.core.NodeTimeInfo(type, attributes)
	...
	def init(self, greycat: GreyCat) -> None:
		self.mapped: list[GreyCat.Type] = [None] *94
		self.mapped[0] = greycat.types_by_name[std.core.tf2d.name_]
		self.mapped[1] = greycat.types_by_name[std.core.SamplingMode.name_]
		self.mapped[1].resolve_generated_offset_with_values("fixed", 0,"fixed_reg", 1,"adaptative", 2,"dense", 3)
		self.mapped[2] = greycat.types_by_name[std.core.Table.name_]
		self.mapped[3] = greycat.types_by_name[std.core.ti6d.name_]
		self.mapped[4] = greycat.types_by_name[std.core.nodeTimeSingleton.name_]
		self.mapped[4].resolve_generated_offsets("t","v")
		self.mapped[5] = greycat.types_by_name[std.core.time.name_]
		self.mapped[5].static_values = [greycat.create_time(-9223372036854775808),greycat.create_time(9223372036854775807)]
		self.mapped[6] = greycat.types_by_name[std.core.nodeTime.name_]
		self.mapped[7] = greycat.types_by_name[std.core.DurationUnit.name_]
		...
		self.mapped[8] = greycat.types_by_name[std.core.NodeTimeInfo.name_]
		self.mapped[8].resolve_generated_offsets("size","from","to")
		self.mapped[9] = greycat.types_by_name[std.core.function.name_]
		self.mapped[10] = greycat.types_by_name[std.core.Error.name_]
		self.mapped[11] = greycat.types_by_name[std.core.GeoPoly.name_]
		self.mapped[11].resolve_generated_offsets("points")
		self.mapped[12] = greycat.types_by_name[std.core.duration.name_]
		self.mapped[13] = greycat.types_by_name[std.core.ti2d.name_]
		self.mapped[14] = greycat.types_by_name[std.core.ErrorCode.name_]
		...
		self.mapped[15] = greycat.types_by_name[std.core.geo.name_]
		...
		self.mapped[16] = greycat.types_by_name[std.core.node.name_]
		self.mapped[17] = greycat.types_by_name[std.core.TableColumnMeta.name_]
		self.mapped[17].resolve_generated_offsets("type","size","index","min","max","avg","std")
		self.mapped[18] = greycat.types_by_name[std.core.Date.name_]
		self.mapped[19] = greycat.types_by_name[std.core.Tensor.name_]
		self.mapped[20] = greycat.types_by_name[std.core.ti4d.name_]
		self.mapped[21] = greycat.types_by_name[std.core.GeoCircle.name_]
		self.mapped[21].resolve_generated_offsets("center","radius")
		self.mapped[22] = greycat.types_by_name[std.core.nodeGeo.name_]
		self.mapped[23] = greycat.types_by_name[std.core.ti5d.name_]
		self.mapped[24] = greycat.types_by_name[std.core.String.name_]
		self.mapped[25] = greycat.types_by_name[std.core.Map.name_]
		self.mapped[26] = greycat.types_by_name[std.core.TensorType.name_]
		self.mapped[26].resolve_generated_offset_with_values("i32", 4,"i64", 8,"f32", 4,"f64", 8,"c64", 8,"c128", 16)
		self.mapped[27] = greycat.types_by_name[std.core.TimeZone.name_]
		...
		self.mapped[28] = greycat.types_by_name[std.core.GeoBox.name_]
		self.mapped[28].resolve_generated_offsets("sw","ne")
		self.mapped[29] = greycat.types_by_name[std.core.Tuple.name_]
		self.mapped[29].resolve_generated_offsets("x","y")
		self.mapped[30] = greycat.types_by_name[std.core.DatePart.name_]
		self.mapped[30].resolve_generated_offset_with_values("years", 0,"months", 1,"days", 2,"hours", 3,"minutes", 4,"seconds", 5,"microseconds", 6)
		self.mapped[31] = greycat.types_by_name[std.core.nodeIndex.name_]
		self.mapped[32] = greycat.types_by_name[std.core.nodeList.name_]
		self.mapped[33] = greycat.types_by_name[std.core.tf3d.name_]
		self.mapped[34] = greycat.types_by_name[std.core.nodeIndexBucket.name_]
		self.mapped[35] = greycat.types_by_name[std.core.ti10d.name_]
		self.mapped[36] = greycat.types_by_name[std.core.Array.name_]
		self.mapped[37] = greycat.types_by_name[std.core.tf4d.name_]
		self.mapped[38] = greycat.types_by_name[std.core.ti3d.name_]
		self.mapped[39] = greycat.types_by_name[std.runtime.UserGroup.name_]
		self.mapped[39].resolve_generated_offsets("id","name","activated")
		self.mapped[40] = greycat.types_by_name[std.runtime.SecurityEntity.name_]
		self.mapped[40].resolve_generated_offsets("id","name","activated")
		self.mapped[41] = greycat.types_by_name[std.runtime.PeriodicTask.name_]
		self.mapped[41].resolve_generated_offsets("name","user_id","args","start","every")
		self.mapped[42] = greycat.types_by_name[std.runtime.License.name_]
		self.mapped[42].resolve_generated_offsets("name","start","end","company","max_workers","max_memory","extra_1","extra_2","extra_3","extra_4")
		self.mapped[43] = greycat.types_by_name[std.runtime.StoreStat.name_]
		...
		self.mapped[44] = greycat.types_by_name[std.runtime.SecurityFields.name_]
		self.mapped[44].resolve_generated_offsets("email","name","first_name","last_name","roles","groups")
		self.mapped[45] = greycat.types_by_name[std.runtime.Task.name_]
		self.mapped[45].resolve_generated_offsets("user_id","task_id","mod","type","fun","creation","status")
		self.mapped[46] = greycat.types_by_name[std.runtime.OpenIDConnect.name_]
		self.mapped[46].resolve_generated_offsets("url","clientId")
		self.mapped[47] = greycat.types_by_name[std.runtime.UserGroupPolicy.name_]
		self.mapped[47].resolve_generated_offsets("group_id","type")
		self.mapped[48] = greycat.types_by_name[std.runtime.RuntimeInfo.name_]
		...
		self.mapped[49] = greycat.types_by_name[std.runtime.User.name_]
		...
		self.mapped[50] = greycat.types_by_name[std.runtime.System.name_]
		self.mapped[51] = greycat.types_by_name[std.runtime.UserCredential.name_]
		self.mapped[51].resolve_generated_offsets("offset","pass")
		self.mapped[52] = greycat.types_by_name[std.runtime.TaskStatus.name_]
		self.mapped[52].resolve_generated_offset_with_values("empty", 0,"waiting", 1,"running", 2,"cancelled", 3,"error", 4,"ended", 5)
		self.mapped[53] = greycat.types_by_name[std.runtime.UserRole.name_]
		self.mapped[53].resolve_generated_offsets("name","permissions")
		self.mapped[54] = greycat.types_by_name[std.runtime.SecurityPolicy.name_]
		self.mapped[54].resolve_generated_offsets("entities","credentials","roles","fields")
		self.mapped[55] = greycat.types_by_name[std.runtime.Runtime.name_]
		self.mapped[56] = greycat.types_by_name[std.runtime.TaskInfo.name_]
		...
		self.mapped[57] = greycat.types_by_name[std.runtime.UserGroupPolicyType.name_]
		self.mapped[57].resolve_generated_offset_with_values("read", 0,"write", 1,"execute", 2)
		self.mapped[58] = greycat.types_by_name[std.io.Email.name_]
		self.mapped[58].resolve_generated_offsets("from","subject","body","body_is_html","to","cc","bcc")
		self.mapped[59] = greycat.types_by_name[std.io.Smtp.name_]
		self.mapped[59].resolve_generated_offsets("host","port","mode","authenticate","user","pass")
		self.mapped[60] = greycat.types_by_name[std.io.CsvFormat.name_]
		...
		self.mapped[61] = greycat.types_by_name[std.io.CsvColumnDuration.name_]
		self.mapped[61].resolve_generated_offsets("name","mandatory","unit")
		self.mapped[62] = greycat.types_by_name[std.io.CsvColumnInteger.name_]
		self.mapped[62].resolve_generated_offsets("name","mandatory")
		self.mapped[63] = greycat.types_by_name[std.io.HttpHeader.name_]
		self.mapped[63].resolve_generated_offsets("name","value")
		self.mapped[64] = greycat.types_by_name[std.io.SmtpMode.name_]
		self.mapped[64].resolve_generated_offset_with_values("plain", 0,"ssl_tls", 1,"starttls", 2)
		self.mapped[65] = greycat.types_by_name[std.io.Url.name_]
		self.mapped[65].resolve_generated_offsets("protocol","host","port","path","params","hash")
		self.mapped[66] = greycat.types_by_name[std.io.CsvColumnFloat.name_]
		self.mapped[66].resolve_generated_offsets("name","mandatory")
		self.mapped[67] = greycat.types_by_name[std.io.CsvColumn.name_]
		self.mapped[67].resolve_generated_offsets("name","mandatory")
		self.mapped[68] = greycat.types_by_name[std.io.File.name_]
		self.mapped[68].resolve_generated_offsets("path","size","last_modification")
		self.mapped[69] = greycat.types_by_name[std.io.Http.name_]
		self.mapped[70] = greycat.types_by_name[std.io.CsvColumnTime.name_]
		self.mapped[70].resolve_generated_offsets("name","mandatory","unit")
		self.mapped[71] = greycat.types_by_name[std.io.SmtpAuth.name_]
		self.mapped[71].resolve_generated_offset_with_values("none", 0,"plain", 1,"login", 2)
		self.mapped[72] = greycat.types_by_name[std.io.CsvColumnDate.name_]
		self.mapped[72].resolve_generated_offsets("name","mandatory","format","tz","as_time")
		self.mapped[73] = greycat.types_by_name[std.io.CsvColumnString.name_]
		self.mapped[73].resolve_generated_offsets("name","mandatory","trim","try_number","try_json","values","encoder")
		self.mapped[74] = greycat.types_by_name[std.io.CsvColumnBoolean.name_]
		self.mapped[74].resolve_generated_offsets("name","mandatory")
		self.mapped[75] = greycat.types_by_name[std.io.CsvColumnIgnored.name_]
		self.mapped[75].resolve_generated_offsets("name","mandatory")
		self.mapped[76] = greycat.types_by_name[std.io.TextEncoder.name_]
		self.mapped[76].resolve_generated_offset_with_values("plain", None,"base64", None,"base64url", None,"hexadecimal", None)
		self.mapped[77] = greycat.types_by_name[std.math.MathConstants.name_]
		...
		self.mapped[78] = greycat.types_by_name[std.util.SlidingWindow.name_]
		self.mapped[79] = greycat.types_by_name[std.util.Assert.name_]
		self.mapped[80] = greycat.types_by_name[std.util.Iban.name_]
		self.mapped[81] = greycat.types_by_name[std.util.BoxPlotFloat.name_]
		...
		self.mapped[82] = greycat.types_by_name[std.util.Random.name_]
		self.mapped[82].resolve_generated_offsets("seed","v")
		self.mapped[83] = greycat.types_by_name[std.util.Crypto.name_]
		self.mapped[84] = greycat.types_by_name[std.util.TimeWindow.name_]
		self.mapped[85] = greycat.types_by_name[std.util.ProgressTracker.name_]
		self.mapped[85].resolve_generated_offsets("start","total","counter","duration","progress","speed","remaining")
		self.mapped[86] = greycat.types_by_name[std.util.Quantizer.name_]
		self.mapped[87] = greycat.types_by_name[std.util.Gaussian.name_]
		self.mapped[87].resolve_generated_offsets("sum","sum_sq","count","min","max")
		self.mapped[88] = greycat.types_by_name[std.util.Queue.name_]
		self.mapped[89] = greycat.types_by_name[std.util.GaussianProfile.name_]
		self.mapped[89].static_values = [0,1,2,3,4,5,6]
		self.mapped[90] = greycat.types_by_name[std.util.HistogramInt.name_]
		self.mapped[90].static_values = [0,1,2,3]
		self.mapped[91] = greycat.types_by_name[std.util.Buffer.name_]
		self.mapped[92] = greycat.types_by_name[std.util.BoxPlotInt.name_]
		...
		self.mapped[93] = greycat.types_by_name[std.util.HistogramFloat.name_]
