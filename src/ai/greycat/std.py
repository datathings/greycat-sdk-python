...
class std(GreyCat.Library):
	...
	def init(self, greycat: GreyCat) -> None:
		...
		self.mapped.append(greycat.types_by_name[std.core.tf2d.name_])
		self.mapped.append(greycat.types_by_name[std.core.SamplingMode.name_])
		self.mapped[1].resolve_generated_offset_with_values("fixed", 0,"fixed_reg", 1,"adaptative", 2,"dense", 3)
		self.mapped.append(greycat.types_by_name[std.core.Table.name_])
		self.mapped.append(greycat.types_by_name[std.core.ti6d.name_])
		self.mapped.append(greycat.types_by_name[std.core.nodeTimeSingleton.name_])
		self.mapped[4].resolve_generated_offsets("t","v")
		self.mapped.append(greycat.types_by_name[std.core.time.name_])
		self.mapped[5].static_values = [greycat.create_time(-9223372036854775808),greycat.create_time(9223372036854775807)]
		self.mapped.append(greycat.types_by_name[std.core.nodeTime.name_])
		self.mapped.append(greycat.types_by_name[std.core.DurationUnit.name_])
		...
		self.mapped.append(greycat.types_by_name[std.core.NodeTimeInfo.name_])
		self.mapped[8].resolve_generated_offsets("size","from","to")
		self.mapped.append(greycat.types_by_name[std.core.function.name_])
		self.mapped.append(greycat.types_by_name[std.core.Error.name_])
		self.mapped.append(greycat.types_by_name[std.core.GeoPoly.name_])
		self.mapped[11].resolve_generated_offsets("points")
		self.mapped.append(greycat.types_by_name[std.core.duration.name_])
		self.mapped.append(greycat.types_by_name[std.core.ti2d.name_])
		self.mapped.append(greycat.types_by_name[std.core.ErrorCode.name_])
		...
		self.mapped.append(greycat.types_by_name[std.core.geo.name_])
		...
		self.mapped.append(greycat.types_by_name[std.core.node.name_])
		self.mapped.append(greycat.types_by_name[std.core.TableColumnMeta.name_])
		self.mapped[17].resolve_generated_offsets("type","size","index","min","max","avg","std")
		self.mapped.append(greycat.types_by_name[std.core.Date.name_])
		self.mapped.append(greycat.types_by_name[std.core.Tensor.name_])
		self.mapped.append(greycat.types_by_name[std.core.ti4d.name_])
		self.mapped.append(greycat.types_by_name[std.core.GeoCircle.name_])
		self.mapped[21].resolve_generated_offsets("center","radius")
		self.mapped.append(greycat.types_by_name[std.core.nodeGeo.name_])
		self.mapped.append(greycat.types_by_name[std.core.ti5d.name_])
		self.mapped.append(greycat.types_by_name[std.core.String.name_])
		self.mapped.append(greycat.types_by_name[std.core.Map.name_])
		self.mapped.append(greycat.types_by_name[std.core.TensorType.name_])
		self.mapped[26].resolve_generated_offset_with_values("i32", 4,"i64", 8,"f32", 4,"f64", 8,"c64", 8,"c128", 16)
		self.mapped.append(greycat.types_by_name[std.core.TimeZone.name_])
		...
		self.mapped.append(greycat.types_by_name[std.core.GeoBox.name_])
		self.mapped[28].resolve_generated_offsets("sw","ne")
		self.mapped.append(greycat.types_by_name[std.core.Tuple.name_])
		self.mapped[29].resolve_generated_offsets("x","y")
		self.mapped.append(greycat.types_by_name[std.core.DatePart.name_])
		self.mapped[30].resolve_generated_offset_with_values("years", 0,"months", 1,"days", 2,"hours", 3,"minutes", 4,"seconds", 5,"microseconds", 6)
		self.mapped.append(greycat.types_by_name[std.core.nodeIndex.name_])
		self.mapped.append(greycat.types_by_name[std.core.nodeList.name_])
		self.mapped.append(greycat.types_by_name[std.core.tf3d.name_])
		self.mapped.append(greycat.types_by_name[std.core.nodeIndexBucket.name_])
		self.mapped.append(greycat.types_by_name[std.core.ti10d.name_])
		self.mapped.append(greycat.types_by_name[std.core.Array.name_])
		self.mapped.append(greycat.types_by_name[std.core.tf4d.name_])
		self.mapped.append(greycat.types_by_name[std.core.ti3d.name_])
		self.mapped.append(greycat.types_by_name[std.runtime.UserGroup.name_])
		self.mapped[39].resolve_generated_offsets("id","name","activated")
		self.mapped.append(greycat.types_by_name[std.runtime.SecurityEntity.name_])
		self.mapped[40].resolve_generated_offsets("id","name","activated")
		self.mapped.append(greycat.types_by_name[std.runtime.PeriodicTask.name_])
		self.mapped[41].resolve_generated_offsets("name","user_id","args","start","every")
		self.mapped.append(greycat.types_by_name[std.runtime.License.name_])
		self.mapped[42].resolve_generated_offsets("name","start","end","company","max_workers","max_memory","extra_1","extra_2","extra_3","extra_4")
		self.mapped.append(greycat.types_by_name[std.runtime.StoreStat.name_])
		...
		self.mapped.append(greycat.types_by_name[std.runtime.SecurityFields.name_])
		self.mapped[44].resolve_generated_offsets("email","name","first_name","last_name","roles","groups")
		self.mapped.append(greycat.types_by_name[std.runtime.Task.name_])
		self.mapped[45].resolve_generated_offsets("user_id","task_id","mod","type","fun","creation","status")
		self.mapped.append(greycat.types_by_name[std.runtime.OpenIDConnect.name_])
		self.mapped[46].resolve_generated_offsets("url","clientId")
		self.mapped.append(greycat.types_by_name[std.runtime.UserGroupPolicy.name_])
		self.mapped[47].resolve_generated_offsets("group_id","type")
		self.mapped.append(greycat.types_by_name[std.runtime.RuntimeInfo.name_])
		...
		self.mapped.append(greycat.types_by_name[std.runtime.User.name_])
		...
		self.mapped.append(greycat.types_by_name[std.runtime.System.name_])
		self.mapped.append(greycat.types_by_name[std.runtime.UserCredential.name_])
		self.mapped[51].resolve_generated_offsets("offset","pass")
		self.mapped.append(greycat.types_by_name[std.runtime.TaskStatus.name_])
		self.mapped[52].resolve_generated_offset_with_values("empty", 0,"waiting", 1,"running", 2,"cancelled", 3,"error", 4,"ended", 5)
		self.mapped.append(greycat.types_by_name[std.runtime.UserRole.name_])
		self.mapped[53].resolve_generated_offsets("name","permissions")
		self.mapped.append(greycat.types_by_name[std.runtime.SecurityPolicy.name_])
		self.mapped[54].resolve_generated_offsets("entities","credentials","roles","fields")
		self.mapped.append(greycat.types_by_name[std.runtime.Runtime.name_])
		self.mapped.append(greycat.types_by_name[std.runtime.TaskInfo.name_])
		...
		self.mapped.append(greycat.types_by_name[std.runtime.UserGroupPolicyType.name_])
		self.mapped[57].resolve_generated_offset_with_values("read", 0,"write", 1,"execute", 2)
		self.mapped.append(greycat.types_by_name[std.io.Email.name_])
		self.mapped[58].resolve_generated_offsets("from","subject","body","body_is_html","to","cc","bcc")
		self.mapped.append(greycat.types_by_name[std.io.Smtp.name_])
		self.mapped[59].resolve_generated_offsets("host","port","mode","authenticate","user","pass")
		self.mapped.append(greycat.types_by_name[std.io.CsvFormat.name_])
		...
		self.mapped.append(greycat.types_by_name[std.io.CsvColumnDuration.name_])
		self.mapped[61].resolve_generated_offsets("name","mandatory","unit")
		self.mapped.append(greycat.types_by_name[std.io.CsvColumnInteger.name_])
		self.mapped[62].resolve_generated_offsets("name","mandatory")
		self.mapped.append(greycat.types_by_name[std.io.HttpHeader.name_])
		self.mapped[63].resolve_generated_offsets("name","value")
		self.mapped.append(greycat.types_by_name[std.io.SmtpMode.name_])
		self.mapped[64].resolve_generated_offset_with_values("plain", 0,"ssl_tls", 1,"starttls", 2)
		self.mapped.append(greycat.types_by_name[std.io.Url.name_])
		self.mapped[65].resolve_generated_offsets("protocol","host","port","path","params","hash")
		self.mapped.append(greycat.types_by_name[std.io.CsvColumnFloat.name_])
		self.mapped[66].resolve_generated_offsets("name","mandatory")
		self.mapped.append(greycat.types_by_name[std.io.CsvColumn.name_])
		self.mapped[67].resolve_generated_offsets("name","mandatory")
		self.mapped.append(greycat.types_by_name[std.io.File.name_])
		self.mapped[68].resolve_generated_offsets("path","size","last_modification")
		self.mapped.append(greycat.types_by_name[std.io.Http.name_])
		self.mapped.append(greycat.types_by_name[std.io.CsvColumnTime.name_])
		self.mapped[70].resolve_generated_offsets("name","mandatory","unit")
		self.mapped.append(greycat.types_by_name[std.io.SmtpAuth.name_])
		self.mapped[71].resolve_generated_offset_with_values("none", 0,"plain", 1,"login", 2)
		self.mapped.append(greycat.types_by_name[std.io.CsvColumnDate.name_])
		self.mapped[72].resolve_generated_offsets("name","mandatory","format","tz","as_time")
		self.mapped.append(greycat.types_by_name[std.io.CsvColumnString.name_])
		self.mapped[73].resolve_generated_offsets("name","mandatory","trim","try_number","try_json","values","encoder")
		self.mapped.append(greycat.types_by_name[std.io.CsvColumnBoolean.name_])
		self.mapped[74].resolve_generated_offsets("name","mandatory")
		self.mapped.append(greycat.types_by_name[std.io.CsvColumnIgnored.name_])
		self.mapped[75].resolve_generated_offsets("name","mandatory")
		self.mapped.append(greycat.types_by_name[std.io.TextEncoder.name_])
		self.mapped[76].resolve_generated_offset_with_values("plain", None,"base64", None,"base64url", None,"hexadecimal", None)
		self.mapped.append(greycat.types_by_name[std.math.MathConstants.name_])
		...
		self.mapped.append(greycat.types_by_name[std.util.SlidingWindow.name_])
		self.mapped.append(greycat.types_by_name[std.util.Assert.name_])
		self.mapped.append(greycat.types_by_name[std.util.Iban.name_])
		self.mapped.append(greycat.types_by_name[std.util.BoxPlotFloat.name_])
		...
		self.mapped.append(greycat.types_by_name[std.util.Random.name_])
		self.mapped[82].resolve_generated_offsets("seed","v")
		self.mapped.append(greycat.types_by_name[std.util.Crypto.name_])
		self.mapped.append(greycat.types_by_name[std.util.TimeWindow.name_])
		self.mapped.append(greycat.types_by_name[std.util.ProgressTracker.name_])
		self.mapped[85].resolve_generated_offsets("start","total","counter","duration","progress","speed","remaining")
		self.mapped.append(greycat.types_by_name[std.util.Quantizer.name_])
		self.mapped.append(greycat.types_by_name[std.util.Gaussian.name_])
		self.mapped[87].resolve_generated_offsets("sum","sum_sq","count","min","max")
		self.mapped.append(greycat.types_by_name[std.util.Queue.name_])
		self.mapped.append(greycat.types_by_name[std.util.GaussianProfile.name_])
		self.mapped[89].static_values = [0,1,2,3,4,5,6]
		self.mapped.append(greycat.types_by_name[std.util.HistogramInt.name_])
		self.mapped[90].static_values = [0,1,2,3]
		self.mapped.append(greycat.types_by_name[std.util.Buffer.name_])
		self.mapped.append(greycat.types_by_name[std.util.BoxPlotInt.name_])
		...
		self.mapped.append(greycat.types_by_name[std.util.HistogramFloat.name_])
