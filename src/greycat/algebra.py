...
class algebra(GreyCat.Library):
    ...
    def init(self, greycat: GreyCat) -> None:
        ...
        self.mapped[2].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput")
        self.mapped[2].static_values = ["Inputs or outputs can't be negative", "Last layer has different number of outputs than declared", "Incompatible loss function", "Some NN layers are not currently supported", "Tensor Type not currently supported", "NN should contain at least 1 layer", "layer placeholders", "layer classification", "layer preprocess", "layer postprocess learn", "layer main", "layer loss learn", "layer loss display", "layer postprocess display", "layer confusion", "seq predict", "seq postprocess", "seq learn", "seq loss display", "seq encode", "seq decode", "seq confusion", "var input", "var enc input", "var targets", "var Classifier classes", "var Classifier probabilities", "var Classifier class weights", "var Classifier confusion", "var input avg", "var input min", "var input max", "var input std", "var input space", "var output avg", "var output min", "var output max", "var output std"]
        self.mapped[3].resolve_generated_offsets("previousLayerName", "previousLayerOutput", "expectedLayerName", "expectedLayerOutput", "postLayer")
        self.mapped[4].resolve_generated_offsets("weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer")
        self.mapped[5].resolve_generated_offsets("precision", "recall", "f1Score")
        self.mapped[6].resolve_generated_offset_with_values("relu", "Relu", "leaky_relu", "Leaky Relu", "sigmoid", "Sigmoid", "hard_sigmoid", "Hard Sigmoid", "exp", "Exp", "soft_max", "Soft Max", "soft_plus", "Soft Plus", "soft_sign", "Soft Sign", "tanh", "Tanh", "selu", "Selu", "elu", "Elu", "celu", "Celu")
        self.mapped[7].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput")
        self.mapped[8].resolve_generated_offset_with_values("ada_delta", "Ada Delta", "ada_grad", "Ada Grad", "adam", "Adam", "ada_max", "Ada Max", "nadam", "NAdam", "ftrl", "Ftrl", "sgd", "Stochastic Gradient Descent", "rms_prop", "RMS Prop", "momentum", "Momentum", "nesterov", "Nesterov")
        self.mapped[9].resolve_generated_offset_with_values("linear", "Linear", "dense", "Dense", "activation", "Activation", "lstm", "LSTM", "loss", "Loss", "filter", "Filter")
        self.mapped[10].resolve_generated_offset_with_values("none", "None", "min_max_scaling", "Min/Max Scaling", "standard_scaling", "Standard Scaling", "pca_scaling", "PCA Scaling")
        self.mapped[11].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput", "calculate_probabilities", "has_class_weights", "from_logits")
        self.mapped[12].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput", "encoder_layer_idx", "encoder_layer_name", "encoder_layer_var")
        ...
        self.mapped[24].static_values = ["input", "assignement", "min_distance", "centroids", "distance", "sum_centroids", "sum_min_distance", "count_centroids", "centroid_distances", "sum_cluster_distances", "avg_cluster_distances", "count_cluster_distances", "placeholders", "kmeans_forward", "kmeans_backward", "kmeans_init_round", "kmeans_end_round", "kmeans_stats_layer", "kmeans_init_round_seq", "kmeans_forward_seq", "kmeans_backward_seq", "kmeans_end_round_seq", "kmeans_stats_seq", 100, 20]
        self.mapped[25].resolve_generated_offsets("runDistances", "bestResult")
        self.mapped[26].resolve_generated_offsets("name", "calculate_probabilities", "from_logits")
        self.mapped[26].static_values = ["input", "predicted_classes", "probabilities"]
        self.mapped[27].resolve_generated_offsets("input", "output", "mask", "nbOutputs")
        self.mapped[28].resolve_generated_offsets("input", "output", "min", "max")
        self.mapped[29].resolve_generated_offsets("epoch", "optimizationSteps", "batchNotOptimized")
        ...
        self.mapped[41].resolve_generated_offsets("input", "output", "axis")
        ...
        self.mapped[57].resolve_generated_offsets("input", "output")
        self.mapped[59].resolve_generated_offsets("name", "type", "shape", "l1", "l2", "init")
        self.mapped[60].resolve_generated_offsets("input", "input2", "output")
        self.mapped[61].resolve_generated_offset_with_values("categorical_cross_entropy", "Categorical Cross Entropy", "sparse_categorical_cross_entropy", "Sparse Categorical Cross Entropy")
        ...
        self.mapped[75].resolve_generated_offsets("input", "output")
        self.mapped[76].resolve_generated_offsets("input", "output", "alpha")
        ...
        self.mapped[83].static_values = ["input", "output", "min", "max"]
        self.mapped[84].resolve_generated_offsets("classes")
        self.mapped[85].resolve_generated_offsets("input", "output")
        self.mapped[86].resolve_generated_offsets("name", "nbClass")
        self.mapped[86].static_values = ["computed", "expected", "confusion"]
        self.mapped[87].resolve_generated_offsets("value")
        self.mapped[88].resolve_generated_offsets("name", "activation")
        ...
        self.mapped[105].resolve_generated_offsets("input", "output")
        ...
        self.mapped[116].resolve_generated_offsets("input", "input2", "output")
        self.mapped[117].resolve_generated_offsets("name", "type", "inputs", "outputs", "use_bias", "weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer", "activation")
        self.mapped[117].static_values = ["input", "output", "weight", "bias", "mult", "pre_activation"]
        ...
        self.mapped[153].resolve_generated_offsets("name", "bias_initializer", "weight_regularizer", "bias_regularizer", "type", "use_bias", "return_sequences", "bidirectional", "auto_init_states", "inputs", "outputs", "layers", "sequences")
        self.mapped[153].static_values = ["input", "output", "hx", "cx", "hy", "cy", "weight", "bias", "internal_i", "internal_f", "internal_cp", "internal_o", "internal_h", "internal_c", "internal_mult", "internal_output"]
        self.mapped[154].resolve_generated_offsets("name", "ops", "vars")
        ...
        self.mapped[158].resolve_generated_offset_with_values("as_is", "As-is", "shift", "Vertical shift", "scaling", "Vertical scaling", "shift_and_scaling", "Vertical shift and scaling")
        self.mapped[159].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "std", "matchingNormalisation")
        ...
        self.mapped[162].resolve_generated_offsets("score", "best_pattern", "timespan")
        self.mapped[163].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy")
        self.mapped[164].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "rng")
        self.mapped[165].resolve_generated_offset_with_values("none", "None", "euclidean", "Euclidean", "fft", "FFT", "dtw", "DTW", "random", "Random", "sax", "SAX")
        self.mapped[166].resolve_generated_offsets("best_pattern", "timespan", "timestamp")
        self.mapped[168].resolve_generated_offsets("distance", "best_pattern", "best_timespan")
        self.mapped[169].resolve_generated_offsets("score", "best_pattern", "timespan", "overlap")
        self.mapped[171].resolve_generated_offsets("threshold", "overlap")
        self.mapped[173].resolve_generated_offsets("hasScores", "hasDetections", "patterns", "scores", "detections")
        self.mapped[174].resolve_generated_offsets("best_pattern", "timespan")
        ...
        self.mapped[177].resolve_generated_offsets("alphabet_size", "fingerprint_length")
