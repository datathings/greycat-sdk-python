...
class algebra(GreyCat.Library):
    ...
    class nn:
        ...
        class PostProcessType(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.nn.PostProcessType:
                return algebra.nn.PostProcessType(greycat.libs_by_name[algebra.name_].mapped[2])
        ...
        class RegressionNetwork(GreyCat.Object):
            ...
            def create(greycat: GreyCat, inputs: int, inputs_gradients: bool, outputs: int, fixed_batch_size: int, inputs_sequences: int, outputs_sequences: int, tensor_type: std.core.TensorType, seed: int, randomizeSeed: bool, layers: std.core.Array, preProcessType: algebra.nn.PreProcessType, preProcessObject: Any, postProcessType: algebra.nn.PostProcessType, postProcessObject: Any, optimizer: algebra.compute.ComputeOptimizer, lossLayer: algebra.compute.ComputeLayerLoss, _lastLayer: str, _lastOutput: str) -> algebra.nn.RegressionNetwork:
                return algebra.nn.RegressionNetwork(greycat.libs_by_name[algebra.name_].mapped[3], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput)
        ...
        class BindingsResult(GreyCat.Object):
            ...
            def create(greycat: GreyCat, previousLayerName: str, previousLayerOutput: str, expectedLayerName: str, expectedLayerOutput: str, postLayer: algebra.compute.ComputeLayer) -> algebra.nn.BindingsResult:
                return algebra.nn.BindingsResult(greycat.libs_by_name[algebra.name_].mapped[4], previousLayerName, previousLayerOutput, expectedLayerName, expectedLayerOutput, postLayer)
        ...
        class ComputeInitializers(GreyCat.Enum):
            ...
            def none(greycat: GreyCat) -> algebra.nn.ComputeInitializers:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[5]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> algebra.nn.ComputeInitializers:
                return algebra.nn.ComputeInitializers(greycat.libs_by_name[algebra.name_].mapped[5])
        ...
        class InitializerConfig(GreyCat.Object):
            ...
            def create(greycat: GreyCat, weight_initializer: algebra.compute.ComputeInitializer, weight_regularizer: algebra.compute.ComputeRegularizer, bias_initializer: algebra.compute.ComputeInitializer, bias_regularizer: algebra.compute.ComputeRegularizer) -> algebra.nn.InitializerConfig:
                return algebra.nn.InitializerConfig(greycat.libs_by_name[algebra.name_].mapped[6], weight_initializer, weight_regularizer, bias_initializer, bias_regularizer)
        ...
        class ComputeLayerTypes(GreyCat.Enum):
            ...
            def linear(greycat: GreyCat) -> algebra.nn.ComputeLayerTypes:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[7]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> algebra.nn.ComputeLayerTypes:
                return algebra.nn.ComputeLayerTypes(greycat.libs_by_name[algebra.name_].mapped[7])
        ...
        class ClassificationNetwork(GreyCat.Object):
            ...
            def create(greycat: GreyCat, inputs: int, inputs_gradients: bool, outputs: int, fixed_batch_size: int, inputs_sequences: int, outputs_sequences: int, tensor_type: std.core.TensorType, seed: int, randomizeSeed: bool, layers: std.core.Array, preProcessType: algebra.nn.PreProcessType, preProcessObject: Any, postProcessType: algebra.nn.PostProcessType, postProcessObject: Any, optimizer: algebra.compute.ComputeOptimizer, lossLayer: algebra.compute.ComputeLayerLoss, _lastLayer: str, _lastOutput: str, calculate_probabilities: bool, has_class_weights: bool, from_logits: bool) -> algebra.nn.ClassificationNetwork:
                return algebra.nn.ClassificationNetwork(greycat.libs_by_name[algebra.name_].mapped[8], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, calculate_probabilities, has_class_weights, from_logits)
        ...
        class ComputeOptimizers(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.nn.ComputeOptimizers:
                return algebra.nn.ComputeOptimizers(greycat.libs_by_name[algebra.name_].mapped[9])
        ...
        class ClassificationMetrics(GreyCat.Object):
            ...
            def create(greycat: GreyCat, precision: std.core.Array, recall: std.core.Array, f1Score: std.core.Array) -> algebra.nn.ClassificationMetrics:
                return algebra.nn.ClassificationMetrics(greycat.libs_by_name[algebra.name_].mapped[10], precision, recall, f1Score)
        ...
        class PreProcessType(GreyCat.Enum):
            ...
            def none(greycat: GreyCat) -> algebra.nn.PreProcessType:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[11]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> algebra.nn.PreProcessType:
                return algebra.nn.PreProcessType(greycat.libs_by_name[algebra.name_].mapped[11])
        ...
        class ComputeActivations(GreyCat.Enum):
            ...
            def relu(greycat: GreyCat) -> algebra.nn.ComputeActivations:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[12]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> algebra.nn.ComputeActivations:
                return algebra.nn.ComputeActivations(greycat.libs_by_name[algebra.name_].mapped[12])
        ...
        class NeuralNetwork(GreyCat.Object):
            ...
            def create(greycat: GreyCat, inputs: int, inputs_gradients: bool, outputs: int, fixed_batch_size: int, inputs_sequences: int, outputs_sequences: int, tensor_type: std.core.TensorType, seed: int, randomizeSeed: bool, layers: std.core.Array, preProcessType: algebra.nn.PreProcessType, preProcessObject: Any, postProcessType: algebra.nn.PostProcessType, postProcessObject: Any, optimizer: algebra.compute.ComputeOptimizer, lossLayer: algebra.compute.ComputeLayerLoss, _lastLayer: str, _lastOutput: str) -> algebra.nn.NeuralNetwork:
                return algebra.nn.NeuralNetwork(greycat.libs_by_name[algebra.name_].mapped[13], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput)
        ...
        class AutoEncoderNetwork(GreyCat.Object):
            ...
            def create(greycat: GreyCat, inputs: int, inputs_gradients: bool, outputs: int, fixed_batch_size: int, inputs_sequences: int, outputs_sequences: int, tensor_type: std.core.TensorType, seed: int, randomizeSeed: bool, layers: std.core.Array, preProcessType: algebra.nn.PreProcessType, preProcessObject: Any, postProcessType: algebra.nn.PostProcessType, postProcessObject: Any, optimizer: algebra.compute.ComputeOptimizer, lossLayer: algebra.compute.ComputeLayerLoss, _lastLayer: str, _lastOutput: str, encoder_layer_idx: int, encoder_layer_name: str, encoder_layer_var: str) -> algebra.nn.AutoEncoderNetwork:
                return algebra.nn.AutoEncoderNetwork(greycat.libs_by_name[algebra.name_].mapped[14], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, encoder_layer_idx, encoder_layer_name, encoder_layer_var)
    ...
    class ml:
        ...
        class HeatMapProfile(GreyCat.Object):
            ...
            def create(greycat: GreyCat, counts: std.core.Table, x_labels: std.core.Array, y_labels: std.core.Array, counts_max: int, counts_sum: int) -> algebra.ml.HeatMapProfile:
                return algebra.ml.HeatMapProfile(greycat.libs_by_name[algebra.name_].mapped[16], counts, x_labels, y_labels, counts_max, counts_sum)
        ...
        class Polynomial(algebra_n.ml._Polynomial):
            ...
            def create(greycat: GreyCat) -> algebra_n.ml._Polynomial:
                return algebra.ml.Polynomial(greycat.libs_by_name[algebra.name_].mapped[17])
        ...
        class PCA(algebra_n.ml._PCA):
            ...
            def create(greycat: GreyCat) -> algebra_n.ml._PCA:
                return algebra.ml.PCA(greycat.libs_by_name[algebra.name_].mapped[18])
        ...
        class Solver(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.ml.Solver:
                return algebra.ml.Solver(greycat.libs_by_name[algebra.name_].mapped[19])
        ...
        class TimeSeriesDecomposition(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.ml.TimeSeriesDecomposition:
                return algebra.ml.TimeSeriesDecomposition(greycat.libs_by_name[algebra.name_].mapped[20])
        ...
        class GaussianND(algebra_n.ml._GaussianND):
            ...
            def create(greycat: GreyCat) -> algebra_n.ml._GaussianND:
                return algebra.ml.GaussianND(greycat.libs_by_name[algebra.name_].mapped[21])
    ...
    class kmeans:
        ...
        class Kmeans(GreyCat.Object):
            ...
            def var_input(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[23]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat) -> algebra.kmeans.Kmeans:
                return algebra.kmeans.Kmeans(greycat.libs_by_name[algebra.name_].mapped[23])
        ...
        class KmeanMetaResult(GreyCat.Object):
            ...
            def create(greycat: GreyCat, runDistances: std.core.Array, bestResult: algebra.kmeans.KmeanResult) -> algebra.kmeans.KmeanMetaResult:
                return algebra.kmeans.KmeanMetaResult(greycat.libs_by_name[algebra.name_].mapped[24], runDistances, bestResult)
        ...
        class KmeanResult(GreyCat.Object):
            ...
            def create(greycat: GreyCat, loss: float, roundsDistances: std.core.Array, centroids: std.core.Tensor, clusters_count: std.core.Tensor, clusters_sum_distance: std.core.Tensor, clusters_avg_distance: std.core.Tensor, assignement: std.core.Tensor, distances: std.core.Tensor, clusterInterDistances: std.core.Tensor) -> algebra.kmeans.KmeanResult:
                return algebra.kmeans.KmeanResult(greycat.libs_by_name[algebra.name_].mapped[25], loss, roundsDistances, centroids, clusters_count, clusters_sum_distance, clusters_avg_distance, assignement, distances, clusterInterDistances)
    ...
    class compute:
        ...
        class ComputeCounter(GreyCat.Object):
            ...
            def create(greycat: GreyCat, epoch: int, optimizationSteps: int, batchNotOptimized: int) -> algebra.compute.ComputeCounter:
                return algebra.compute.ComputeCounter(greycat.libs_by_name[algebra.name_].mapped[26], epoch, optimizationSteps, batchNotOptimized)
        ...
        class ComputeOperationLogSoftmax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, axis: int) -> algebra.compute.ComputeOperationLogSoftmax:
                return algebra.compute.ComputeOperationLogSoftmax(greycat.libs_by_name[algebra.name_].mapped[27], input, output, axis)
        ...
        class ComputeInitializerIdentity(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerIdentity:
                return algebra.compute.ComputeInitializerIdentity(greycat.libs_by_name[algebra.name_].mapped[28])
        ...
        class ComputeOperation1In1Out(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperation1In1Out:
                return algebra.compute.ComputeOperation1In1Out(greycat.libs_by_name[algebra.name_].mapped[29], input, output)
        ...
        class ComputeActivationRelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, max_value: float, threshold: float) -> algebra.compute.ComputeActivationRelu:
                return algebra.compute.ComputeActivationRelu(greycat.libs_by_name[algebra.name_].mapped[30], max_value, threshold)
        ...
        class ComputeOperationSoftmax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSoftmax:
                return algebra.compute.ComputeOperationSoftmax(greycat.libs_by_name[algebra.name_].mapped[31], input, output)
        ...
        class ComputeActivationLeakyRelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, alpha: float, max_value: float, threshold: float) -> algebra.compute.ComputeActivationLeakyRelu:
                return algebra.compute.ComputeActivationLeakyRelu(greycat.libs_by_name[algebra.name_].mapped[32], alpha, max_value, threshold)
        ...
        class ComputeRegularizer(GreyCat.Object):
            ...
            def create(greycat: GreyCat, l1: float, l2: float) -> algebra.compute.ComputeRegularizer:
                return algebra.compute.ComputeRegularizer(greycat.libs_by_name[algebra.name_].mapped[33], l1, l2)
        ...
        class ComputeInitializerNormalOut(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerNormalOut:
                return algebra.compute.ComputeInitializerNormalOut(greycat.libs_by_name[algebra.name_].mapped[34])
        ...
        class ComputeActivationSelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationSelu:
                return algebra.compute.ComputeActivationSelu(greycat.libs_by_name[algebra.name_].mapped[35])
        ...
        class ComputeOperationFill(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, value: Any) -> algebra.compute.ComputeOperationFill:
                return algebra.compute.ComputeOperationFill(greycat.libs_by_name[algebra.name_].mapped[36], input, value)
        ...
        class ComputeLayerDense(GreyCat.Object):
            ...
            def var_input_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[37]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inputs: int, outputs: int, use_bias: bool, weight_initializer: algebra.compute.ComputeInitializer, weight_regularizer: algebra.compute.ComputeRegularizer, bias_initializer: algebra.compute.ComputeInitializer, bias_regularizer: algebra.compute.ComputeRegularizer, activation: algebra.compute.ComputeActivation) -> algebra.compute.ComputeLayerDense:
                return algebra.compute.ComputeLayerDense(greycat.libs_by_name[algebra.name_].mapped[37], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation)
        ...
        class ComputeOperationArgMax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, output2: str) -> algebra.compute.ComputeOperationArgMax:
                return algebra.compute.ComputeOperationArgMax(greycat.libs_by_name[algebra.name_].mapped[38], input, output, output2)
        ...
        class ComputeOperationSelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSelu:
                return algebra.compute.ComputeOperationSelu(greycat.libs_by_name[algebra.name_].mapped[39], input, output)
        ...
        class ComputeOperationEuclidean(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationEuclidean:
                return algebra.compute.ComputeOperationEuclidean(greycat.libs_by_name[algebra.name_].mapped[40], input, input2, output)
        ...
        class ComputeOperationSqrt(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSqrt:
                return algebra.compute.ComputeOperationSqrt(greycat.libs_by_name[algebra.name_].mapped[41], input, output)
        ...
        class ComputeOptimizerNesterov(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, decay_rate: float) -> algebra.compute.ComputeOptimizerNesterov:
                return algebra.compute.ComputeOptimizerNesterov(greycat.libs_by_name[algebra.name_].mapped[42], learning_rate, decay_rate)
        ...
        class ComputeInitializerLSTM(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerLSTM:
                return algebra.compute.ComputeInitializerLSTM(greycat.libs_by_name[algebra.name_].mapped[43])
        ...
        class ComputeOperationRaiseToPower(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, power: float) -> algebra.compute.ComputeOperationRaiseToPower:
                return algebra.compute.ComputeOperationRaiseToPower(greycat.libs_by_name[algebra.name_].mapped[44], input, output, power)
        ...
        class ComputeInitializerRelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerRelu:
                return algebra.compute.ComputeInitializerRelu(greycat.libs_by_name[algebra.name_].mapped[45])
        ...
        class ComputeLayerClassification(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, calculate_probabilities: bool, from_logits: bool) -> algebra.compute.ComputeLayerClassification:
                return algebra.compute.ComputeLayerClassification(greycat.libs_by_name[algebra.name_].mapped[46], name, calculate_probabilities, from_logits)
        ...
        class ComputeRegressionLoss(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeRegressionLoss:
                return algebra.compute.ComputeRegressionLoss(greycat.libs_by_name[algebra.name_].mapped[47])
        ...
        class ComputeActivationCelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, alpha: float) -> algebra.compute.ComputeActivationCelu:
                return algebra.compute.ComputeActivationCelu(greycat.libs_by_name[algebra.name_].mapped[48], alpha)
        ...
        class ComputeVarProxy(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str) -> algebra.compute.ComputeVarProxy:
                return algebra.compute.ComputeVarProxy(greycat.libs_by_name[algebra.name_].mapped[49], name)
        ...
        class ComputeOperationSum(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, axis: int) -> algebra.compute.ComputeOperationSum:
                return algebra.compute.ComputeOperationSum(greycat.libs_by_name[algebra.name_].mapped[50], input, output, axis)
        ...
        class ComputeModel(GreyCat.Object):
            ...
            def create(greycat: GreyCat, layers: std.core.Array) -> algebra.compute.ComputeModel:
                return algebra.compute.ComputeModel(greycat.libs_by_name[algebra.name_].mapped[51], layers)
        ...
        class ComputeLayerMinMaxScaler(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inverse_transform: bool) -> algebra.compute.ComputeLayerMinMaxScaler:
                return algebra.compute.ComputeLayerMinMaxScaler(greycat.libs_by_name[algebra.name_].mapped[52], name, type, inverse_transform)
        ...
        class ComputeOperationCosh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationCosh:
                return algebra.compute.ComputeOperationCosh(greycat.libs_by_name[algebra.name_].mapped[53], input, output)
        ...
        class ComputeOperation2In1Out(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperation2In1Out:
                return algebra.compute.ComputeOperation2In1Out(greycat.libs_by_name[algebra.name_].mapped[54], input, input2, output)
        ...
        class ComputeOperationSign(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSign:
                return algebra.compute.ComputeOperationSign(greycat.libs_by_name[algebra.name_].mapped[55], input, output)
        ...
        class ComputeInitializerConstant(GreyCat.Object):
            ...
            def create(greycat: GreyCat, value: Any) -> algebra.compute.ComputeInitializerConstant:
                return algebra.compute.ComputeInitializerConstant(greycat.libs_by_name[algebra.name_].mapped[56], value)
        ...
        class ComputeOperationSumIf(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, ifCondition: str, output: str, counts: str, classes: int) -> algebra.compute.ComputeOperationSumIf:
                return algebra.compute.ComputeOperationSumIf(greycat.libs_by_name[algebra.name_].mapped[57], input, ifCondition, output, counts, classes)
        ...
        class ComputeOperationArgMin(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, output2: str) -> algebra.compute.ComputeOperationArgMin:
                return algebra.compute.ComputeOperationArgMin(greycat.libs_by_name[algebra.name_].mapped[58], input, output, output2)
        ...
        class ComputeLayerLossClassification(GreyCat.Object):
            ...
            def var_class_weights_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[59]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, reduction: algebra.compute.ComputeReduction, loss_type: algebra.compute.ComputeClassificationLoss, has_class_weights: bool, calculate_probabilities: bool, from_logits: bool) -> algebra.compute.ComputeLayerLossClassification:
                return algebra.compute.ComputeLayerLossClassification(greycat.libs_by_name[algebra.name_].mapped[59], name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits)
        ...
        class ComputeInitializerXavierUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerXavierUniform:
                return algebra.compute.ComputeInitializerXavierUniform(greycat.libs_by_name[algebra.name_].mapped[60])
        ...
        class ComputeActivationElu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, alpha: float) -> algebra.compute.ComputeActivationElu:
                return algebra.compute.ComputeActivationElu(greycat.libs_by_name[algebra.name_].mapped[61], alpha)
        ...
        class ComputeOperationAsinh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAsinh:
                return algebra.compute.ComputeOperationAsinh(greycat.libs_by_name[algebra.name_].mapped[62], input, output)
        ...
        class ComputeOptimizer(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float) -> algebra.compute.ComputeOptimizer:
                return algebra.compute.ComputeOptimizer(greycat.libs_by_name[algebra.name_].mapped[63], learning_rate)
        ...
        class ComputeOperationClip(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, min: float, max: float) -> algebra.compute.ComputeOperationClip:
                return algebra.compute.ComputeOperationClip(greycat.libs_by_name[algebra.name_].mapped[64], input, output, min, max)
        ...
        class ComputeLayerFilter(GreyCat.Object):
            ...
            @staticmethod
            def var_input_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[65]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inputs: int, outputs: int, maskValues: std.core.Array) -> algebra.compute.ComputeLayerFilter:
                return algebra.compute.ComputeLayerFilter(greycat.libs_by_name[algebra.name_].mapped[65], name, type, inputs, outputs, maskValues)
        ...
        class ComputeOperationDiv(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationDiv:
                return algebra.compute.ComputeOperationDiv(greycat.libs_by_name[algebra.name_].mapped[66], input, input2, output)
        ...
        class ComputeActivationTanh(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationTanh:
                return algebra.compute.ComputeActivationTanh(greycat.libs_by_name[algebra.name_].mapped[67])
        ...
        class ComputeVar(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str) -> algebra.compute.ComputeVar:
                return algebra.compute.ComputeVar(greycat.libs_by_name[algebra.name_].mapped[68], name)
        ...
        class ComputeState(algebra_n.compute._ComputeState):
            ...
            def create(greycat: GreyCat) -> algebra_n.compute._ComputeState:
                return algebra.compute.ComputeState(greycat.libs_by_name[algebra.name_].mapped[69])
        ...
        class ComputeOperationSinh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSinh:
                return algebra.compute.ComputeOperationSinh(greycat.libs_by_name[algebra.name_].mapped[70], input, output)
        ...
        class ComputeInitializerNormalIn(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerNormalIn:
                return algebra.compute.ComputeInitializerNormalIn(greycat.libs_by_name[algebra.name_].mapped[71])
        ...
        class ComputeInitializerPytorch(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerPytorch:
                return algebra.compute.ComputeInitializerPytorch(greycat.libs_by_name[algebra.name_].mapped[72])
        ...
        class ComputeOperationTanh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationTanh:
                return algebra.compute.ComputeOperationTanh(greycat.libs_by_name[algebra.name_].mapped[73], input, output)
        ...
        class ComputeLayerLinear(GreyCat.Object):
            ...
            @staticmethod
            def var_input_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[74]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inputs: int, outputs: int, use_bias: bool, weight_initializer: algebra.compute.ComputeInitializer, weight_regularizer: algebra.compute.ComputeRegularizer, bias_initializer: algebra.compute.ComputeInitializer, bias_regularizer: algebra.compute.ComputeRegularizer) -> algebra.compute.ComputeLayerLinear:
                return algebra.compute.ComputeLayerLinear(greycat.libs_by_name[algebra.name_].mapped[74], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer)
        ...
        class ComputeOperationAdd(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationAdd:
                return algebra.compute.ComputeOperationAdd(greycat.libs_by_name[algebra.name_].mapped[75], input, input2, output)
        ...
        class ComputeOperationNeg(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationNeg:
                return algebra.compute.ComputeOperationNeg(greycat.libs_by_name[algebra.name_].mapped[76], input, output)
        ...
        class ComputeOperationSoftSign(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSoftSign:
                return algebra.compute.ComputeOperationSoftSign(greycat.libs_by_name[algebra.name_].mapped[77], input, output)
        ...
        class ComputeClassificationLoss(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeClassificationLoss:
                return algebra.compute.ComputeClassificationLoss(greycat.libs_by_name[algebra.name_].mapped[78])
        ...
        class ComputeLayerPCAScaler(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inverse_transform: bool) -> algebra.compute.ComputeLayerPCAScaler:
                return algebra.compute.ComputeLayerPCAScaler(greycat.libs_by_name[algebra.name_].mapped[79], name, type, inverse_transform)
        ...
        class ComputeVarConst(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, shape: std.core.Array) -> algebra.compute.ComputeVarConst:
                return algebra.compute.ComputeVarConst(greycat.libs_by_name[algebra.name_].mapped[80], name, type, shape)
        ...
        class ComputeInitializerUniformOut(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerUniformOut:
                return algebra.compute.ComputeInitializerUniformOut(greycat.libs_by_name[algebra.name_].mapped[81])
        ...
        class ComputeLayerStandardScaler(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inverse_transform: bool) -> algebra.compute.ComputeLayerStandardScaler:
                return algebra.compute.ComputeLayerStandardScaler(greycat.libs_by_name[algebra.name_].mapped[82], name, type, inverse_transform)
        ...
        class ComputeOperationAtanh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAtanh:
                return algebra.compute.ComputeOperationAtanh(greycat.libs_by_name[algebra.name_].mapped[83], input, output)
        ...
        class ComputeActivationSoftSign(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationSoftSign:
                return algebra.compute.ComputeActivationSoftSign(greycat.libs_by_name[algebra.name_].mapped[84])
        ...
        class ComputeInitializerNormal(GreyCat.Object):
            ...
            def create(greycat: GreyCat, avg: float, std: float) -> algebra.compute.ComputeInitializerNormal:
                return algebra.compute.ComputeInitializerNormal(greycat.libs_by_name[algebra.name_].mapped[85], avg, std)
        ...
        class ComputeOptimizerAdaMax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, beta1: float, beta2: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerAdaMax:
                return algebra.compute.ComputeOptimizerAdaMax(greycat.libs_by_name[algebra.name_].mapped[86], learning_rate, beta1, beta2, smooth_epsilon)
        ...
        class ComputeLayerSeq(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, calls: std.core.Array, optimizer: algebra.compute.ComputeOptimizer) -> algebra.compute.ComputeLayerSeq:
                return algebra.compute.ComputeLayerSeq(greycat.libs_by_name[algebra.name_].mapped[87], name, calls, optimizer)
        ...
        class ComputeVariable(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str) -> algebra.compute.ComputeVariable:
                return algebra.compute.ComputeVariable(greycat.libs_by_name[algebra.name_].mapped[88], name)
        ...
        class ComputeOperation(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeOperation:
                return algebra.compute.ComputeOperation(greycat.libs_by_name[algebra.name_].mapped[89])
        ...
        class ComputeOptimizerAdaGrad(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, initial_accumulator: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerAdaGrad:
                return algebra.compute.ComputeOptimizerAdaGrad(greycat.libs_by_name[algebra.name_].mapped[90], learning_rate, initial_accumulator, smooth_epsilon)
        ...
        class ComputeActivationSoftmax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, classes: str) -> algebra.compute.ComputeActivationSoftmax:
                return algebra.compute.ComputeActivationSoftmax(greycat.libs_by_name[algebra.name_].mapped[91], classes)
        ...
        class ComputeOperationAtan(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAtan:
                return algebra.compute.ComputeOperationAtan(greycat.libs_by_name[algebra.name_].mapped[92], input, output)
        ...
        class ComputeLayerConfusion(GreyCat.Object):
            ...
            def var_computed_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[93]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, nbClass: int) -> algebra.compute.ComputeLayerConfusion:
                return algebra.compute.ComputeLayerConfusion(greycat.libs_by_name[algebra.name_].mapped[93], name, nbClass)
        ...
        class ComputeLayerLossRegression(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, reduction: algebra.compute.ComputeReduction, loss_type: algebra.compute.ComputeRegressionLoss) -> algebra.compute.ComputeLayerLossRegression:
                return algebra.compute.ComputeLayerLossRegression(greycat.libs_by_name[algebra.name_].mapped[94], name, reduction, loss_type)
        ...
        class ComputeOperationAsin(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAsin:
                return algebra.compute.ComputeOperationAsin(greycat.libs_by_name[algebra.name_].mapped[95], input, output)
        ...
        class ComputeOperationRelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, max_value: float, threshold: float) -> algebra.compute.ComputeOperationRelu:
                return algebra.compute.ComputeOperationRelu(greycat.libs_by_name[algebra.name_].mapped[96], input, output, max_value, threshold)
        ...
        class ComputeActivationHardSigmoid(GreyCat.Object):
            ...
            def create(greycat: GreyCat, slope: float, shift: float) -> algebra.compute.ComputeActivationHardSigmoid:
                return algebra.compute.ComputeActivationHardSigmoid(greycat.libs_by_name[algebra.name_].mapped[97], slope, shift)
        ...
        class ComputeOperationCos(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationCos:
                return algebra.compute.ComputeOperationCos(greycat.libs_by_name[algebra.name_].mapped[98], input, output)
        ...
        class ComputeInitializerUniformAvg(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerUniformAvg:
                return algebra.compute.ComputeInitializerUniformAvg(greycat.libs_by_name[algebra.name_].mapped[99])
        ...
        class ComputeOperationExp(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationExp:
                return algebra.compute.ComputeOperationExp(greycat.libs_by_name[algebra.name_].mapped[100], input, output)
        ...
        class ComputeReduction(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeReduction:
                return algebra.compute.ComputeReduction(greycat.libs_by_name[algebra.name_].mapped[101])
        ...
        class ComputeOperationSigmoid(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSigmoid:
                return algebra.compute.ComputeOperationSigmoid(greycat.libs_by_name[algebra.name_].mapped[102], input, output)
        ...
        class ComputeOperationCelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, alpha: float) -> algebra.compute.ComputeOperationCelu:
                return algebra.compute.ComputeOperationCelu(greycat.libs_by_name[algebra.name_].mapped[103], input, output, alpha)
        ...
        class ComputeOperationHardSigmoid(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, slope: float, shift: float) -> algebra.compute.ComputeOperationHardSigmoid:
                return algebra.compute.ComputeOperationHardSigmoid(greycat.libs_by_name[algebra.name_].mapped[104], input, output, slope, shift)
        ...
        class ComputeInitializerNormalAvg(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerNormalAvg:
                return algebra.compute.ComputeInitializerNormalAvg(greycat.libs_by_name[algebra.name_].mapped[105])
        ...
        class ComputeOperationLeCunTanh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationLeCunTanh:
                return algebra.compute.ComputeOperationLeCunTanh(greycat.libs_by_name[algebra.name_].mapped[106], input, output)
        ...
        class ComputeOperationFilter(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, mask: str, nbOutputs: int) -> algebra.compute.ComputeOperationFilter:
                return algebra.compute.ComputeOperationFilter(greycat.libs_by_name[algebra.name_].mapped[107], input, output, mask, nbOutputs)
        ...
        class ComputeActivationSoftplus(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationSoftplus:
                return algebra.compute.ComputeActivationSoftplus(greycat.libs_by_name[algebra.name_].mapped[108])
        ...
        class ComputeOperationAcosh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAcosh:
                return algebra.compute.ComputeOperationAcosh(greycat.libs_by_name[algebra.name_].mapped[109], input, output)
        ...
        class ComputeOperationElu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, alpha: float) -> algebra.compute.ComputeOperationElu:
                return algebra.compute.ComputeOperationElu(greycat.libs_by_name[algebra.name_].mapped[110], input, output, alpha)
        ...
        class ComputeOperationPow(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationPow:
                return algebra.compute.ComputeOperationPow(greycat.libs_by_name[algebra.name_].mapped[111], input, input2, output)
        ...
        class ComputeOperationSin(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSin:
                return algebra.compute.ComputeOperationSin(greycat.libs_by_name[algebra.name_].mapped[112], input, output)
        ...
        class ComputeOperationLeakyRelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, alpha: float, max_value: float, threshold: float) -> algebra.compute.ComputeOperationLeakyRelu:
                return algebra.compute.ComputeOperationLeakyRelu(greycat.libs_by_name[algebra.name_].mapped[113], input, output, alpha, max_value, threshold)
        ...
        class ComputeOperationAvg(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationAvg:
                return algebra.compute.ComputeOperationAvg(greycat.libs_by_name[algebra.name_].mapped[114], input, input2, output)
        ...
        class ComputeOptimizerFtrl(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[115]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, learning_rate: float, lambda1: float, lambda2: float, beta: float) -> algebra.compute.ComputeOptimizerFtrl:
                return algebra.compute.ComputeOptimizerFtrl(greycat.libs_by_name[algebra.name_].mapped[115], learning_rate, lambda1, lambda2, beta)
        ...
        class ComputeLayerLoss(GreyCat.Object):
            ...
            @staticmethod
            def var_computed_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[116]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, reduction: algebra.compute.ComputeReduction) -> algebra.compute.ComputeLayerLoss:
                return algebra.compute.ComputeLayerLoss(greycat.libs_by_name[algebra.name_].mapped[116], name, reduction)
        ...
        class ComputeOptimizerAdaDelta(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, decay_rate: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerAdaDelta:
                return algebra.compute.ComputeOptimizerAdaDelta(greycat.libs_by_name[algebra.name_].mapped[117], learning_rate, decay_rate, smooth_epsilon)
        ...
        class ComputeInitializerUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat, min: float, max: float) -> algebra.compute.ComputeInitializerUniform:
                return algebra.compute.ComputeInitializerUniform(greycat.libs_by_name[algebra.name_].mapped[118], min, max)
        ...
        class ComputeInitializerGlorotUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerGlorotUniform:
                return algebra.compute.ComputeInitializerGlorotUniform(greycat.libs_by_name[algebra.name_].mapped[119])
        ...
        class ComputeInitializerSigmoidUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerSigmoidUniform:
                return algebra.compute.ComputeInitializerSigmoidUniform(greycat.libs_by_name[algebra.name_].mapped[120])
        ...
        class ComputeOperationSub(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationSub:
                return algebra.compute.ComputeOperationSub(greycat.libs_by_name[algebra.name_].mapped[121], input, input2, output)
        ...
        class ComputeInitializerLeCunUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerLeCunUniform:
                return algebra.compute.ComputeInitializerLeCunUniform(greycat.libs_by_name[algebra.name_].mapped[122])
        ...
        class ComputeLayerCall(GreyCat.Object):
            ...
            def create(greycat: GreyCat, layer_name: str, bindings: std.core.Array) -> algebra.compute.ComputeLayerCall:
                return algebra.compute.ComputeLayerCall(greycat.libs_by_name[algebra.name_].mapped[123], layer_name, bindings)
        ...
        class ComputeOperationAbs(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAbs:
                return algebra.compute.ComputeOperationAbs(greycat.libs_by_name[algebra.name_].mapped[124], input, output)
        ...
        class ComputeOptimizerSgd(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[125]
                return t.static_values[0]

            @staticmethod
            def create(greycat: GreyCat, learning_rate: float) -> algebra.compute.ComputeOptimizerSgd:
                return algebra.compute.ComputeOptimizerSgd(greycat.libs_by_name[algebra.name_].mapped[125], learning_rate)
        ...
        class ComputeOptimizerNadam(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, beta1: float, beta2: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerNadam:
                return algebra.compute.ComputeOptimizerNadam(greycat.libs_by_name[algebra.name_].mapped[126], learning_rate, beta1, beta2, smooth_epsilon)
        ...
        class ComputeInitializerNone(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerNone:
                return algebra.compute.ComputeInitializerNone(greycat.libs_by_name[algebra.name_].mapped[127])
        ...
        class ComputeOperationAcos(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAcos:
                return algebra.compute.ComputeOperationAcos(greycat.libs_by_name[algebra.name_].mapped[128], input, output)
        ...
        class ComputeLayerCustom(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, ops: std.core.Array, vars: std.core.Array) -> algebra.compute.ComputeLayerCustom:
                return algebra.compute.ComputeLayerCustom(greycat.libs_by_name[algebra.name_].mapped[129], name, ops, vars)
        ...
        class ComputeOperationScale(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, alpha: float) -> algebra.compute.ComputeOperationScale:
                return algebra.compute.ComputeOperationScale(greycat.libs_by_name[algebra.name_].mapped[130], input, output, alpha)
        ...
        class ComputeOperationArg(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, output2: str) -> algebra.compute.ComputeOperationArg:
                return algebra.compute.ComputeOperationArg(greycat.libs_by_name[algebra.name_].mapped[131], input, output, output2)
        ...
        class ComputeInitializer(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializer:
                return algebra.compute.ComputeInitializer(greycat.libs_by_name[algebra.name_].mapped[132])
        ...
        class ComputeEngine(algebra_n.compute._ComputeEngine):
            ...
            def create(greycat: GreyCat) -> algebra_n.compute._ComputeEngine:
                return algebra.compute.ComputeEngine(greycat.libs_by_name[algebra.name_].mapped[133])
        ...
        class ComputeOperationAddBias(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationAddBias:
                return algebra.compute.ComputeOperationAddBias(greycat.libs_by_name[algebra.name_].mapped[134], input, input2, output)
        ...
        class ComputeOperationSoftplus(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSoftplus:
                return algebra.compute.ComputeOperationSoftplus(greycat.libs_by_name[algebra.name_].mapped[135], input, output)
        ...
        class ComputeVarOptimize(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, shape: std.core.Array, l1: float, l2: float, init: algebra.compute.ComputeInitializer) -> algebra.compute.ComputeVarOptimize:
                return algebra.compute.ComputeVarOptimize(greycat.libs_by_name[algebra.name_].mapped[136], name, type, shape, l1, l2, init)
        ...
        class ComputeOperationMul(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationMul:
                return algebra.compute.ComputeOperationMul(greycat.libs_by_name[algebra.name_].mapped[137], input, input2, output)
        ...
        class ComputeOperationMatMul(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str, transposeA: bool, transposeB: bool, alpha: float, beta: float) -> algebra.compute.ComputeOperationMatMul:
                return algebra.compute.ComputeOperationMatMul(greycat.libs_by_name[algebra.name_].mapped[138], input, input2, output, transposeA, transposeB, alpha, beta)
        ...
        class ComputeLayerLSTM(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, bias_initializer: algebra.compute.ComputeInitializer, weight_regularizer: algebra.compute.ComputeRegularizer, bias_regularizer: algebra.compute.ComputeRegularizer, type: std.core.TensorType, use_bias: bool, return_sequences: bool, bidirectional: bool, auto_init_states: bool, inputs: int, outputs: int, layers: int, sequences: int) -> algebra.compute.ComputeLayerLSTM:
                return algebra.compute.ComputeLayerLSTM(greycat.libs_by_name[algebra.name_].mapped[139], name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences)
        ...
        class ComputeOptimizerMomentum(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, decay_rate: float) -> algebra.compute.ComputeOptimizerMomentum:
                return algebra.compute.ComputeOptimizerMomentum(greycat.libs_by_name[algebra.name_].mapped[140], learning_rate, decay_rate)
        ...
        class ComputeInitializerReluUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerReluUniform:
                return algebra.compute.ComputeInitializerReluUniform(greycat.libs_by_name[algebra.name_].mapped[141])
        ...
        class ComputeActivation(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivation:
                return algebra.compute.ComputeActivation(greycat.libs_by_name[algebra.name_].mapped[142])
        ...
        class ComputeInitializerXavier(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerXavier:
                return algebra.compute.ComputeInitializerXavier(greycat.libs_by_name[algebra.name_].mapped[143])
        ...
        class ComputeVarInOut(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, shape: std.core.Array, with_grad: bool) -> algebra.compute.ComputeVarInOut:
                return algebra.compute.ComputeVarInOut(greycat.libs_by_name[algebra.name_].mapped[144], name, type, shape, with_grad)
        ...
        class ComputeOptimizerAdam(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[145]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, learning_rate: float, beta1: float, beta2: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerAdam:
                return algebra.compute.ComputeOptimizerAdam(greycat.libs_by_name[algebra.name_].mapped[145], learning_rate, beta1, beta2, smooth_epsilon)
        ...
        class ComputeLayer(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str) -> algebra.compute.ComputeLayer:
                return algebra.compute.ComputeLayer(greycat.libs_by_name[algebra.name_].mapped[146], name)
        ...
        class ComputeActivationExp(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationExp:
                return algebra.compute.ComputeActivationExp(greycat.libs_by_name[algebra.name_].mapped[147])
        ...
        class ComputeBinding(GreyCat.Object):
            ...
            def create(greycat: GreyCat, src_layer_name: str, src_var_name: str, target_var_name: str) -> algebra.compute.ComputeBinding:
                return algebra.compute.ComputeBinding(greycat.libs_by_name[algebra.name_].mapped[148], src_layer_name, src_var_name, target_var_name)
        ...
        class ComputeActivationSigmoid(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationSigmoid:
                return algebra.compute.ComputeActivationSigmoid(greycat.libs_by_name[algebra.name_].mapped[149])
        ...
        class ComputeOptimizerRmsProp(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[150]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, learning_rate: float, decay_rate: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerRmsProp:
                return algebra.compute.ComputeOptimizerRmsProp(greycat.libs_by_name[algebra.name_].mapped[150], learning_rate, decay_rate, smooth_epsilon)
        ...
        class ComputeOperationTan(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationTan:
                return algebra.compute.ComputeOperationTan(greycat.libs_by_name[algebra.name_].mapped[151], input, output)
        ...
        class ComputeOperationLog(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationLog:
                return algebra.compute.ComputeOperationLog(greycat.libs_by_name[algebra.name_].mapped[152], input, output)
        ...
        class ComputeInitializerUniformIn(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerUniformIn:
                return algebra.compute.ComputeInitializerUniformIn(greycat.libs_by_name[algebra.name_].mapped[153])
        ...
        class ComputeLayerActivation(GreyCat.Object):
            ...
            @staticmethod
            def var_input_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[154]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, activation: algebra.compute.ComputeActivation) -> algebra.compute.ComputeLayerActivation:
                return algebra.compute.ComputeLayerActivation(greycat.libs_by_name[algebra.name_].mapped[154], name, activation)
    ...
    class patterns:
        ...
        class RandomPatternDetectionEngine(GreyCat.Object):
            ...
            def create(greycat: GreyCat, timeseries: std.core.nodeTime, state: algebra.patterns.PatternDetectionEngineState, nullStrategy: algebra.patterns.PatternNullStrategy, nullReplaceConstant: float, samplingPolicy: algebra.patterns.SamplingPolicy, rng: std.util.Random) -> algebra.patterns.RandomPatternDetectionEngine:
                return algebra.patterns.RandomPatternDetectionEngine(greycat.libs_by_name[algebra.name_].mapped[155], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, rng)
        ...
        class PatternDetectionSensitivity(GreyCat.Object):
            ...
            def create(greycat: GreyCat, threshold: float, overlap: float) -> algebra.patterns.PatternDetectionSensitivity:
                return algebra.patterns.PatternDetectionSensitivity(greycat.libs_by_name[algebra.name_].mapped[156], threshold, overlap)
        ...
        class MatchingNormalisation(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.MatchingNormalisation:
                return algebra.patterns.MatchingNormalisation(greycat.libs_by_name[algebra.name_].mapped[157])
        ...
        class RandomPatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.RandomPatternDetector:
                return algebra.patterns.RandomPatternDetector(greycat.libs_by_name[algebra.name_].mapped[158])
        ...
        class PatternDetectionEngineState(GreyCat.Object):
            ...
            def create(greycat: GreyCat, hasScores: bool, hasDetections: bool, patterns: std.core.Array, scores: std.core.nodeList, detections: std.core.nodeTime) -> algebra.patterns.PatternDetectionEngineState:
                return algebra.patterns.PatternDetectionEngineState(greycat.libs_by_name[algebra.name_].mapped[159], hasScores, hasDetections, patterns, scores, detections)
        ...
        class FFTResult(GreyCat.Object):
            ...
            def create(greycat: GreyCat, distance: float, best_pattern: int, best_timespan: std.core.duration) -> algebra.patterns.FFTResult:
                return algebra.patterns.FFTResult(greycat.libs_by_name[algebra.name_].mapped[160], distance, best_pattern, best_timespan)
        ...
        class ScoreDetails(GreyCat.Object):
            ...
            def create(greycat: GreyCat, best_pattern: int, timespan: std.core.duration) -> algebra.patterns.ScoreDetails:
                return algebra.patterns.ScoreDetails(greycat.libs_by_name[algebra.name_].mapped[161], best_pattern, timespan)
        ...
        class SaxPatternDetectionEngine(GreyCat.Object):
            ...
            def alphabet(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[162]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, timeseries: std.core.nodeTime, state: algebra.patterns.PatternDetectionEngineState, nullStrategy: algebra.patterns.PatternNullStrategy, nullReplaceConstant: float, samplingPolicy: algebra.patterns.SamplingPolicy, alphabet_size: int, alphabet_boundaries: std.core.Array, lookup_table: std.core.nodeIndex, max_distance: float, pattern_fingerprints: std.core.Array, fingerprint_length: int) -> algebra.patterns.SaxPatternDetectionEngine:
                return algebra.patterns.SaxPatternDetectionEngine(greycat.libs_by_name[algebra.name_].mapped[162], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, alphabet_size, alphabet_boundaries, lookup_table, max_distance, pattern_fingerprints, fingerprint_length)
        ...
        class DTWPatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.DTWPatternDetector:
                return algebra.patterns.DTWPatternDetector(greycat.libs_by_name[algebra.name_].mapped[163])
        ...
        class OverlappingDetection(GreyCat.Object):
            ...
            def create(greycat: GreyCat, score: float, best_pattern: int, timespan: std.core.duration, overlap: std.core.duration) -> algebra.patterns.OverlappingDetection:
                return algebra.patterns.OverlappingDetection(greycat.libs_by_name[algebra.name_].mapped[164], score, best_pattern, timespan, overlap)
        ...
        class SamplingPolicy(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.SamplingPolicy:
                return algebra.patterns.SamplingPolicy(greycat.libs_by_name[algebra.name_].mapped[165])
        ...
        class EuclideanPatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.EuclideanPatternDetector:
                return algebra.patterns.EuclideanPatternDetector(greycat.libs_by_name[algebra.name_].mapped[166])
        ...
        class DTWPatternDetectionEngine(GreyCat.Object):
            ...
            def create(greycat: GreyCat, timeseries: std.core.nodeTime, state: algebra.patterns.PatternDetectionEngineState, nullStrategy: algebra.patterns.PatternNullStrategy, nullReplaceConstant: float, samplingPolicy: algebra.patterns.SamplingPolicy, std: float, matchingNormalisation: algebra.patterns.MatchingNormalisation) -> algebra.patterns.DTWPatternDetectionEngine:
                return algebra.patterns.DTWPatternDetectionEngine(greycat.libs_by_name[algebra.name_].mapped[167], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, std, matchingNormalisation)
        ...
        class EuclideanPatternDetectionEngine(GreyCat.Object):
            ...
            def create(greycat: GreyCat, timeseries: std.core.nodeTime, state: algebra.patterns.PatternDetectionEngineState, nullStrategy: algebra.patterns.PatternNullStrategy, nullReplaceConstant: float, samplingPolicy: algebra.patterns.SamplingPolicy, pattern_tensors: std.core.Array, window_tensors: std.core.Array, std: float, matchingNormalisation: algebra.patterns.MatchingNormalisation) -> algebra.patterns.EuclideanPatternDetectionEngine:
                return algebra.patterns.EuclideanPatternDetectionEngine(greycat.libs_by_name[algebra.name_].mapped[168], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, pattern_tensors, window_tensors, std, matchingNormalisation)
        ...
        class Detection(GreyCat.Object):
            ...
            def create(greycat: GreyCat, score: float, best_pattern: int, timespan: std.core.duration) -> algebra.patterns.Detection:
                return algebra.patterns.Detection(greycat.libs_by_name[algebra.name_].mapped[169], score, best_pattern, timespan)
        ...
        class ScoreDetailsSingleton(GreyCat.Object):
            ...
            def create(greycat: GreyCat, best_pattern: int, timespan: std.core.duration, timestamp: std.core.time) -> algebra.patterns.ScoreDetailsSingleton:
                return algebra.patterns.ScoreDetailsSingleton(greycat.libs_by_name[algebra.name_].mapped[170], best_pattern, timespan, timestamp)
        ...
        class SaxPatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat, alphabet_size: int, fingerprint_length: int) -> algebra.patterns.SaxPatternDetector:
                return algebra.patterns.SaxPatternDetector(greycat.libs_by_name[algebra.name_].mapped[171], alphabet_size, fingerprint_length)
        ...
        class PatternDetectors(GreyCat.Enum):
            ...
            def none(greycat: GreyCat) -> algebra.patterns.PatternDetectors:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[172]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> algebra.patterns.PatternDetectors:
                return algebra.patterns.PatternDetectors(greycat.libs_by_name[algebra.name_].mapped[172])
        ...
        class FFTPatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.FFTPatternDetector:
                return algebra.patterns.FFTPatternDetector(greycat.libs_by_name[algebra.name_].mapped[173])
        ...
        class PatternDetectionEngine(GreyCat.Object):
            ...
            def create(greycat: GreyCat, timeseries: std.core.nodeTime, state: algebra.patterns.PatternDetectionEngineState, nullStrategy: algebra.patterns.PatternNullStrategy, nullReplaceConstant: float, samplingPolicy: algebra.patterns.SamplingPolicy) -> algebra.patterns.PatternDetectionEngine:
                return algebra.patterns.PatternDetectionEngine(greycat.libs_by_name[algebra.name_].mapped[174], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy)
        ...
        class PatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.PatternDetector:
                return algebra.patterns.PatternDetector(greycat.libs_by_name[algebra.name_].mapped[177])
    ...
    def init(self, greycat: GreyCat) -> None:
        ...
        self.mapped[0].resolve_generated_offsets("abs", "angle_radians", "voltage", "voltage_img", "current", "current_img")
        self.mapped[1].resolve_generated_offsets("p_from_mw", "q_from_mvar", "p_to_mw", "q_to_mvar", "pl_mw", "ql_mvar", "i_from_ka", "i_to_ka", "i_ka", "vm_from_pu", "vm_to_pu", "va_from_radians", "va_to_radians", "loading_percent")
        self.mapped[2].resolve_generated_offset_with_values("none", "None", "min_max_scaling", "Min/Max Scaling", "standard_scaling", "Standard Scaling")
        self.mapped[3].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput")
        self.mapped[4].resolve_generated_offsets("previousLayerName", "previousLayerOutput", "expectedLayerName", "expectedLayerOutput", "postLayer")
        self.mapped[5].resolve_generated_offset_with_values("none", "None", "constant", "Constant", "sigmoid_uniform", "SigmoidUniform", "lecun_uniform", "LeCunUniform", "xavier", "Xavier", "xavier_uniform", "XavierUniform", "relu", "Relu", "relu_uniform", "ReluUniform", "normal", "Normal", "normal_in", "NormalIn", "normal_out", "NormalOut", "normal_avg", "NormalAvg", "uniform", "Uniform", "uniform_in", "UniformIn", "uniform_out", "UniformOut", "uniform_avg", "UniformAvg", "identity", "Identity", "pytorch", "Pytorch")
        self.mapped[6].resolve_generated_offsets("weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer")
        self.mapped[7].resolve_generated_offset_with_values("linear", "Linear", "dense", "Dense", "activation", "Activation", "lstm", "LSTM", "loss", "Loss", "filter", "Filter")
        self.mapped[8].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput", "calculate_probabilities", "has_class_weights", "from_logits")
        self.mapped[9].resolve_generated_offset_with_values("ada_delta", "Ada Delta", "ada_grad", "Ada Grad", "adam", "Adam", "ada_max", "Ada Max", "nadam", "NAdam", "ftrl", "Ftrl", "sgd", "Stochastic Gradient Descent", "rms_prop", "RMS Prop", "momentum", "Momentum", "nesterov", "Nesterov")
        self.mapped[10].resolve_generated_offsets("precision", "recall", "f1Score")
        self.mapped[11].resolve_generated_offset_with_values("none", "None", "min_max_scaling", "Min/Max Scaling", "standard_scaling", "Standard Scaling", "pca_scaling", "PCA Scaling")
        self.mapped[12].resolve_generated_offset_with_values("relu", "Relu", "leaky_relu", "Leaky Relu", "sigmoid", "Sigmoid", "hard_sigmoid", "Hard Sigmoid", "exp", "Exp", "soft_max", "Soft Max", "soft_plus", "Soft Plus", "soft_sign", "Soft Sign", "tanh", "Tanh", "selu", "Selu", "elu", "Elu", "celu", "Celu")
        self.mapped[13].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput")
        self.mapped[13].static_values = ["Inputs or outputs can't be negative", "Last layer has different number of outputs than declared", "Incompatible loss function", "Some NN layers are not currently supported", "Tensor Type not currently supported", "NN should contain at least 1 layer", "layer placeholders", "layer classification", "layer preprocess", "layer postprocess learn", "layer main", "layer loss learn", "layer loss display", "layer postprocess display", "layer confusion", "seq predict", "seq postprocess", "seq learn", "seq loss display", "seq encode", "seq decode", "seq confusion", "var input", "var enc input", "var targets", "var Classifier classes", "var Classifier probabilities", "var Classifier class weights", "var Classifier confusion", "var input avg", "var input min", "var input max", "var input std", "var input space", "var output avg", "var output min", "var output max", "var output std"]
        self.mapped[14].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput", "encoder_layer_idx", "encoder_layer_name", "encoder_layer_var")
        ...
        self.mapped[16].resolve_generated_offsets("counts", "x_labels", "y_labels", "counts_max", "counts_sum")
        self.mapped[18].static_values = [0.95]
        ...
        self.mapped[23].static_values = ["input", "assignement", "min_distance", "centroids", "distance", "sum_centroids", "sum_min_distance", "count_centroids", "centroid_distances", "sum_cluster_distances", "avg_cluster_distances", "count_cluster_distances", "placeholders", "kmeans_forward", "kmeans_backward", "kmeans_init_round", "kmeans_end_round", "kmeans_stats_layer", "kmeans_init_round_seq", "kmeans_forward_seq", "kmeans_backward_seq", "kmeans_end_round_seq", "kmeans_stats_seq", 100, 20]
        self.mapped[24].resolve_generated_offsets("runDistances", "bestResult")
        self.mapped[25].resolve_generated_offsets("loss", "roundsDistances", "centroids", "clusters_count", "clusters_sum_distance", "clusters_avg_distance", "assignement", "distances", "clusterInterDistances")
        self.mapped[26].resolve_generated_offsets("epoch", "optimizationSteps", "batchNotOptimized")
        self.mapped[27].resolve_generated_offsets("input", "output", "axis")
        self.mapped[29].resolve_generated_offsets("input", "output")
        self.mapped[30].resolve_generated_offsets("max_value", "threshold")
        self.mapped[30].static_values = [0.0]
        self.mapped[31].resolve_generated_offsets("input", "output")
        self.mapped[32].resolve_generated_offsets("alpha", "max_value", "threshold")
        self.mapped[32].static_values = [0.3, 0.0]
        self.mapped[33].resolve_generated_offsets("l1", "l2")
        self.mapped[36].resolve_generated_offsets("input", "value")
        self.mapped[37].resolve_generated_offsets("name", "type", "inputs", "outputs", "use_bias", "weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer", "activation")
        self.mapped[37].static_values = ["input", "output", "weight", "bias", "mult", "pre_activation"]
        self.mapped[38].resolve_generated_offsets("input", "output", "output2")
        self.mapped[39].resolve_generated_offsets("input", "output")
        self.mapped[40].resolve_generated_offsets("input", "input2", "output")
        self.mapped[41].resolve_generated_offsets("input", "output")
        self.mapped[42].resolve_generated_offsets("learning_rate", "decay_rate")
        self.mapped[42].static_values = [0.001, 0.9]
        self.mapped[44].resolve_generated_offsets("input", "output", "power")
        self.mapped[46].resolve_generated_offsets("name", "calculate_probabilities", "from_logits")
        self.mapped[46].static_values = ["input", "predicted_classes", "probabilities"]
        self.mapped[47].resolve_generated_offset_with_values("square", "Square", "abs", "Abs")
        self.mapped[48].resolve_generated_offsets("alpha")
        self.mapped[48].static_values = [1.0]
        self.mapped[49].resolve_generated_offsets("name")
        self.mapped[50].resolve_generated_offsets("input", "output", "axis")
        self.mapped[51].resolve_generated_offsets("layers")
        self.mapped[52].resolve_generated_offsets("name", "type", "inverse_transform")
        self.mapped[52].static_values = ["input", "output", "min", "max"]
        self.mapped[53].resolve_generated_offsets("input", "output")
        self.mapped[54].resolve_generated_offsets("input", "input2", "output")
        self.mapped[55].resolve_generated_offsets("input", "output")
        self.mapped[56].resolve_generated_offsets("value")
        self.mapped[57].resolve_generated_offsets("input", "ifCondition", "output", "counts", "classes")
        self.mapped[58].resolve_generated_offsets("input", "output", "output2")
        self.mapped[59].resolve_generated_offsets("name", "reduction", "loss_type", "has_class_weights", "calculate_probabilities", "from_logits")
        self.mapped[59].static_values = ["class_weights", "predicted_classes", "probabilities", "sum_reduce"]
        self.mapped[61].resolve_generated_offsets("alpha")
        self.mapped[61].static_values = [1.0]
        self.mapped[62].resolve_generated_offsets("input", "output")
        self.mapped[63].resolve_generated_offsets("learning_rate")
        self.mapped[64].resolve_generated_offsets("input", "output", "min", "max")
        self.mapped[65].resolve_generated_offsets("name", "type", "inputs", "outputs", "maskValues")
        self.mapped[65].static_values = ["input", "output", "mask"]
        self.mapped[66].resolve_generated_offsets("input", "input2", "output")
        self.mapped[68].resolve_generated_offsets("name")
        self.mapped[70].resolve_generated_offsets("input", "output")
        self.mapped[73].resolve_generated_offsets("input", "output")
        self.mapped[74].resolve_generated_offsets("name", "type", "inputs", "outputs", "use_bias", "weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer")
        self.mapped[74].static_values = ["input", "output", "weight", "bias", "mult"]
        self.mapped[75].resolve_generated_offsets("input", "input2", "output")
        self.mapped[76].resolve_generated_offsets("input", "output")
        self.mapped[77].resolve_generated_offsets("input", "output")
        self.mapped[78].resolve_generated_offset_with_values("categorical_cross_entropy", "Categorical Cross Entropy", "sparse_categorical_cross_entropy", "Sparse Categorical Cross Entropy")
        self.mapped[79].resolve_generated_offsets("name", "type", "inverse_transform")
        self.mapped[79].static_values = ["input", "output", "avg", "std", "space"]
        self.mapped[80].resolve_generated_offsets("name", "type", "shape")
        self.mapped[82].resolve_generated_offsets("name", "type", "inverse_transform")
        self.mapped[82].static_values = ["input", "output", "avg", "std"]
        self.mapped[83].resolve_generated_offsets("input", "output")
        self.mapped[85].resolve_generated_offsets("avg", "std")
        self.mapped[86].resolve_generated_offsets("learning_rate", "beta1", "beta2", "smooth_epsilon")
        self.mapped[86].static_values = [0.001, 0.9, 0.999, 0.0000001]
        self.mapped[87].resolve_generated_offsets("name", "calls", "optimizer")
        self.mapped[88].resolve_generated_offsets("name")
        self.mapped[90].resolve_generated_offsets("learning_rate", "initial_accumulator", "smooth_epsilon")
        self.mapped[90].static_values = [0.001, 0.1, 0.0000001]
        self.mapped[91].resolve_generated_offsets("classes")
        self.mapped[92].resolve_generated_offsets("input", "output")
        self.mapped[93].resolve_generated_offsets("name", "nbClass")
        self.mapped[93].static_values = ["computed", "expected", "confusion"]
        self.mapped[94].resolve_generated_offsets("name", "reduction", "loss_type")
        self.mapped[95].resolve_generated_offsets("input", "output")
        self.mapped[96].resolve_generated_offsets("input", "output", "max_value", "threshold")
        self.mapped[96].static_values = [0.0]
        self.mapped[97].resolve_generated_offsets("slope", "shift")
        self.mapped[97].static_values = [0.2, 0.5]
        self.mapped[98].resolve_generated_offsets("input", "output")
        self.mapped[100].resolve_generated_offsets("input", "output")
        self.mapped[101].resolve_generated_offset_with_values("auto", "auto", "none", "none", "sum", "sum", "mean", "mean", "disabled", "disabled")
        self.mapped[102].resolve_generated_offsets("input", "output")
        self.mapped[103].resolve_generated_offsets("input", "output", "alpha")
        self.mapped[103].static_values = [1.0]
        self.mapped[104].resolve_generated_offsets("input", "output", "slope", "shift")
        self.mapped[104].static_values = [0.2, 0.5]
        self.mapped[106].resolve_generated_offsets("input", "output")
        self.mapped[107].resolve_generated_offsets("input", "output", "mask", "nbOutputs")
        self.mapped[109].resolve_generated_offsets("input", "output")
        self.mapped[110].resolve_generated_offsets("input", "output", "alpha")
        self.mapped[110].static_values = [1.0]
        self.mapped[111].resolve_generated_offsets("input", "input2", "output")
        self.mapped[112].resolve_generated_offsets("input", "output")
        self.mapped[113].resolve_generated_offsets("input", "output", "alpha", "max_value", "threshold")
        self.mapped[113].static_values = [0.3, 1.7976931349E308, 0.0]
        self.mapped[114].resolve_generated_offsets("input", "input2", "output")
        self.mapped[115].resolve_generated_offsets("learning_rate", "lambda1", "lambda2", "beta")
        self.mapped[115].static_values = [0.001, 0.0, 0.0, 0.0]
        self.mapped[116].resolve_generated_offsets("name", "reduction")
        self.mapped[116].static_values = ["computed", "expected", "loss"]
        self.mapped[117].resolve_generated_offsets("learning_rate", "decay_rate", "smooth_epsilon")
        self.mapped[117].static_values = [0.001, 0.95, 0.0000001]
        self.mapped[118].resolve_generated_offsets("min", "max")
        self.mapped[121].resolve_generated_offsets("input", "input2", "output")
        self.mapped[123].resolve_generated_offsets("layer_name", "bindings")
        self.mapped[124].resolve_generated_offsets("input", "output")
        self.mapped[125].resolve_generated_offsets("learning_rate")
        self.mapped[125].static_values = [0.01]
        self.mapped[126].resolve_generated_offsets("learning_rate", "beta1", "beta2", "smooth_epsilon")
        self.mapped[126].static_values = [0.001, 0.9, 0.999, 0.0000001]
        self.mapped[128].resolve_generated_offsets("input", "output")
        self.mapped[129].resolve_generated_offsets("name", "ops", "vars")
        self.mapped[130].resolve_generated_offsets("input", "output", "alpha")
        self.mapped[131].resolve_generated_offsets("input", "output", "output2")
        self.mapped[134].resolve_generated_offsets("input", "input2", "output")
        self.mapped[135].resolve_generated_offsets("input", "output")
        self.mapped[136].resolve_generated_offsets("name", "type", "shape", "l1", "l2", "init")
        self.mapped[137].resolve_generated_offsets("input", "input2", "output")
        self.mapped[138].resolve_generated_offsets("input", "input2", "output", "transposeA", "transposeB", "alpha", "beta")
        self.mapped[138].static_values = [false, 1.0, 0.0]
        self.mapped[139].resolve_generated_offsets("name", "bias_initializer", "weight_regularizer", "bias_regularizer", "type", "use_bias", "return_sequences", "bidirectional", "auto_init_states", "inputs", "outputs", "layers", "sequences")
        self.mapped[139].static_values = ["input", "output", "hx", "cx", "hy", "cy", "weight", "bias", "internal_i", "internal_f", "internal_cp", "internal_o", "internal_h", "internal_c", "internal_mult", "internal_output"]
        self.mapped[140].resolve_generated_offsets("learning_rate", "decay_rate")
        self.mapped[140].static_values = [0.001, 0.9]
        self.mapped[144].resolve_generated_offsets("name", "type", "shape", "with_grad")
        self.mapped[145].resolve_generated_offsets("learning_rate", "beta1", "beta2", "smooth_epsilon")
        self.mapped[145].static_values = [0.001, 0.9, 0.999, 0.0000001]
        self.mapped[146].resolve_generated_offsets("name")
        self.mapped[148].resolve_generated_offsets("src_layer_name", "src_var_name", "target_var_name")
        self.mapped[150].resolve_generated_offsets("learning_rate", "decay_rate", "smooth_epsilon")
        self.mapped[150].static_values = [0.001, 0.9, 0.0000001]
        self.mapped[151].resolve_generated_offsets("input", "output")
        self.mapped[152].resolve_generated_offsets("input", "output")
        self.mapped[154].resolve_generated_offsets("name", "activation")
        self.mapped[154].static_values = ["input", "output"]
        self.mapped[155].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "rng")
        self.mapped[156].resolve_generated_offsets("threshold", "overlap")
        self.mapped[157].resolve_generated_offset_with_values("as_is", "As-is", "shift", "Vertical shift", "scaling", "Vertical scaling", "shift_and_scaling", "Vertical shift and scaling")
        self.mapped[159].resolve_generated_offsets("hasScores", "hasDetections", "patterns", "scores", "detections")
        self.mapped[160].resolve_generated_offsets("distance", "best_pattern", "best_timespan")
        self.mapped[161].resolve_generated_offsets("best_pattern", "timespan")
        self.mapped[162].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "alphabet_size", "alphabet_boundaries", "lookup_table", "max_distance", "pattern_fingerprints", "fingerprint_length")
        self.mapped[162].static_values = ["ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz"]
        self.mapped[164].resolve_generated_offsets("score", "best_pattern", "timespan", "overlap")
        self.mapped[165].resolve_generated_offset_with_values("as_is", "As-is", "average_frequency", "Average frequency", "highest_frequency", "Highest frequency")
        self.mapped[167].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "std", "matchingNormalisation")
        self.mapped[168].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "pattern_tensors", "window_tensors", "std", "matchingNormalisation")
        self.mapped[169].resolve_generated_offsets("score", "best_pattern", "timespan")
        self.mapped[170].resolve_generated_offsets("best_pattern", "timespan", "timestamp")
        self.mapped[171].resolve_generated_offsets("alphabet_size", "fingerprint_length")
        self.mapped[172].resolve_generated_offset_with_values("none", "None", "euclidean", "Euclidean", "fft", "FFT", "dtw", "DTW", "random", "Random", "sax", "SAX")
        self.mapped[174].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy")
        self.mapped[175].resolve_generated_offset_with_values("replace", "Replace", "interpolate", "Interpolate", "previous", "Previous", "next", "Next", "none", "None")
