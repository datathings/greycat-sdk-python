...
class algebra(GreyCat.Library):
    ...
    class compute:
        ...
        class ComputeVarProxy(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str) -> algebra.compute.ComputeVarProxy:
                return algebra.compute.ComputeVarProxy(greycat.libs_by_name[algebra.name_].mapped[0], name)
        ...
        class ComputeInitializerNone(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerNone:
                return algebra.compute.ComputeInitializerNone(greycat.libs_by_name[algebra.name_].mapped[1])
        ...
        class ComputeActivationSoftSign(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationSoftSign:
                return algebra.compute.ComputeActivationSoftSign(greycat.libs_by_name[algebra.name_].mapped[2])
        ...
        class ComputeOperationFilter(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, mask: str, nbOutputs: int) -> algebra.compute.ComputeOperationFilter:
                return algebra.compute.ComputeOperationFilter(greycat.libs_by_name[algebra.name_].mapped[3], input, output, mask, nbOutputs)
        ...
        class ComputeOperationAtan(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAtan:
                return algebra.compute.ComputeOperationAtan(greycat.libs_by_name[algebra.name_].mapped[4], input, output)
        ...
        class ComputeInitializerNormalOut(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerNormalOut:
                return algebra.compute.ComputeInitializerNormalOut(greycat.libs_by_name[algebra.name_].mapped[5])
        ...
        class ComputeOperationLogSoftmax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, axis: int) -> algebra.compute.ComputeOperationLogSoftmax:
                return algebra.compute.ComputeOperationLogSoftmax(greycat.libs_by_name[algebra.name_].mapped[6], input, output, axis)
        ...
        class ComputeOperationCos(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationCos:
                return algebra.compute.ComputeOperationCos(greycat.libs_by_name[algebra.name_].mapped[7], input, output)
        ...
        class ComputeOperationPow(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationPow:
                return algebra.compute.ComputeOperationPow(greycat.libs_by_name[algebra.name_].mapped[8], input, input2, output)
        ...
        class ComputeOperationSumIf(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, ifCondition: str, output: str, counts: str, classes: int) -> algebra.compute.ComputeOperationSumIf:
                return algebra.compute.ComputeOperationSumIf(greycat.libs_by_name[algebra.name_].mapped[9], input, ifCondition, output, counts, classes)
        ...
        class ComputeInitializerUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat, min: float, max: float) -> algebra.compute.ComputeInitializerUniform:
                return algebra.compute.ComputeInitializerUniform(greycat.libs_by_name[algebra.name_].mapped[10], min, max)
        ...
        class ComputeActivationLeakyRelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, alpha: float, max_value: float, threshold: float) -> algebra.compute.ComputeActivationLeakyRelu:
                return algebra.compute.ComputeActivationLeakyRelu(greycat.libs_by_name[algebra.name_].mapped[11], alpha, max_value, threshold)
        ...
        class ComputeOperation2In1Out(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperation2In1Out:
                return algebra.compute.ComputeOperation2In1Out(greycat.libs_by_name[algebra.name_].mapped[12], input, input2, output)
        ...
        class ComputeLayerLossClassification(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, reduction: algebra.compute.ComputeReduction, loss_type: algebra.compute.ComputeClassificationLoss, has_class_weights: bool, calculate_probabilities: bool, from_logits: bool) -> algebra.compute.ComputeLayerLossClassification:
                return algebra.compute.ComputeLayerLossClassification(greycat.libs_by_name[algebra.name_].mapped[13], name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits)
        ...
        class ComputeLayerConfusion(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, nbClass: int) -> algebra.compute.ComputeLayerConfusion:
                return algebra.compute.ComputeLayerConfusion(greycat.libs_by_name[algebra.name_].mapped[14], name, nbClass)
        ...
        class ComputeOperationArg(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, output2: str) -> algebra.compute.ComputeOperationArg:
                return algebra.compute.ComputeOperationArg(greycat.libs_by_name[algebra.name_].mapped[15], input, output, output2)
        ...
        class ComputeOperationNeg(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationNeg:
                return algebra.compute.ComputeOperationNeg(greycat.libs_by_name[algebra.name_].mapped[16], input, output)
        ...
        class ComputeLayerStandardScaler(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inverse_transform: bool) -> algebra.compute.ComputeLayerStandardScaler:
                return algebra.compute.ComputeLayerStandardScaler(greycat.libs_by_name[algebra.name_].mapped[17], name, type, inverse_transform)
        ...
        class ComputeLayerLoss(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, reduction: algebra.compute.ComputeReduction) -> algebra.compute.ComputeLayerLoss:
                return algebra.compute.ComputeLayerLoss(greycat.libs_by_name[algebra.name_].mapped[18], name, reduction)
        ...
        class ComputeLayerClassification(GreyCat.Object):
            ...
            @staticmethod
            def var_input_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[19]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, calculate_probabilities: bool, from_logits: bool) -> algebra.compute.ComputeLayerClassification:
                return algebra.compute.ComputeLayerClassification(greycat.libs_by_name[algebra.name_].mapped[19], name, calculate_probabilities, from_logits)
        ...
        class ComputeInitializerReluUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerReluUniform:
                return algebra.compute.ComputeInitializerReluUniform(greycat.libs_by_name[algebra.name_].mapped[20])
        ...
        class ComputeOperationArgMax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, output2: str) -> algebra.compute.ComputeOperationArgMax:
                return algebra.compute.ComputeOperationArgMax(greycat.libs_by_name[algebra.name_].mapped[21], input, output, output2)
        ...
        class ComputeOperationSum(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, axis: int) -> algebra.compute.ComputeOperationSum:
                return algebra.compute.ComputeOperationSum(greycat.libs_by_name[algebra.name_].mapped[22], input, output, axis)
        ...
        class ComputeInitializerXavier(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerXavier:
                return algebra.compute.ComputeInitializerXavier(greycat.libs_by_name[algebra.name_].mapped[23])
        ...
        class ComputeOperationEuclidean(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationEuclidean:
                return algebra.compute.ComputeOperationEuclidean(greycat.libs_by_name[algebra.name_].mapped[24], input, input2, output)
        ...
        class ComputeInitializer(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializer:
                return algebra.compute.ComputeInitializer(greycat.libs_by_name[algebra.name_].mapped[25])
        ...
        class ComputeActivationTanh(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationTanh:
                return algebra.compute.ComputeActivationTanh(greycat.libs_by_name[algebra.name_].mapped[26])
        ...
        class ComputeOptimizerAdaDelta(GreyCat.Object):
            ...
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[27]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, learning_rate: float, decay_rate: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerAdaDelta:
                return algebra.compute.ComputeOptimizerAdaDelta(greycat.libs_by_name[algebra.name_].mapped[27], learning_rate, decay_rate, smooth_epsilon)
        ...
        class ComputeOptimizerRmsProp(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[28]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, learning_rate: float, decay_rate: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerRmsProp:
                return algebra.compute.ComputeOptimizerRmsProp(greycat.libs_by_name[algebra.name_].mapped[28], learning_rate, decay_rate, smooth_epsilon)
        ...
        class ComputeLayerFilter(GreyCat.Object):
            ...
            @staticmethod
            def var_input_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[29]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inputs: int, outputs: int, maskValues: std.core.Array) -> algebra.compute.ComputeLayerFilter:
                return algebra.compute.ComputeLayerFilter(greycat.libs_by_name[algebra.name_].mapped[29], name, type, inputs, outputs, maskValues)
        ...
        class ComputeReduction(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeReduction:
                return algebra.compute.ComputeReduction(greycat.libs_by_name[algebra.name_].mapped[30])
        ...
        class ComputeOperationAtanh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAtanh:
                return algebra.compute.ComputeOperationAtanh(greycat.libs_by_name[algebra.name_].mapped[31], input, output)
        ...
        class ComputeOperationSinh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSinh:
                return algebra.compute.ComputeOperationSinh(greycat.libs_by_name[algebra.name_].mapped[32], input, output)
        ...
        class ComputeOperationSoftplus(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSoftplus:
                return algebra.compute.ComputeOperationSoftplus(greycat.libs_by_name[algebra.name_].mapped[33], input, output)
        ...
        class ComputeOperationAsinh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAsinh:
                return algebra.compute.ComputeOperationAsinh(greycat.libs_by_name[algebra.name_].mapped[35], input, output)
        ...
        class ComputeLayerCustom(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, ops: std.core.Array, vars: std.core.Array) -> algebra.compute.ComputeLayerCustom:
                return algebra.compute.ComputeLayerCustom(greycat.libs_by_name[algebra.name_].mapped[36], name, ops, vars)
        ...
        class ComputeClassificationLoss(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeClassificationLoss:
                return algebra.compute.ComputeClassificationLoss(greycat.libs_by_name[algebra.name_].mapped[37])
        ...
        class ComputeState(algebra_n.compute._ComputeState):
            ...
            def create(greycat: GreyCat) -> algebra_n.compute._ComputeState:
                return algebra.compute.ComputeState(greycat.libs_by_name[algebra.name_].mapped[38])
        ...
        class ComputeOperationSin(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSin:
                return algebra.compute.ComputeOperationSin(greycat.libs_by_name[algebra.name_].mapped[39], input, output)
        ...
        class ComputeVariable(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str) -> algebra.compute.ComputeVariable:
                return algebra.compute.ComputeVariable(greycat.libs_by_name[algebra.name_].mapped[40], name)
        ...
        class ComputeOperationRaiseToPower(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, power: float) -> algebra.compute.ComputeOperationRaiseToPower:
                return algebra.compute.ComputeOperationRaiseToPower(greycat.libs_by_name[algebra.name_].mapped[41], input, output, power)
        ...
        class ComputeOperationCelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, alpha: float) -> algebra.compute.ComputeOperationCelu:
                return algebra.compute.ComputeOperationCelu(greycat.libs_by_name[algebra.name_].mapped[42], input, output, alpha)
        ...
        class ComputeOperationLog(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationLog:
                return algebra.compute.ComputeOperationLog(greycat.libs_by_name[algebra.name_].mapped[43], input, output)
        ...
        class ComputeOperationMatMul(GreyCat.Object):
            ...
            def transpose_def(greycat: GreyCat) -> bool:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[44]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str, transposeA: bool, transposeB: bool, alpha: float, beta: float) -> algebra.compute.ComputeOperationMatMul:
                return algebra.compute.ComputeOperationMatMul(greycat.libs_by_name[algebra.name_].mapped[44], input, input2, output, transposeA, transposeB, alpha, beta)
        ...
        class ComputeOperationRelu(GreyCat.Object):
            ...
            @staticmethod
            def threshold_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[45]
                return t.static_values[0]

            @staticmethod
            def create(greycat: GreyCat, input: str, output: str, max_value: float, threshold: float) -> algebra.compute.ComputeOperationRelu:
                return algebra.compute.ComputeOperationRelu(greycat.libs_by_name[algebra.name_].mapped[45], input, output, max_value, threshold)
        ...
        class ComputeActivationSelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationSelu:
                return algebra.compute.ComputeActivationSelu(greycat.libs_by_name[algebra.name_].mapped[46])
        ...
        class ComputeInitializerNormalAvg(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerNormalAvg:
                return algebra.compute.ComputeInitializerNormalAvg(greycat.libs_by_name[algebra.name_].mapped[47])
        ...
        class ComputeInitializerUniformOut(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerUniformOut:
                return algebra.compute.ComputeInitializerUniformOut(greycat.libs_by_name[algebra.name_].mapped[48])
        ...
        class ComputeRegularizer(GreyCat.Object):
            ...
            def create(greycat: GreyCat, l1: float, l2: float) -> algebra.compute.ComputeRegularizer:
                return algebra.compute.ComputeRegularizer(greycat.libs_by_name[algebra.name_].mapped[49], l1, l2)
        ...
        class ComputeOperationExp(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationExp:
                return algebra.compute.ComputeOperationExp(greycat.libs_by_name[algebra.name_].mapped[50], input, output)
        ...
        class ComputeOperationMul(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationMul:
                return algebra.compute.ComputeOperationMul(greycat.libs_by_name[algebra.name_].mapped[51], input, input2, output)
        ...
        class ComputeOperationTanh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationTanh:
                return algebra.compute.ComputeOperationTanh(greycat.libs_by_name[algebra.name_].mapped[52], input, output)
        ...
        class ComputeOperationAbs(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAbs:
                return algebra.compute.ComputeOperationAbs(greycat.libs_by_name[algebra.name_].mapped[53], input, output)
        ...
        class ComputeVarConst(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, shape: std.core.Array) -> algebra.compute.ComputeVarConst:
                return algebra.compute.ComputeVarConst(greycat.libs_by_name[algebra.name_].mapped[54], name, type, shape)
        ...
        class ComputeModel(GreyCat.Object):
            ...
            def create(greycat: GreyCat, layers: std.core.Array) -> algebra.compute.ComputeModel:
                return algebra.compute.ComputeModel(greycat.libs_by_name[algebra.name_].mapped[55], layers)
        ...
        class ComputeInitializerIdentity(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerIdentity:
                return algebra.compute.ComputeInitializerIdentity(greycat.libs_by_name[algebra.name_].mapped[56])
        ...
        class ComputeVarOptimize(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, shape: std.core.Array, l1: float, l2: float, init: algebra.compute.ComputeInitializer) -> algebra.compute.ComputeVarOptimize:
                return algebra.compute.ComputeVarOptimize(greycat.libs_by_name[algebra.name_].mapped[57], name, type, shape, l1, l2, init)
        ...
        class ComputeActivationSoftplus(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationSoftplus:
                return algebra.compute.ComputeActivationSoftplus(greycat.libs_by_name[algebra.name_].mapped[58])
        ...
        class ComputeOptimizerFtrl(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, lambda1: float, lambda2: float, beta: float) -> algebra.compute.ComputeOptimizerFtrl:
                return algebra.compute.ComputeOptimizerFtrl(greycat.libs_by_name[algebra.name_].mapped[59], learning_rate, lambda1, lambda2, beta)
        ...
        class ComputeOptimizerSgd(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[60]
                return t.static_values[0]

            @staticmethod
            def create(greycat: GreyCat, learning_rate: float) -> algebra.compute.ComputeOptimizerSgd:
                return algebra.compute.ComputeOptimizerSgd(greycat.libs_by_name[algebra.name_].mapped[60], learning_rate)
        ...
        class ComputeLayerLinear(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inputs: int, outputs: int, use_bias: bool, weight_initializer: algebra.compute.ComputeInitializer, weight_regularizer: algebra.compute.ComputeRegularizer, bias_initializer: algebra.compute.ComputeInitializer, bias_regularizer: algebra.compute.ComputeRegularizer) -> algebra.compute.ComputeLayerLinear:
                return algebra.compute.ComputeLayerLinear(greycat.libs_by_name[algebra.name_].mapped[61], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer)
        ...
        class ComputeOptimizerAdaMax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, beta1: float, beta2: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerAdaMax:
                return algebra.compute.ComputeOptimizerAdaMax(greycat.libs_by_name[algebra.name_].mapped[62], learning_rate, beta1, beta2, smooth_epsilon)
        ...
        class ComputeLayerLossRegression(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, reduction: algebra.compute.ComputeReduction, loss_type: algebra.compute.ComputeRegressionLoss) -> algebra.compute.ComputeLayerLossRegression:
                return algebra.compute.ComputeLayerLossRegression(greycat.libs_by_name[algebra.name_].mapped[63], name, reduction, loss_type)
        ...
        class ComputeOperationAdd(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationAdd:
                return algebra.compute.ComputeOperationAdd(greycat.libs_by_name[algebra.name_].mapped[65], input, input2, output)
        ...
        class ComputeOperationAddBias(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationAddBias:
                return algebra.compute.ComputeOperationAddBias(greycat.libs_by_name[algebra.name_].mapped[66], input, input2, output)
        ...
        class ComputeInitializerGlorotUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerGlorotUniform:
                return algebra.compute.ComputeInitializerGlorotUniform(greycat.libs_by_name[algebra.name_].mapped[67])
        ...
        class ComputeInitializerLSTM(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerLSTM:
                return algebra.compute.ComputeInitializerLSTM(greycat.libs_by_name[algebra.name_].mapped[68])
        ...
        class ComputeOperation1In1Out(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperation1In1Out:
                return algebra.compute.ComputeOperation1In1Out(greycat.libs_by_name[algebra.name_].mapped[69], input, output)
        ...
        class ComputeOperationSelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSelu:
                return algebra.compute.ComputeOperationSelu(greycat.libs_by_name[algebra.name_].mapped[70], input, output)
        ...
        class ComputeLayerLSTM(GreyCat.Object):
            ...
            @staticmethod
            def var_input_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[71]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, bias_initializer: algebra.compute.ComputeInitializer, weight_regularizer: algebra.compute.ComputeRegularizer, bias_regularizer: algebra.compute.ComputeRegularizer, type: std.core.TensorType, use_bias: bool, return_sequences: bool, bidirectional: bool, auto_init_states: bool, inputs: int, outputs: int, layers: int, sequences: int) -> algebra.compute.ComputeLayerLSTM:
                return algebra.compute.ComputeLayerLSTM(greycat.libs_by_name[algebra.name_].mapped[71], name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences)
        ...
        class ComputeOperationSigmoid(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSigmoid:
                return algebra.compute.ComputeOperationSigmoid(greycat.libs_by_name[algebra.name_].mapped[72], input, output)
        ...
        class ComputeOperationSoftmax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSoftmax:
                return algebra.compute.ComputeOperationSoftmax(greycat.libs_by_name[algebra.name_].mapped[73], input, output)
        ...
        class ComputeInitializerLeCunUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerLeCunUniform:
                return algebra.compute.ComputeInitializerLeCunUniform(greycat.libs_by_name[algebra.name_].mapped[74])
        ...
        class ComputeOperationClip(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, min: float, max: float) -> algebra.compute.ComputeOperationClip:
                return algebra.compute.ComputeOperationClip(greycat.libs_by_name[algebra.name_].mapped[75], input, output, min, max)
        ...
        class ComputeActivationExp(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationExp:
                return algebra.compute.ComputeActivationExp(greycat.libs_by_name[algebra.name_].mapped[76])
        ...
        class ComputeInitializerNormalIn(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerNormalIn:
                return algebra.compute.ComputeInitializerNormalIn(greycat.libs_by_name[algebra.name_].mapped[77])
        ...
        class ComputeActivationRelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat, max_value: float, threshold: float) -> algebra.compute.ComputeActivationRelu:
                return algebra.compute.ComputeActivationRelu(greycat.libs_by_name[algebra.name_].mapped[78], max_value, threshold)
        ...
        class ComputeActivation(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivation:
                return algebra.compute.ComputeActivation(greycat.libs_by_name[algebra.name_].mapped[79])
        ...
        class ComputeOperationArgMin(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str, output2: str) -> algebra.compute.ComputeOperationArgMin:
                return algebra.compute.ComputeOperationArgMin(greycat.libs_by_name[algebra.name_].mapped[80], input, output, output2)
        ...
        class ComputeInitializerRelu(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerRelu:
                return algebra.compute.ComputeInitializerRelu(greycat.libs_by_name[algebra.name_].mapped[81])
        ...
        class ComputeOperationLeCunTanh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationLeCunTanh:
                return algebra.compute.ComputeOperationLeCunTanh(greycat.libs_by_name[algebra.name_].mapped[82], input, output)
        ...
        class ComputeVar(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str) -> algebra.compute.ComputeVar:
                return algebra.compute.ComputeVar(greycat.libs_by_name[algebra.name_].mapped[83], name)
        ...
        class ComputeOperationLeakyRelu(GreyCat.Object):
            ...
            @staticmethod
            def alpha_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[84]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, input: str, output: str, alpha: float, max_value: float, threshold: float) -> algebra.compute.ComputeOperationLeakyRelu:
                return algebra.compute.ComputeOperationLeakyRelu(greycat.libs_by_name[algebra.name_].mapped[84], input, output, alpha, max_value, threshold)
        ...
        class ComputeOperationFill(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, value: Any) -> algebra.compute.ComputeOperationFill:
                return algebra.compute.ComputeOperationFill(greycat.libs_by_name[algebra.name_].mapped[85], input, value)
        ...
        class ComputeInitializerUniformIn(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerUniformIn:
                return algebra.compute.ComputeInitializerUniformIn(greycat.libs_by_name[algebra.name_].mapped[86])
        ...
        class ComputeBinding(GreyCat.Object):
            ...
            def create(greycat: GreyCat, src_layer_name: str, src_var_name: str, target_var_name: str) -> algebra.compute.ComputeBinding:
                return algebra.compute.ComputeBinding(greycat.libs_by_name[algebra.name_].mapped[87], src_layer_name, src_var_name, target_var_name)
        ...
        class ComputeOperationAvg(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationAvg:
                return algebra.compute.ComputeOperationAvg(greycat.libs_by_name[algebra.name_].mapped[88], input, input2, output)
        ...
        class ComputeActivationElu(GreyCat.Object):
            ...
            @staticmethod
            def alpha_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[89]
                return t.static_values[0]

            @staticmethod
            def create(greycat: GreyCat, alpha: float) -> algebra.compute.ComputeActivationElu:
                return algebra.compute.ComputeActivationElu(greycat.libs_by_name[algebra.name_].mapped[89], alpha)
        ...
        class ComputeVarInOut(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, shape: std.core.Array, with_grad: bool) -> algebra.compute.ComputeVarInOut:
                return algebra.compute.ComputeVarInOut(greycat.libs_by_name[algebra.name_].mapped[90], name, type, shape, with_grad)
        ...
        class ComputeInitializerSigmoidUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerSigmoidUniform:
                return algebra.compute.ComputeInitializerSigmoidUniform(greycat.libs_by_name[algebra.name_].mapped[91])
        ...
        class ComputeLayerCall(GreyCat.Object):
            ...
            def create(greycat: GreyCat, layer_name: str, bindings: std.core.Array) -> algebra.compute.ComputeLayerCall:
                return algebra.compute.ComputeLayerCall(greycat.libs_by_name[algebra.name_].mapped[92], layer_name, bindings)
        ...
        class ComputeRegressionLoss(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeRegressionLoss:
                return algebra.compute.ComputeRegressionLoss(greycat.libs_by_name[algebra.name_].mapped[93])
        ...
        class ComputeActivationCelu(GreyCat.Object):
            ...
            @staticmethod
            def alpha_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[94]
                return t.static_values[0]

            @staticmethod
            def create(greycat: GreyCat, alpha: float) -> algebra.compute.ComputeActivationCelu:
                return algebra.compute.ComputeActivationCelu(greycat.libs_by_name[algebra.name_].mapped[94], alpha)
        ...
        class ComputeOptimizerNesterov(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, decay_rate: float) -> algebra.compute.ComputeOptimizerNesterov:
                return algebra.compute.ComputeOptimizerNesterov(greycat.libs_by_name[algebra.name_].mapped[95], learning_rate, decay_rate)
        ...
        class ComputeLayerDense(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inputs: int, outputs: int, use_bias: bool, weight_initializer: algebra.compute.ComputeInitializer, weight_regularizer: algebra.compute.ComputeRegularizer, bias_initializer: algebra.compute.ComputeInitializer, bias_regularizer: algebra.compute.ComputeRegularizer, activation: algebra.compute.ComputeActivation) -> algebra.compute.ComputeLayerDense:
                return algebra.compute.ComputeLayerDense(greycat.libs_by_name[algebra.name_].mapped[96], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation)
        ...
        class ComputeOptimizerNadam(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, beta1: float, beta2: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerNadam:
                return algebra.compute.ComputeOptimizerNadam(greycat.libs_by_name[algebra.name_].mapped[97], learning_rate, beta1, beta2, smooth_epsilon)
        ...
        class ComputeActivationHardSigmoid(GreyCat.Object):
            ...
            def slope_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[98]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, slope: float, shift: float) -> algebra.compute.ComputeActivationHardSigmoid:
                return algebra.compute.ComputeActivationHardSigmoid(greycat.libs_by_name[algebra.name_].mapped[98], slope, shift)
        ...
        class ComputeOptimizerAdam(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[99]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, learning_rate: float, beta1: float, beta2: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerAdam:
                return algebra.compute.ComputeOptimizerAdam(greycat.libs_by_name[algebra.name_].mapped[99], learning_rate, beta1, beta2, smooth_epsilon)
        ...
        class ComputeInitializerPytorch(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerPytorch:
                return algebra.compute.ComputeInitializerPytorch(greycat.libs_by_name[algebra.name_].mapped[100])
        ...
        class ComputeInitializerNormal(GreyCat.Object):
            ...
            def create(greycat: GreyCat, avg: float, std: float) -> algebra.compute.ComputeInitializerNormal:
                return algebra.compute.ComputeInitializerNormal(greycat.libs_by_name[algebra.name_].mapped[101], avg, std)
        ...
        class ComputeOperationSub(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationSub:
                return algebra.compute.ComputeOperationSub(greycat.libs_by_name[algebra.name_].mapped[102], input, input2, output)
        ...
        class ComputeOptimizerMomentum(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, decay_rate: float) -> algebra.compute.ComputeOptimizerMomentum:
                return algebra.compute.ComputeOptimizerMomentum(greycat.libs_by_name[algebra.name_].mapped[103], learning_rate, decay_rate)
        ...
        class ComputeOperationDiv(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, input2: str, output: str) -> algebra.compute.ComputeOperationDiv:
                return algebra.compute.ComputeOperationDiv(greycat.libs_by_name[algebra.name_].mapped[104], input, input2, output)
        ...
        class ComputeLayerPCAScaler(GreyCat.Object):
            ...
            @staticmethod
            def var_input_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[105]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, name: str, type: std.core.TensorType, inverse_transform: bool) -> algebra.compute.ComputeLayerPCAScaler:
                return algebra.compute.ComputeLayerPCAScaler(greycat.libs_by_name[algebra.name_].mapped[105], name, type, inverse_transform)
        ...
        class ComputeOperationAcos(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAcos:
                return algebra.compute.ComputeOperationAcos(greycat.libs_by_name[algebra.name_].mapped[107], input, output)
        ...
        class ComputeLayerSeq(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, calls: std.core.Array, optimizer: algebra.compute.ComputeOptimizer) -> algebra.compute.ComputeLayerSeq:
                return algebra.compute.ComputeLayerSeq(greycat.libs_by_name[algebra.name_].mapped[108], name, calls, optimizer)
        ...
        class ComputeCounter(GreyCat.Object):
            ...
            def create(greycat: GreyCat, epoch: int, optimizationSteps: int, batchNotOptimized: int) -> algebra.compute.ComputeCounter:
                return algebra.compute.ComputeCounter(greycat.libs_by_name[algebra.name_].mapped[110], epoch, optimizationSteps, batchNotOptimized)
        ...
        class ComputeOperationHardSigmoid(GreyCat.Object):
            ...
            @staticmethod
            def slope_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[111]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, input: str, output: str, slope: float, shift: float) -> algebra.compute.ComputeOperationHardSigmoid:
                return algebra.compute.ComputeOperationHardSigmoid(greycat.libs_by_name[algebra.name_].mapped[111], input, output, slope, shift)
        ...
        class ComputeOperationSqrt(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSqrt:
                return algebra.compute.ComputeOperationSqrt(greycat.libs_by_name[algebra.name_].mapped[112], input, output)
        ...
        class ComputeOperationCosh(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationCosh:
                return algebra.compute.ComputeOperationCosh(greycat.libs_by_name[algebra.name_].mapped[113], input, output)
        ...
        class ComputeOptimizer(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float) -> algebra.compute.ComputeOptimizer:
                return algebra.compute.ComputeOptimizer(greycat.libs_by_name[algebra.name_].mapped[114], learning_rate)
        ...
        class ComputeEngine(algebra_n.compute._ComputeEngine):
            ...
            def create(greycat: GreyCat) -> algebra_n.compute._ComputeEngine:
                return algebra.compute.ComputeEngine(greycat.libs_by_name[algebra.name_].mapped[115])
        ...
        class ComputeOptimizerAdaGrad(GreyCat.Object):
            ...
            def create(greycat: GreyCat, learning_rate: float, initial_accumulator: float, smooth_epsilon: float) -> algebra.compute.ComputeOptimizerAdaGrad:
                return algebra.compute.ComputeOptimizerAdaGrad(greycat.libs_by_name[algebra.name_].mapped[116], learning_rate, initial_accumulator, smooth_epsilon)
        ...
        class ComputeOperationTan(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationTan:
                return algebra.compute.ComputeOperationTan(greycat.libs_by_name[algebra.name_].mapped[117], input, output)
        ...
        class ComputeInitializerXavierUniform(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeInitializerXavierUniform:
                return algebra.compute.ComputeInitializerXavierUniform(greycat.libs_by_name[algebra.name_].mapped[118])
        ...
        class ComputeOperationSoftSign(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationSoftSign:
                return algebra.compute.ComputeOperationSoftSign(greycat.libs_by_name[algebra.name_].mapped[119], input, output)
        ...
        class ComputeActivationSigmoid(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeActivationSigmoid:
                return algebra.compute.ComputeActivationSigmoid(greycat.libs_by_name[algebra.name_].mapped[120])
        ...
        class ComputeInitializerConstant(GreyCat.Object):
            ...
            def create(greycat: GreyCat, value: Any) -> algebra.compute.ComputeInitializerConstant:
                return algebra.compute.ComputeInitializerConstant(greycat.libs_by_name[algebra.name_].mapped[121], value)
        ...
        class ComputeLayerActivation(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, activation: algebra.compute.ComputeActivation) -> algebra.compute.ComputeLayerActivation:
                return algebra.compute.ComputeLayerActivation(greycat.libs_by_name[algebra.name_].mapped[122], name, activation)
        ...
        class ComputeOperationElu(GreyCat.Object):
            ...
            @staticmethod
            def alpha_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[123]
                return t.static_values[0]

            @staticmethod
            def create(greycat: GreyCat, input: str, output: str, alpha: float) -> algebra.compute.ComputeOperationElu:
                return algebra.compute.ComputeOperationElu(greycat.libs_by_name[algebra.name_].mapped[123], input, output, alpha)
        ...
        class ComputeOperationAsin(GreyCat.Object):
            ...
            def create(greycat: GreyCat, input: str, output: str) -> algebra.compute.ComputeOperationAsin:
                return algebra.compute.ComputeOperationAsin(greycat.libs_by_name[algebra.name_].mapped[125], input, output)
        ...
        class ComputeOperation(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.compute.ComputeOperation:
                return algebra.compute.ComputeOperation(greycat.libs_by_name[algebra.name_].mapped[126])
        ...
        class ComputeLayer(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str) -> algebra.compute.ComputeLayer:
                return algebra.compute.ComputeLayer(greycat.libs_by_name[algebra.name_].mapped[127], name)
        ...
        class ComputeActivationSoftmax(GreyCat.Object):
            ...
            def create(greycat: GreyCat, classes: str) -> algebra.compute.ComputeActivationSoftmax:
                return algebra.compute.ComputeActivationSoftmax(greycat.libs_by_name[algebra.name_].mapped[128], classes)
    ...
    class nn:
        ...
        class InitializerConfig(GreyCat.Object):
            ...
            def create(greycat: GreyCat, weight_initializer: algebra.compute.ComputeInitializer, weight_regularizer: algebra.compute.ComputeRegularizer, bias_initializer: algebra.compute.ComputeInitializer, bias_regularizer: algebra.compute.ComputeRegularizer) -> algebra.nn.InitializerConfig:
                return algebra.nn.InitializerConfig(greycat.libs_by_name[algebra.name_].mapped[130], weight_initializer, weight_regularizer, bias_initializer, bias_regularizer)
        ...
        class ComputeActivations(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.nn.ComputeActivations:
                return algebra.nn.ComputeActivations(greycat.libs_by_name[algebra.name_].mapped[131])
        ...
        class AutoEncoderNetwork(GreyCat.Object):
            ...
            def create(greycat: GreyCat, inputs: int, inputs_gradients: bool, outputs: int, fixed_batch_size: int, inputs_sequences: int, outputs_sequences: int, tensor_type: std.core.TensorType, seed: int, randomizeSeed: bool, layers: std.core.Array, preProcessType: algebra.nn.PreProcessType, preProcessObject: Any, postProcessType: algebra.nn.PostProcessType, postProcessObject: Any, optimizer: algebra.compute.ComputeOptimizer, lossLayer: algebra.compute.ComputeLayerLoss, _lastLayer: str, _lastOutput: str, encoder_layer_idx: int, encoder_layer_name: str, encoder_layer_var: str) -> algebra.nn.AutoEncoderNetwork:
                return algebra.nn.AutoEncoderNetwork(greycat.libs_by_name[algebra.name_].mapped[134], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, encoder_layer_idx, encoder_layer_name, encoder_layer_var)
        ...
        class ClassificationNetwork(GreyCat.Object):
            ...
            def create(greycat: GreyCat, inputs: int, inputs_gradients: bool, outputs: int, fixed_batch_size: int, inputs_sequences: int, outputs_sequences: int, tensor_type: std.core.TensorType, seed: int, randomizeSeed: bool, layers: std.core.Array, preProcessType: algebra.nn.PreProcessType, preProcessObject: Any, postProcessType: algebra.nn.PostProcessType, postProcessObject: Any, optimizer: algebra.compute.ComputeOptimizer, lossLayer: algebra.compute.ComputeLayerLoss, _lastLayer: str, _lastOutput: str, calculate_probabilities: bool, has_class_weights: bool, from_logits: bool) -> algebra.nn.ClassificationNetwork:
                return algebra.nn.ClassificationNetwork(greycat.libs_by_name[algebra.name_].mapped[135], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, calculate_probabilities, has_class_weights, from_logits)
        ...
        class RegressionNetwork(GreyCat.Object):
            ...
            def create(greycat: GreyCat, inputs: int, inputs_gradients: bool, outputs: int, fixed_batch_size: int, inputs_sequences: int, outputs_sequences: int, tensor_type: std.core.TensorType, seed: int, randomizeSeed: bool, layers: std.core.Array, preProcessType: algebra.nn.PreProcessType, preProcessObject: Any, postProcessType: algebra.nn.PostProcessType, postProcessObject: Any, optimizer: algebra.compute.ComputeOptimizer, lossLayer: algebra.compute.ComputeLayerLoss, _lastLayer: str, _lastOutput: str) -> algebra.nn.RegressionNetwork:
                return algebra.nn.RegressionNetwork(greycat.libs_by_name[algebra.name_].mapped[136], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput)
        ...
        class ComputeLayerTypes(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.nn.ComputeLayerTypes:
                return algebra.nn.ComputeLayerTypes(greycat.libs_by_name[algebra.name_].mapped[138])
        ...
        class ClassificationMetrics(GreyCat.Object):
            ...
            def create(greycat: GreyCat, precision: std.core.Array, recall: std.core.Array, f1Score: std.core.Array) -> algebra.nn.ClassificationMetrics:
                return algebra.nn.ClassificationMetrics(greycat.libs_by_name[algebra.name_].mapped[140], precision, recall, f1Score)
        ...
        class ComputeOptimizers(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.nn.ComputeOptimizers:
                return algebra.nn.ComputeOptimizers(greycat.libs_by_name[algebra.name_].mapped[141])
        ...
        class PostProcessType(GreyCat.Enum):
            ...
            def none(greycat: GreyCat) -> algebra.nn.PostProcessType:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[142]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> algebra.nn.PostProcessType:
                return algebra.nn.PostProcessType(greycat.libs_by_name[algebra.name_].mapped[142])
    ...
    class patterns:
        ...
        class SamplingPolicy(GreyCat.Enum):
            ...
            def as_is(greycat: GreyCat) -> algebra.patterns.SamplingPolicy:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[146]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> algebra.patterns.SamplingPolicy:
                return algebra.patterns.SamplingPolicy(greycat.libs_by_name[algebra.name_].mapped[146])
        ...
        class PatternNullStrategy(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.PatternNullStrategy:
                return algebra.patterns.PatternNullStrategy(greycat.libs_by_name[algebra.name_].mapped[147])
        ...
        class DTWPatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.DTWPatternDetector:
                return algebra.patterns.DTWPatternDetector(greycat.libs_by_name[algebra.name_].mapped[148])
        ...
        class DTWPatternDetectionEngine(GreyCat.Object):
            ...
            def create(greycat: GreyCat, timeseries: std.core.nodeTime, state: algebra.patterns.PatternDetectionEngineState, nullStrategy: algebra.patterns.PatternNullStrategy, nullReplaceConstant: float, samplingPolicy: algebra.patterns.SamplingPolicy, std: float, matchingNormalisation: algebra.patterns.MatchingNormalisation) -> algebra.patterns.DTWPatternDetectionEngine:
                return algebra.patterns.DTWPatternDetectionEngine(greycat.libs_by_name[algebra.name_].mapped[149], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, std, matchingNormalisation)
        ...
        class EuclideanPatternDetectionEngine(GreyCat.Object):
            ...
            def create(greycat: GreyCat, timeseries: std.core.nodeTime, state: algebra.patterns.PatternDetectionEngineState, nullStrategy: algebra.patterns.PatternNullStrategy, nullReplaceConstant: float, samplingPolicy: algebra.patterns.SamplingPolicy, pattern_tensors: std.core.Array, window_tensors: std.core.Array, std: float, matchingNormalisation: algebra.patterns.MatchingNormalisation) -> algebra.patterns.EuclideanPatternDetectionEngine:
                return algebra.patterns.EuclideanPatternDetectionEngine(greycat.libs_by_name[algebra.name_].mapped[151], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, pattern_tensors, window_tensors, std, matchingNormalisation)
        ...
        class Detection(GreyCat.Object):
            ...
            def create(greycat: GreyCat, score: float, best_pattern: int, timespan: std.core.duration) -> algebra.patterns.Detection:
                return algebra.patterns.Detection(greycat.libs_by_name[algebra.name_].mapped[152], score, best_pattern, timespan)
        ...
        class RandomPatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.RandomPatternDetector:
                return algebra.patterns.RandomPatternDetector(greycat.libs_by_name[algebra.name_].mapped[154])
        ...
        class MatchingNormalisation(GreyCat.Enum):
            ...
            def as_is(greycat: GreyCat) -> algebra.patterns.MatchingNormalisation:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[156]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> algebra.patterns.MatchingNormalisation:
                return algebra.patterns.MatchingNormalisation(greycat.libs_by_name[algebra.name_].mapped[156])
        ...
        class DistanceMetrics(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.DistanceMetrics:
                return algebra.patterns.DistanceMetrics(greycat.libs_by_name[algebra.name_].mapped[157])
        ...
        class PatternDetectors(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.PatternDetectors:
                return algebra.patterns.PatternDetectors(greycat.libs_by_name[algebra.name_].mapped[158])
        ...
        class SaxPatternDetectionEngine(GreyCat.Object):
            ...
            def alphabet(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[159]
                return t.static_values[0]
            ...
            def create(greycat: GreyCat, timeseries: std.core.nodeTime, state: algebra.patterns.PatternDetectionEngineState, nullStrategy: algebra.patterns.PatternNullStrategy, nullReplaceConstant: float, samplingPolicy: algebra.patterns.SamplingPolicy, alphabet_size: int, alphabet_boundaries: std.core.Array, lookup_table: std.core.nodeIndex, max_distance: float, pattern_fingerprints: std.core.Array, fingerprint_length: int) -> algebra.patterns.SaxPatternDetectionEngine:
                return algebra.patterns.SaxPatternDetectionEngine(greycat.libs_by_name[algebra.name_].mapped[159], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, alphabet_size, alphabet_boundaries, lookup_table, max_distance, pattern_fingerprints, fingerprint_length)
        ...
        class PatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.PatternDetector:
                return algebra.patterns.PatternDetector(greycat.libs_by_name[algebra.name_].mapped[161])
        ...
        class FFTPatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.FFTPatternDetector:
                return algebra.patterns.FFTPatternDetector(greycat.libs_by_name[algebra.name_].mapped[162])
        ...
        class PatternDetectionEngineState(GreyCat.Object):
            ...
            def create(greycat: GreyCat, hasScores: bool, hasDetections: bool, patterns: std.core.Array, scores: std.core.nodeList, detections: std.core.nodeTime) -> algebra.patterns.PatternDetectionEngineState:
                return algebra.patterns.PatternDetectionEngineState(greycat.libs_by_name[algebra.name_].mapped[163], hasScores, hasDetections, patterns, scores, detections)
        ...
        class EuclideanPatternDetector(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.patterns.EuclideanPatternDetector:
                return algebra.patterns.EuclideanPatternDetector(greycat.libs_by_name[algebra.name_].mapped[164])
        ...
        class ScoreDetails(GreyCat.Object):
            ...
            def create(greycat: GreyCat, best_pattern: int, timespan: std.core.duration) -> algebra.patterns.ScoreDetails:
                return algebra.patterns.ScoreDetails(greycat.libs_by_name[algebra.name_].mapped[165], best_pattern, timespan)
        ...
        class PatternDetectionSensitivity(GreyCat.Object):
            ...
            def create(greycat: GreyCat, threshold: float, overlap: float) -> algebra.patterns.PatternDetectionSensitivity:
                return algebra.patterns.PatternDetectionSensitivity(greycat.libs_by_name[algebra.name_].mapped[166], threshold, overlap)
        ...
        class ScoreDetailsSingleton(GreyCat.Object):
            ...
            def create(greycat: GreyCat, best_pattern: int, timespan: std.core.duration, timestamp: std.core.time) -> algebra.patterns.ScoreDetailsSingleton:
                return algebra.patterns.ScoreDetailsSingleton(greycat.libs_by_name[algebra.name_].mapped[167], best_pattern, timespan, timestamp)
        ...
        class OverlappingDetection(GreyCat.Object):
            ...
            def create(greycat: GreyCat, score: float, best_pattern: int, timespan: std.core.duration, overlap: std.core.duration) -> algebra.patterns.OverlappingDetection:
                return algebra.patterns.OverlappingDetection(greycat.libs_by_name[algebra.name_].mapped[168], score, best_pattern, timespan, overlap)
    ...
    class ml:
        ...
        class PCA(algebra_n.ml._PCA):
            ...
            def create(greycat: GreyCat) -> algebra_n.ml._PCA:
                return algebra.ml.PCA(greycat.libs_by_name[algebra.name_].mapped[169])
        ...
        class TimeSeriesDecomposition(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> algebra.ml.TimeSeriesDecomposition:
                return algebra.ml.TimeSeriesDecomposition(greycat.libs_by_name[algebra.name_].mapped[170])
        ...
        class HeatMapProfile(GreyCat.Object):
            ...
            def create(greycat: GreyCat, counts: std.core.Table, x_labels: std.core.Array, y_labels: std.core.Array, counts_max: int, counts_sum: int) -> algebra.ml.HeatMapProfile:
                return algebra.ml.HeatMapProfile(greycat.libs_by_name[algebra.name_].mapped[173], counts, x_labels, y_labels, counts_max, counts_sum)
        ...
        class Polynomial(algebra_n.ml._Polynomial):
            ...
            def create(greycat: GreyCat) -> algebra_n.ml._Polynomial:
                return algebra.ml.Polynomial(greycat.libs_by_name[algebra.name_].mapped[174])
    ...
    def init(self, greycat: GreyCat) -> None:
        ...
        self.mapped[0].resolve_generated_offsets("name")
        self.mapped[3].resolve_generated_offsets("input", "output", "mask", "nbOutputs")
        self.mapped[4].resolve_generated_offsets("input", "output")
        self.mapped[6].resolve_generated_offsets("input", "output", "axis")
        self.mapped[7].resolve_generated_offsets("input", "output")
        self.mapped[8].resolve_generated_offsets("input", "input2", "output")
        self.mapped[9].resolve_generated_offsets("input", "ifCondition", "output", "counts", "classes")
        self.mapped[10].resolve_generated_offsets("min", "max")
        self.mapped[11].resolve_generated_offsets("alpha", "max_value", "threshold")
        self.mapped[11].static_values = [struct.unpack("d", struct.pack("l", 4599075939470750515))[0], struct.unpack("d", struct.pack("l", 0))[0]]
        self.mapped[12].resolve_generated_offsets("input", "input2", "output")
        self.mapped[13].resolve_generated_offsets("name", "reduction", "loss_type", "has_class_weights", "calculate_probabilities", "from_logits")
        self.mapped[13].static_values = ["class_weights", "predicted_classes", "probabilities", "sum_reduce"]
        self.mapped[14].resolve_generated_offsets("name", "nbClass")
        self.mapped[14].static_values = ["computed", "expected", "confusion"]
        self.mapped[15].resolve_generated_offsets("input", "output", "output2")
        self.mapped[16].resolve_generated_offsets("input", "output")
        self.mapped[17].resolve_generated_offsets("name", "type", "inverse_transform")
        self.mapped[17].static_values = ["input", "output", "avg", "std"]
        self.mapped[18].resolve_generated_offsets("name", "reduction")
        self.mapped[18].static_values = ["computed", "expected", "loss"]
        self.mapped[19].resolve_generated_offsets("name", "calculate_probabilities", "from_logits")
        self.mapped[19].static_values = ["input", "predicted_classes", "probabilities"]
        self.mapped[21].resolve_generated_offsets("input", "output", "output2")
        self.mapped[22].resolve_generated_offsets("input", "output", "axis")
        self.mapped[24].resolve_generated_offsets("input", "input2", "output")
        self.mapped[27].resolve_generated_offsets("learning_rate", "decay_rate", "smooth_epsilon")
        self.mapped[27].static_values = [struct.unpack("d", struct.pack("l", 4562254508917369340))[0], struct.unpack("d", struct.pack("l", 4606732058837280358))[0], struct.unpack("d", struct.pack("l", 4502148214488346440))[0]]
        self.mapped[28].resolve_generated_offsets("learning_rate", "decay_rate", "smooth_epsilon")
        self.mapped[28].static_values = [struct.unpack("d", struct.pack("l", 4562254508917369340))[0], struct.unpack("d", struct.pack("l", 4606281698874543309))[0], struct.unpack("d", struct.pack("l", 4502148214488346440))[0]]
        self.mapped[29].resolve_generated_offsets("name", "type", "inputs", "outputs", "maskValues")
        self.mapped[29].static_values = ["input", "output", "mask"]
        self.mapped[30].resolve_generated_offset_with_values("auto", "auto", "none", "none", "sum", "sum", "mean", "mean", "disabled", "disabled")
        self.mapped[31].resolve_generated_offsets("input", "output")
        self.mapped[32].resolve_generated_offsets("input", "output")
        ...
        self.mapped[35].resolve_generated_offsets("input", "output")
        self.mapped[36].resolve_generated_offsets("name", "ops", "vars")
        self.mapped[37].resolve_generated_offset_with_values("categorical_cross_entropy", "Categorical Cross Entropy", "sparse_categorical_cross_entropy", "Sparse Categorical Cross Entropy")
        self.mapped[39].resolve_generated_offsets("input", "output")
        self.mapped[40].resolve_generated_offsets("name")
        self.mapped[41].resolve_generated_offsets("input", "output", "power")
        self.mapped[42].resolve_generated_offsets("input", "output", "alpha")
        self.mapped[42].static_values = [struct.unpack("d", struct.pack("l", 4607182418800017408))[0]]
        self.mapped[43].resolve_generated_offsets("input", "output")
        self.mapped[44].resolve_generated_offsets("input", "input2", "output", "transposeA", "transposeB", "alpha", "beta")
        self.mapped[44].static_values = [false, struct.unpack("d", struct.pack("l", 4607182418800017408))[0], struct.unpack("d", struct.pack("l", 0))[0]]
        self.mapped[45].resolve_generated_offsets("input", "output", "max_value", "threshold")
        self.mapped[45].static_values = [struct.unpack("d", struct.pack("l", 0))[0]]
        self.mapped[49].resolve_generated_offsets("l1", "l2")
        self.mapped[50].resolve_generated_offsets("input", "output")
        self.mapped[51].resolve_generated_offsets("input", "input2", "output")
        self.mapped[52].resolve_generated_offsets("input", "output")
        self.mapped[53].resolve_generated_offsets("input", "output")
        self.mapped[54].resolve_generated_offsets("name", "type", "shape")
        self.mapped[55].resolve_generated_offsets("layers")
        self.mapped[57].resolve_generated_offsets("name", "type", "shape", "l1", "l2", "init")
        self.mapped[59].resolve_generated_offsets("learning_rate", "lambda1", "lambda2", "beta")
        self.mapped[59].static_values = [struct.unpack("d", struct.pack("l", 4562254508917369340))[0], struct.unpack("d", struct.pack("l", 0))[0], struct.unpack("d", struct.pack("l", 0))[0], struct.unpack("d", struct.pack("l", 0))[0]]
        self.mapped[60].resolve_generated_offsets("learning_rate")
        self.mapped[60].static_values = [struct.unpack("d", struct.pack("l", 4576918229304087675))[0]]
        self.mapped[61].resolve_generated_offsets("name", "type", "inputs", "outputs", "use_bias", "weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer")
        self.mapped[61].static_values = ["input", "output", "weight", "bias", "mult"]
        self.mapped[62].resolve_generated_offsets("learning_rate", "beta1", "beta2", "smooth_epsilon")
        self.mapped[62].static_values = [struct.unpack("d", struct.pack("l", 4562254508917369340))[0], struct.unpack("d", struct.pack("l", 4606281698874543309))[0], struct.unpack("d", struct.pack("l", 4607173411600762667))[0], struct.unpack("d", struct.pack("l", 4502148214488346440))[0]]
        self.mapped[63].resolve_generated_offsets("name", "reduction", "loss_type")
        self.mapped[64].resolve_generated_offsets("input", "output")
        self.mapped[65].resolve_generated_offsets("input", "input2", "output")
        self.mapped[66].resolve_generated_offsets("input", "input2", "output")
        self.mapped[69].resolve_generated_offsets("input", "output")
        self.mapped[70].resolve_generated_offsets("input", "output")
        self.mapped[71].resolve_generated_offsets("name", "bias_initializer", "weight_regularizer", "bias_regularizer", "type", "use_bias", "return_sequences", "bidirectional", "auto_init_states", "inputs", "outputs", "layers", "sequences")
        self.mapped[71].static_values = ["input", "output", "hx", "cx", "hy", "cy", "weight", "bias", "internal_i", "internal_f", "internal_cp", "internal_o", "internal_h", "internal_c", "internal_mult", "internal_output"]
        self.mapped[72].resolve_generated_offsets("input", "output")
        self.mapped[73].resolve_generated_offsets("input", "output")
        self.mapped[75].resolve_generated_offsets("input", "output", "min", "max")
        self.mapped[78].resolve_generated_offsets("max_value", "threshold")
        self.mapped[78].static_values = [struct.unpack("d", struct.pack("l", 0))[0]]
        self.mapped[80].resolve_generated_offsets("input", "output", "output2")
        self.mapped[82].resolve_generated_offsets("input", "output")
        self.mapped[83].resolve_generated_offsets("name")
        self.mapped[84].resolve_generated_offsets("input", "output", "alpha", "max_value", "threshold")
        self.mapped[84].static_values = [struct.unpack("d", struct.pack("l", 4599075939470750515))[0], struct.unpack("d", struct.pack("l", 9218868437227405311))[0], struct.unpack("d", struct.pack("l", 0))[0]]
        self.mapped[85].resolve_generated_offsets("input", "value")
        self.mapped[87].resolve_generated_offsets("src_layer_name", "src_var_name", "target_var_name")
        self.mapped[88].resolve_generated_offsets("input", "input2", "output")
        self.mapped[89].resolve_generated_offsets("alpha")
        self.mapped[89].static_values = [struct.unpack("d", struct.pack("l", 4607182418800017408))[0]]
        self.mapped[90].resolve_generated_offsets("name", "type", "shape", "with_grad")
        self.mapped[92].resolve_generated_offsets("layer_name", "bindings")
        self.mapped[93].resolve_generated_offset_with_values("square", "Square", "abs", "Abs")
        self.mapped[94].resolve_generated_offsets("alpha")
        self.mapped[94].static_values = [struct.unpack("d", struct.pack("l", 4607182418800017408))[0]]
        self.mapped[95].resolve_generated_offsets("learning_rate", "decay_rate")
        self.mapped[95].static_values = [struct.unpack("d", struct.pack("l", 4562254508917369340))[0], struct.unpack("d", struct.pack("l", 4606281698874543309))[0]]
        self.mapped[96].resolve_generated_offsets("name", "type", "inputs", "outputs", "use_bias", "weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer", "activation")
        self.mapped[96].static_values = ["input", "output", "weight", "bias", "mult", "pre_activation"]
        self.mapped[97].resolve_generated_offsets("learning_rate", "beta1", "beta2", "smooth_epsilon")
        self.mapped[97].static_values = [struct.unpack("d", struct.pack("l", 4562254508917369340))[0], struct.unpack("d", struct.pack("l", 4606281698874543309))[0], struct.unpack("d", struct.pack("l", 4607173411600762667))[0], struct.unpack("d", struct.pack("l", 4502148214488346440))[0]]
        self.mapped[98].resolve_generated_offsets("slope", "shift")
        self.mapped[98].static_values = [struct.unpack("d", struct.pack("l", 4596373779694328218))[0], struct.unpack("d", struct.pack("l", 4602678819172646912))[0]]
        self.mapped[99].resolve_generated_offsets("learning_rate", "beta1", "beta2", "smooth_epsilon")
        self.mapped[99].static_values = [struct.unpack("d", struct.pack("l", 4562254508917369340))[0], struct.unpack("d", struct.pack("l", 4606281698874543309))[0], struct.unpack("d", struct.pack("l", 4607173411600762667))[0], struct.unpack("d", struct.pack("l", 4502148214488346440))[0]]
        self.mapped[101].resolve_generated_offsets("avg", "std")
        self.mapped[102].resolve_generated_offsets("input", "input2", "output")
        self.mapped[103].resolve_generated_offsets("learning_rate", "decay_rate")
        self.mapped[103].static_values = [struct.unpack("d", struct.pack("l", 4562254508917369340))[0], struct.unpack("d", struct.pack("l", 4606281698874543309))[0]]
        self.mapped[104].resolve_generated_offsets("input", "input2", "output")
        self.mapped[105].resolve_generated_offsets("name", "type", "inverse_transform")
        self.mapped[105].static_values = ["input", "output", "avg", "std", "space"]
        self.mapped[106].resolve_generated_offsets("input", "output")
        self.mapped[107].resolve_generated_offsets("input", "output")
        self.mapped[108].resolve_generated_offsets("name", "calls", "optimizer")
        self.mapped[110].resolve_generated_offsets("epoch", "optimizationSteps", "batchNotOptimized")
        self.mapped[111].resolve_generated_offsets("input", "output", "slope", "shift")
        self.mapped[111].static_values = [struct.unpack("d", struct.pack("l", 4596373779694328218))[0], struct.unpack("d", struct.pack("l", 4602678819172646912))[0]]
        self.mapped[112].resolve_generated_offsets("input", "output")
        self.mapped[113].resolve_generated_offsets("input", "output")
        self.mapped[114].resolve_generated_offsets("learning_rate")
        self.mapped[116].resolve_generated_offsets("learning_rate", "initial_accumulator", "smooth_epsilon")
        self.mapped[116].static_values = [struct.unpack("d", struct.pack("l", 4562254508917369340))[0], struct.unpack("d", struct.pack("l", 4591870180066957722))[0], struct.unpack("d", struct.pack("l", 4502148214488346440))[0]]
        self.mapped[117].resolve_generated_offsets("input", "output")
        self.mapped[119].resolve_generated_offsets("input", "output")
        self.mapped[121].resolve_generated_offsets("value")
        self.mapped[122].resolve_generated_offsets("name", "activation")
        self.mapped[122].static_values = ["input", "output"]
        self.mapped[123].resolve_generated_offsets("input", "output", "alpha")
        self.mapped[123].static_values = [struct.unpack("d", struct.pack("l", 4607182418800017408))[0]]
        self.mapped[124].resolve_generated_offsets("input", "output", "alpha")
        self.mapped[125].resolve_generated_offsets("input", "output")
        self.mapped[127].resolve_generated_offsets("name")
        self.mapped[128].resolve_generated_offsets("classes")
        ...
        self.mapped[130].resolve_generated_offsets("weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer")
        self.mapped[131].resolve_generated_offset_with_values("relu", "Relu", "leaky_relu", "Leaky Relu", "sigmoid", "Sigmoid", "hard_sigmoid", "Hard Sigmoid", "exp", "Exp", "soft_max", "Soft Max", "soft_plus", "Soft Plus", "soft_sign", "Soft Sign", "tanh", "Tanh", "selu", "Selu", "elu", "Elu", "celu", "Celu")
        ...
        self.mapped[134].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput", "encoder_layer_idx", "encoder_layer_name", "encoder_layer_var")
        self.mapped[135].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput", "calculate_probabilities", "has_class_weights", "from_logits")
        self.mapped[136].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput")
        ...
        self.mapped[138].resolve_generated_offset_with_values("linear", "Linear", "dense", "Dense", "activation", "Activation", "lstm", "LSTM", "loss", "Loss", "filter", "Filter")
        ...
        self.mapped[139].static_values = ["Inputs or outputs can't be negative", "Last layer has different number of outputs than declared", "Incompatible loss function", "Some NN layers are not currently supported", "Tensor Type not currently supported", "NN should contain at least 1 layer", "layer placeholders", "layer classification", "layer preprocess", "layer postprocess learn", "layer main", "layer loss learn", "layer loss display", "layer postprocess display", "layer confusion", "seq predict", "seq postprocess", "seq learn", "seq loss display", "seq encode", "seq decode", "seq confusion", "var input", "var enc input", "var targets", "var Classifier classes", "var Classifier probabilities", "var Classifier class weights", "var Classifier confusion", "var input avg", "var input min", "var input max", "var input std", "var input space", "var output avg", "var output min", "var output max", "var output std"]
        self.mapped[140].resolve_generated_offsets("precision", "recall", "f1Score")
        self.mapped[141].resolve_generated_offset_with_values("ada_delta", "Ada Delta", "ada_grad", "Ada Grad", "adam", "Adam", "ada_max", "Ada Max", "nadam", "NAdam", "ftrl", "Ftrl", "sgd", "Stochastic Gradient Descent", "rms_prop", "RMS Prop", "momentum", "Momentum", "nesterov", "Nesterov")
        self.mapped[142].resolve_generated_offset_with_values("none", "None", "min_max_scaling", "Min/Max Scaling", "standard_scaling", "Standard Scaling")
        ...
        self.mapped[146].resolve_generated_offset_with_values("as_is", "As-is", "average_frequency", "Average frequency", "highest_frequency", "Highest frequency")
        self.mapped[147].resolve_generated_offset_with_values("replace", "Replace", "interpolate", "Interpolate", "previous", "Previous", "next", "Next", "none", "None")
        self.mapped[149].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "std", "matchingNormalisation")
        self.mapped[150].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy")
        self.mapped[151].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "pattern_tensors", "window_tensors", "std", "matchingNormalisation")
        self.mapped[152].resolve_generated_offsets("score", "best_pattern", "timespan")
        ...
        self.mapped[156].resolve_generated_offset_with_values("as_is", "As-is", "shift", "Vertical shift", "scaling", "Vertical scaling", "shift_and_scaling", "Vertical shift and scaling")
        self.mapped[158].resolve_generated_offset_with_values("none", "None", "euclidean", "Euclidean", "fft", "FFT", "dtw", "DTW", "random", "Random", "sax", "SAX")
        self.mapped[159].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "alphabet_size", "alphabet_boundaries", "lookup_table", "max_distance", "pattern_fingerprints", "fingerprint_length")
        self.mapped[159].static_values = ["ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz"]
        self.mapped[160].resolve_generated_offsets("distance", "best_pattern", "best_timespan")
        self.mapped[163].resolve_generated_offsets("hasScores", "hasDetections", "patterns", "scores", "detections")
        self.mapped[165].resolve_generated_offsets("best_pattern", "timespan")
        self.mapped[166].resolve_generated_offsets("threshold", "overlap")
        self.mapped[167].resolve_generated_offsets("best_pattern", "timespan", "timestamp")
        self.mapped[168].resolve_generated_offsets("score", "best_pattern", "timespan", "overlap")
        self.mapped[169].static_values = [struct.unpack("d", struct.pack("l", 4606732058837280358))[0]]
        self.mapped[173].resolve_generated_offsets("counts", "x_labels", "y_labels", "counts_max", "counts_sum")
