...
class algebra(GreyCat.Library):
    ...
    class compute:
        ...
        class ComputeClassificationLoss(GreyCat.Enum):
            ...
            def categorical_cross_entropy(greycat: GreyCat) -> algebra.compute.ComputeClassificationLoss:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[0]
        ...
        class ComputeOperationElu(GreyCat.Object):
            ...
            @staticmethod
            def alpha_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[20]
                return t.static_values[0]
        ...
        class ComputeOptimizerAdaGrad(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[54]
                return t.static_values[0]
        ...
        class ComputeLayerMinMaxScaler(GreyCat.Object):
            ...
            @staticmethod
            def var_input_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[55]
                return t.static_values[0]
        ...
        class ComputeLayerLossClassification(GreyCat.Object):
            ...
            def var_class_weights_name(greycat: GreyCat) -> str:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[64]
                return t.static_values[0]
        ...
        class ComputeActivationCelu(GreyCat.Object):
            ...
            @staticmethod
            def alpha_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[85]
                return t.static_values[0]
        ...
        class ComputeOptimizerMomentum(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[102]
                return t.static_values[0]
        ...
        class ComputeOperationLeakyRelu(GreyCat.Object):
            ...
            @staticmethod
            def alpha_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[112]
                return t.static_values[0]
        ...
        class ComputeRegressionLoss(GreyCat.Enum):
            ...
            def square(greycat: GreyCat) -> algebra.compute.ComputeRegressionLoss:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[119]
                return t.enum_values[t.generated_offsets[0]]
        ...
        class ComputeOptimizerFtrl(GreyCat.Object):
            ...
            @staticmethod
            def learning_rate_def(greycat: GreyCat) -> float:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[121]
                return t.static_values[0]
    ...
    class patterns:
        ...
        class SamplingPolicy(GreyCat.Enum):
            ...
            def as_is(greycat: GreyCat) -> algebra.patterns.SamplingPolicy:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[152]
                return t.enum_values[t.generated_offsets[0]]
        ...
        class MatchingNormalisation(GreyCat.Enum):
            ...
            def as_is(greycat: GreyCat) -> algebra.patterns.MatchingNormalisation:
                t: Final[GreyCat.Type] = greycat.libs_by_name[algebra.name_].mapped[163]
                return t.enum_values[t.generated_offsets[0]]
    ...
    def init(self, greycat: GreyCat) -> None:
        ...
        self.mapped[0].resolve_generated_offset_with_values("categorical_cross_entropy", "Categorical Cross Entropy", "sparse_categorical_cross_entropy", "Sparse Categorical Cross Entropy")
        self.mapped[1].resolve_generated_offsets("name", "activation")
        self.mapped[1].static_values = ["input", "output"]
        self.mapped[2].resolve_generated_offsets("input", "output", "min", "max")
        self.mapped[4].resolve_generated_offsets("input", "output")
        self.mapped[6].resolve_generated_offsets("input", "output")
        self.mapped[7].resolve_generated_offsets("input", "output")
        self.mapped[10].resolve_generated_offsets("name", "calculate_probabilities", "from_logits")
        self.mapped[10].static_values = ["input", "predicted_classes", "probabilities"]
        self.mapped[12].resolve_generated_offsets("alpha", "max_value", "threshold")
        self.mapped[12].static_values = [0.3, 0.0]
        self.mapped[13].resolve_generated_offsets("input", "value")
        self.mapped[14].resolve_generated_offsets("learning_rate", "beta1", "beta2", "smooth_epsilon")
        self.mapped[14].static_values = [0.001, 0.9, 0.999, 0.0000001]
        self.mapped[15].resolve_generated_offsets("slope", "shift")
        self.mapped[15].static_values = [0.2, 0.5]
        self.mapped[16].resolve_generated_offsets("name", "type", "inverse_transform")
        self.mapped[16].static_values = ["input", "output", "avg", "std"]
        self.mapped[17].resolve_generated_offsets("input", "input2", "output", "transposeA", "transposeB", "alpha", "beta")
        self.mapped[17].static_values = [false, 1.0, 0.0]
        self.mapped[18].resolve_generated_offsets("name", "calls", "optimizer")
        self.mapped[19].resolve_generated_offsets("input", "output")
        self.mapped[20].resolve_generated_offsets("input", "output", "alpha")
        self.mapped[20].static_values = [1.0]
        self.mapped[21].resolve_generated_offsets("input", "output")
        self.mapped[22].resolve_generated_offsets("input", "output")
        self.mapped[23].resolve_generated_offsets("name", "type", "inverse_transform")
        self.mapped[23].static_values = ["input", "output", "avg", "std", "space"]
        self.mapped[24].resolve_generated_offsets("name", "type", "shape", "with_grad")
        self.mapped[25].resolve_generated_offsets("learning_rate")
        self.mapped[27].resolve_generated_offsets("input", "output")
        self.mapped[30].resolve_generated_offsets("input", "output", "output2")
        self.mapped[32].resolve_generated_offsets("learning_rate", "beta1", "beta2", "smooth_epsilon")
        self.mapped[32].static_values = [0.001, 0.9, 0.999, 0.0000001]
        self.mapped[34].resolve_generated_offsets("name", "type", "shape", "l1", "l2", "init")
        self.mapped[36].resolve_generated_offsets("input", "output")
        self.mapped[37].resolve_generated_offsets("input", "output")
        self.mapped[38].resolve_generated_offsets("name", "type", "shape")
        self.mapped[39].resolve_generated_offsets("input", "input2", "output")
        self.mapped[42].resolve_generated_offsets("input", "output")
        self.mapped[43].resolve_generated_offsets("input", "input2", "output")
        self.mapped[44].resolve_generated_offsets("name", "reduction")
        self.mapped[44].static_values = ["computed", "expected", "loss"]
        self.mapped[45].resolve_generated_offsets("input", "input2", "output")
        self.mapped[46].resolve_generated_offsets("learning_rate", "decay_rate")
        self.mapped[46].static_values = [0.001, 0.9]
        self.mapped[49].resolve_generated_offsets("input", "output")
        self.mapped[50].resolve_generated_offsets("input", "output")
        self.mapped[51].resolve_generated_offsets("value")
        self.mapped[52].resolve_generated_offsets("input", "input2", "output")
        self.mapped[53].resolve_generated_offsets("input", "ifCondition", "output", "counts", "classes")
        self.mapped[54].resolve_generated_offsets("learning_rate", "initial_accumulator", "smooth_epsilon")
        self.mapped[54].static_values = [0.001, 0.1, 0.0000001]
        self.mapped[55].resolve_generated_offsets("name", "type", "inverse_transform")
        self.mapped[55].static_values = ["input", "output", "min", "max"]
        self.mapped[56].resolve_generated_offsets("epoch", "optimizationSteps", "batchNotOptimized")
        self.mapped[57].resolve_generated_offsets("name")
        self.mapped[58].resolve_generated_offset_with_values("auto", "auto", "none", "none", "sum", "sum", "mean", "mean", "disabled", "disabled")
        self.mapped[59].resolve_generated_offsets("avg", "std")
        self.mapped[60].resolve_generated_offsets("input", "output")
        self.mapped[61].resolve_generated_offsets("input", "output")
        self.mapped[62].resolve_generated_offsets("input", "output", "power")
        self.mapped[63].resolve_generated_offsets("input", "input2", "output")
        self.mapped[64].resolve_generated_offsets("name", "reduction", "loss_type", "has_class_weights", "calculate_probabilities", "from_logits")
        self.mapped[64].static_values = ["class_weights", "predicted_classes", "probabilities", "sum_reduce"]
        self.mapped[65].resolve_generated_offsets("input", "output")
        self.mapped[66].resolve_generated_offsets("name")
        self.mapped[67].resolve_generated_offsets("name", "nbClass")
        self.mapped[67].static_values = ["computed", "expected", "confusion"]
        self.mapped[68].resolve_generated_offsets("input", "output")
        self.mapped[69].resolve_generated_offsets("layers")
        self.mapped[70].resolve_generated_offsets("input", "output")
        self.mapped[71].resolve_generated_offsets("input", "output", "slope", "shift")
        self.mapped[71].static_values = [0.2, 0.5]
        self.mapped[73].resolve_generated_offsets("l1", "l2")
        self.mapped[74].resolve_generated_offsets("input", "output")
        self.mapped[75].resolve_generated_offsets("name")
        self.mapped[76].resolve_generated_offsets("learning_rate", "decay_rate", "smooth_epsilon")
        self.mapped[76].static_values = [0.001, 0.95, 0.0000001]
        self.mapped[77].resolve_generated_offsets("input", "output", "output2")
        self.mapped[78].resolve_generated_offsets("input", "output")
        self.mapped[79].resolve_generated_offsets("name", "type", "inputs", "outputs", "use_bias", "weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer", "activation")
        self.mapped[79].static_values = ["input", "output", "weight", "bias", "mult", "pre_activation"]
        self.mapped[80].resolve_generated_offsets("name", "ops", "vars")
        self.mapped[81].resolve_generated_offsets("name")
        self.mapped[82].resolve_generated_offsets("input", "input2", "output")
        self.mapped[85].resolve_generated_offsets("alpha")
        self.mapped[85].static_values = [1.0]
        self.mapped[86].resolve_generated_offsets("input", "output", "alpha")
        self.mapped[86].static_values = [1.0]
        self.mapped[87].resolve_generated_offsets("input", "input2", "output")
        self.mapped[88].resolve_generated_offsets("src_layer_name", "src_var_name", "target_var_name")
        self.mapped[89].resolve_generated_offsets("classes")
        self.mapped[90].resolve_generated_offsets("input", "output", "max_value", "threshold")
        self.mapped[90].static_values = [0.0]
        self.mapped[91].resolve_generated_offsets("input", "input2", "output")
        self.mapped[92].resolve_generated_offsets("input", "output", "axis")
        self.mapped[93].resolve_generated_offsets("learning_rate", "decay_rate", "smooth_epsilon")
        self.mapped[93].static_values = [0.001, 0.9, 0.0000001]
        self.mapped[94].resolve_generated_offsets("input", "output", "output2")
        self.mapped[95].resolve_generated_offsets("alpha")
        self.mapped[95].static_values = [1.0]
        self.mapped[96].resolve_generated_offsets("input", "input2", "output")
        self.mapped[97].resolve_generated_offsets("input", "output", "mask", "nbOutputs")
        self.mapped[98].resolve_generated_offsets("input", "output")
        self.mapped[99].resolve_generated_offsets("learning_rate")
        self.mapped[99].static_values = [0.01]
        self.mapped[101].resolve_generated_offsets("name", "bias_initializer", "weight_regularizer", "bias_regularizer", "type", "use_bias", "return_sequences", "bidirectional", "auto_init_states", "inputs", "outputs", "layers", "sequences")
        self.mapped[101].static_values = ["input", "output", "hx", "cx", "hy", "cy", "weight", "bias", "internal_i", "internal_f", "internal_cp", "internal_o", "internal_h", "internal_c", "internal_mult", "internal_output"]
        self.mapped[102].resolve_generated_offsets("learning_rate", "decay_rate")
        self.mapped[102].static_values = [0.001, 0.9]
        self.mapped[103].resolve_generated_offsets("name", "reduction", "loss_type")
        self.mapped[104].resolve_generated_offsets("input", "output")
        self.mapped[105].resolve_generated_offsets("learning_rate", "beta1", "beta2", "smooth_epsilon")
        self.mapped[105].static_values = [0.001, 0.9, 0.999, 0.0000001]
        self.mapped[106].resolve_generated_offsets("input", "output")
        self.mapped[108].resolve_generated_offsets("name", "type", "inputs", "outputs", "use_bias", "weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer")
        self.mapped[108].static_values = ["input", "output", "weight", "bias", "mult"]
        self.mapped[112].resolve_generated_offsets("input", "output", "alpha", "max_value", "threshold")
        self.mapped[112].static_values = [0.3, 1.7976931349E308, 0.0]
        self.mapped[114].resolve_generated_offsets("input", "output", "axis")
        self.mapped[115].resolve_generated_offsets("input", "output")
        self.mapped[118].resolve_generated_offsets("name", "type", "inputs", "outputs", "maskValues")
        self.mapped[118].static_values = ["input", "output", "mask"]
        self.mapped[119].resolve_generated_offset_with_values("square", "Square", "abs", "Abs")
        self.mapped[121].resolve_generated_offsets("learning_rate", "lambda1", "lambda2", "beta")
        self.mapped[121].static_values = [0.001, 0.0, 0.0, 0.0]
        ...
        self.mapped[125].resolve_generated_offsets("min", "max")
        self.mapped[126].resolve_generated_offsets("max_value", "threshold")
        self.mapped[126].static_values = [0.0]
        self.mapped[127].resolve_generated_offsets("layer_name", "bindings")
        ...
        self.mapped[130].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput", "encoder_layer_idx", "encoder_layer_name", "encoder_layer_var")
        self.mapped[131].resolve_generated_offsets("weight_initializer", "weight_regularizer", "bias_initializer", "bias_regularizer")
        self.mapped[132].resolve_generated_offset_with_values("none", "None", "constant", "Constant", "sigmoid_uniform", "SigmoidUniform", "lecun_uniform", "LeCunUniform", "xavier", "Xavier", "xavier_uniform", "XavierUniform", "relu", "Relu", "relu_uniform", "ReluUniform", "normal", "Normal", "normal_in", "NormalIn", "normal_out", "NormalOut", "normal_avg", "NormalAvg", "uniform", "Uniform", "uniform_in", "UniformIn", "uniform_out", "UniformOut", "uniform_avg", "UniformAvg", "identity", "Identity", "pytorch", "Pytorch")
        self.mapped[133].resolve_generated_offset_with_values("ada_delta", "Ada Delta", "ada_grad", "Ada Grad", "adam", "Adam", "ada_max", "Ada Max", "nadam", "NAdam", "ftrl", "Ftrl", "sgd", "Stochastic Gradient Descent", "rms_prop", "RMS Prop", "momentum", "Momentum", "nesterov", "Nesterov")
        self.mapped[134].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput")
        self.mapped[134].static_values = ["Inputs or outputs can't be negative", "Last layer has different number of outputs than declared", "Incompatible loss function", "Some NN layers are not currently supported", "Tensor Type not currently supported", "NN should contain at least 1 layer", "layer placeholders", "layer classification", "layer preprocess", "layer postprocess learn", "layer main", "layer loss learn", "layer loss display", "layer postprocess display", "layer confusion", "seq predict", "seq postprocess", "seq learn", "seq loss display", "seq encode", "seq decode", "seq confusion", "var input", "var enc input", "var targets", "var Classifier classes", "var Classifier probabilities", "var Classifier class weights", "var Classifier confusion", "var input avg", "var input min", "var input max", "var input std", "var input space", "var output avg", "var output min", "var output max", "var output std"]
        self.mapped[135].resolve_generated_offset_with_values("linear", "Linear", "dense", "Dense", "activation", "Activation", "lstm", "LSTM", "loss", "Loss", "filter", "Filter")
        self.mapped[136].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput", "calculate_probabilities", "has_class_weights", "from_logits")
        self.mapped[137].resolve_generated_offsets("inputs", "inputs_gradients", "outputs", "fixed_batch_size", "inputs_sequences", "outputs_sequences", "tensor_type", "seed", "randomizeSeed", "layers", "preProcessType", "preProcessObject", "postProcessType", "postProcessObject", "optimizer", "lossLayer", "_lastLayer", "_lastOutput")
        self.mapped[138].resolve_generated_offsets("precision", "recall", "f1Score")
        self.mapped[139].resolve_generated_offset_with_values("relu", "Relu", "leaky_relu", "Leaky Relu", "sigmoid", "Sigmoid", "hard_sigmoid", "Hard Sigmoid", "exp", "Exp", "soft_max", "Soft Max", "soft_plus", "Soft Plus", "soft_sign", "Soft Sign", "tanh", "Tanh", "selu", "Selu", "elu", "Elu", "celu", "Celu")
        self.mapped[140].resolve_generated_offset_with_values("none", "None", "min_max_scaling", "Min/Max Scaling", "standard_scaling", "Standard Scaling")
        self.mapped[141].resolve_generated_offsets("previousLayerName", "previousLayerOutput", "expectedLayerName", "expectedLayerOutput", "postLayer")
        self.mapped[142].resolve_generated_offset_with_values("none", "None", "min_max_scaling", "Min/Max Scaling", "standard_scaling", "Standard Scaling", "pca_scaling", "PCA Scaling")
        ...
        self.mapped[144].resolve_generated_offsets("runDistances", "bestResult")
        self.mapped[145].static_values = ["input", "assignement", "min_distance", "centroids", "distance", "sum_centroids", "sum_min_distance", "count_centroids", "centroid_distances", "sum_cluster_distances", "avg_cluster_distances", "count_cluster_distances", "placeholders", "kmeans_forward", "kmeans_backward", "kmeans_init_round", "kmeans_end_round", "kmeans_stats_layer", "kmeans_init_round_seq", "kmeans_forward_seq", "kmeans_backward_seq", "kmeans_end_round_seq", "kmeans_stats_seq", 100, 20]
        self.mapped[147].resolve_generated_offsets("best_pattern", "timespan", "timestamp")
        self.mapped[149].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy")
        self.mapped[150].resolve_generated_offsets("threshold", "overlap")
        self.mapped[151].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "alphabet_size", "alphabet_boundaries", "lookup_table", "max_distance", "pattern_fingerprints", "fingerprint_length")
        self.mapped[151].static_values = ["ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz"]
        self.mapped[152].resolve_generated_offset_with_values("as_is", "As-is", "average_frequency", "Average frequency", "highest_frequency", "Highest frequency")
        self.mapped[153].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "std", "matchingNormalisation")
        self.mapped[154].resolve_generated_offsets("hasScores", "hasDetections", "patterns", "scores", "detections")
        self.mapped[157].resolve_generated_offsets("best_pattern", "timespan")
        self.mapped[158].resolve_generated_offsets("score", "best_pattern", "timespan")
        self.mapped[159].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "pattern_tensors", "window_tensors", "std", "matchingNormalisation")
        self.mapped[160].resolve_generated_offsets("timeseries", "state", "nullStrategy", "nullReplaceConstant", "samplingPolicy", "rng")
        self.mapped[161].resolve_generated_offset_with_values("replace", "Replace", "interpolate", "Interpolate", "previous", "Previous", "next", "Next", "none", "None")
        self.mapped[162].resolve_generated_offset_with_values("none", "None", "euclidean", "Euclidean", "fft", "FFT", "dtw", "DTW", "random", "Random", "sax", "SAX")
        self.mapped[163].resolve_generated_offset_with_values("as_is", "As-is", "shift", "Vertical shift", "scaling", "Vertical scaling", "shift_and_scaling", "Vertical shift and scaling")
        self.mapped[166].resolve_generated_offsets("distance", "best_pattern", "best_timespan")
        self.mapped[167].resolve_generated_offsets("score", "best_pattern", "timespan", "overlap")
        self.mapped[168].resolve_generated_offsets("alphabet_size", "fingerprint_length")
        self.mapped[170].static_values = [0.95]
        self.mapped[172].resolve_generated_offsets("counts", "x_labels", "y_labels", "counts_max", "counts_sum")
