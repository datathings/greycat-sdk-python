...
class std(GreyCat.Library):
    ...
    class core:
        ...
        class Error(std_n.core._Error):
            ...
            def create(greycat: GreyCat) -> std_n.core._Error:
                return std.core.Error(greycat.libs_by_name[std.name_].mapped[0])
        ...
        class Table(Generic[__T], std_n.core._Table[__T]):
            ...
            def create(greycat: GreyCat) -> std_n.core._Table:
                return std.core.Table(greycat.libs_by_name[std.name_].mapped[1])
        ...
        class String(std_n.core._String):
            ...
            def create(greycat: GreyCat) -> std_n.core._String:
                return std.core.String(greycat.libs_by_name[std.name_].mapped[2])
        ...
        class nodeList(Generic[__T], std_n.core._nodeList[__T]):
            ...
            def create(greycat: GreyCat) -> std_n.core._nodeList:
                return std.core.nodeList(greycat.libs_by_name[std.name_].mapped[3])
        ...
        class geo(std_n.core._geo):
            ...
            def create(greycat: GreyCat) -> std_n.core._geo:
                return std.core.geo(greycat.libs_by_name[std.name_].mapped[4])
        ...
        class ti5d(std_n.core._ti5d):
            ...
            def create(greycat: GreyCat) -> std_n.core._ti5d:
                return std.core.ti5d(greycat.libs_by_name[std.name_].mapped[5])
        ...
        class tf4d(std_n.core._tf4d):
            ...
            def create(greycat: GreyCat) -> std_n.core._tf4d:
                return std.core.tf4d(greycat.libs_by_name[std.name_].mapped[6])
        ...
        class SamplingMode(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.core.SamplingMode:
                return std.core.SamplingMode(greycat.libs_by_name[std.name_].mapped[7])
        ...
        class nodeTimeSingleton(GreyCat.Object):
            ...
            def create(greycat: GreyCat, t: std.core.time, v: Any) -> std.core.nodeTimeSingleton:
                return std.core.nodeTimeSingleton(greycat.libs_by_name[std.name_].mapped[9], t, v)
        ...
        class ti2d(std_n.core._ti2d):
            ...
            def create(greycat: GreyCat) -> std_n.core._ti2d:
                return std.core.ti2d(greycat.libs_by_name[std.name_].mapped[10])
        ...
        class ti10d(std_n.core._ti10d):
            ...
            def create(greycat: GreyCat) -> std_n.core._ti10d:
                return std.core.ti10d(greycat.libs_by_name[std.name_].mapped[12])
        ...
        class tf3d(std_n.core._tf3d):
            ...
            def create(greycat: GreyCat) -> std_n.core._tf3d:
                return std.core.tf3d(greycat.libs_by_name[std.name_].mapped[13])
        ...
        class Map(Generic[__K, __V], std_n.core._Map[__K, __V]):
            ...
            def create(greycat: GreyCat) -> std_n.core._Map:
                return std.core.Map(greycat.libs_by_name[std.name_].mapped[14])
        ...
        class TimeZone(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.core.TimeZone:
                return std.core.TimeZone(greycat.libs_by_name[std.name_].mapped[15])
        ...
        class Date(std_n.core._Date):
            ...
            def create(greycat: GreyCat) -> std_n.core._Date:
                return std.core.Date(greycat.libs_by_name[std.name_].mapped[16])
        ...
        class DurationUnit(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.core.DurationUnit:
                return std.core.DurationUnit(greycat.libs_by_name[std.name_].mapped[18])
        ...
        class nodeIndexBucket(std_n.core._nodeIndexBucket):
            ...
            def create(greycat: GreyCat) -> std_n.core._nodeIndexBucket:
                return std.core.nodeIndexBucket(greycat.libs_by_name[std.name_].mapped[20])
        ...
        class duration(std_n.core._duration):
            ...
            def create(greycat: GreyCat) -> std_n.core._duration:
                return std.core.duration(greycat.libs_by_name[std.name_].mapped[21])
        ...
        class TensorType(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.core.TensorType:
                return std.core.TensorType(greycat.libs_by_name[std.name_].mapped[22])
        ...
        class ti3d(std_n.core._ti3d):
            ...
            def create(greycat: GreyCat) -> std_n.core._ti3d:
                return std.core.ti3d(greycat.libs_by_name[std.name_].mapped[23])
        ...
        class ti4d(std_n.core._ti4d):
            ...
            def create(greycat: GreyCat) -> std_n.core._ti4d:
                return std.core.ti4d(greycat.libs_by_name[std.name_].mapped[25])
        ...
        class ErrorCode(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.core.ErrorCode:
                return std.core.ErrorCode(greycat.libs_by_name[std.name_].mapped[26])
        ...
        class nodeGeo(Generic[__T], std_n.core._nodeGeo[__T]):
            ...
            def create(greycat: GreyCat) -> std_n.core._nodeGeo:
                return std.core.nodeGeo(greycat.libs_by_name[std.name_].mapped[29])
        ...
        class GeoPoly(GreyCat.Object):
            ...
            def create(greycat: GreyCat, points: std.core.Array) -> std.core.GeoPoly:
                return std.core.GeoPoly(greycat.libs_by_name[std.name_].mapped[30], points)
        ...
        class NodeInfo(Generic[__T], GreyCat.Object):
            ...
            def create(greycat: GreyCat, size: int, from_: std.core.__T, to: std.core.__T) -> std.core.NodeInfo[TypeVar("T")]:
                return std.core.NodeInfo(greycat.libs_by_name[std.name_].mapped[31], size, from_, to)
        ...
        class time(std_n.core._time):
            ...
            def create(greycat: GreyCat) -> std_n.core._time:
                return std.core.time(greycat.libs_by_name[std.name_].mapped[32])
        ...
        class DatePart(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.core.DatePart:
                return std.core.DatePart(greycat.libs_by_name[std.name_].mapped[33])
        ...
        class ti6d(std_n.core._ti6d):
            ...
            def create(greycat: GreyCat) -> std_n.core._ti6d:
                return std.core.ti6d(greycat.libs_by_name[std.name_].mapped[34])
        ...
        class GeoBox(GreyCat.Object):
            ...
            def create(greycat: GreyCat, sw: std.core.geo, ne: std.core.geo) -> std.core.GeoBox:
                return std.core.GeoBox(greycat.libs_by_name[std.name_].mapped[35], sw, ne)
        ...
        class TableColumnMeta(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, type: str, size: int, index: bool, min: Any, max: Any, avg: Any, std: Any) -> std.core.TableColumnMeta:
                return std.core.TableColumnMeta(greycat.libs_by_name[std.name_].mapped[36], type, size, index, min, max, avg, std)
        ...
        class GeoCircle(GreyCat.Object):
            ...
            def create(greycat: GreyCat, center: std.core.geo, radius: float) -> std.core.GeoCircle:
                return std.core.GeoCircle(greycat.libs_by_name[std.name_].mapped[37], center, radius)
        ...
        class tf2d(std_n.core._tf2d):
            ...
            def create(greycat: GreyCat) -> std_n.core._tf2d:
                return std.core.tf2d(greycat.libs_by_name[std.name_].mapped[38])
    ...
    class runtime:
        ...
        class UserRole(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, permissions: std.core.Array) -> std.runtime.UserRole:
                return std.runtime.UserRole(greycat.libs_by_name[std.name_].mapped[39], name, permissions)
        ...
        class RuntimeInfo(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, version: str, arch: str, timezone: std.core.TimeZone, license: std.runtime.License, io_threads: int, bg_threads: int, fg_threads: int, mem_total: int, mem_worker: int, nb_ctx: int, store_stats: std.runtime.StoreStat) -> std.runtime.RuntimeInfo:
                return std.runtime.RuntimeInfo(greycat.libs_by_name[std.name_].mapped[40], version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats)
        ...
        class SecurityPolicy(GreyCat.Object):
            ...
            def create(greycat: GreyCat, entities: std.core.Array, credentials: std.core.Map, roles: std.core.Map, fields: std.runtime.SecurityFields) -> std.runtime.SecurityPolicy:
                return std.runtime.SecurityPolicy(greycat.libs_by_name[std.name_].mapped[41], entities, credentials, roles, fields)
        ...
        class StoreStat(GreyCat.Object):
            ...
            def create(greycat: GreyCat, capacity_bytes: int, allocated_bytes: int, allocated_ratio: float, remained_bytes: int, remained_ratio: float, used_bytes: int, used_ratio: float, available_bytes: int, available_ratio: float) -> std.runtime.StoreStat:
                return std.runtime.StoreStat(greycat.libs_by_name[std.name_].mapped[42], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio)
        ...
        class System(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.runtime.System:
                return std.runtime.System(greycat.libs_by_name[std.name_].mapped[43])
        ...
        class Task(GreyCat.Object):
            ...
            def create(greycat: GreyCat, user_id: int, task_id: int, mod: str, type: str, fun: str, creation: std.core.time, status: std.runtime.TaskStatus) -> std.runtime.Task:
                return std.runtime.Task(greycat.libs_by_name[std.name_].mapped[44], user_id, task_id, mod, type, fun, creation, status)
        ...
        class OpenIDConnect(GreyCat.Object):
            ...
            def create(greycat: GreyCat, url: str, clientId: str) -> std.runtime.OpenIDConnect:
                return std.runtime.OpenIDConnect(greycat.libs_by_name[std.name_].mapped[45], url, clientId)
        ...
        class PeriodicTask(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, user_id: int, args: str, start: std.core.time, every: std.core.duration) -> std.runtime.PeriodicTask:
                return std.runtime.PeriodicTask(greycat.libs_by_name[std.name_].mapped[46], name, user_id, args, start, every)
        ...
        class UserGroupPolicy(GreyCat.Object):
            ...
            def create(greycat: GreyCat, group_id: int, type: std.runtime.UserGroupPolicyType) -> std.runtime.UserGroupPolicy:
                return std.runtime.UserGroupPolicy(greycat.libs_by_name[std.name_].mapped[47], group_id, type)
        ...
        class UserGroupPolicyType(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.runtime.UserGroupPolicyType:
                return std.runtime.UserGroupPolicyType(greycat.libs_by_name[std.name_].mapped[48])
        ...
        class TaskInfo(GreyCat.Object):
            ...
            def create(greycat: GreyCat, user_id: int, task_id: int, mod: str, type: str, fun: str, creation: std.core.time, status: std.runtime.TaskStatus, start: std.core.time, progress: float, remaining: std.core.duration, duration: std.core.duration, sub_waiting: int, sub_tasks_all: int) -> std.runtime.TaskInfo:
                return std.runtime.TaskInfo(greycat.libs_by_name[std.name_].mapped[49], user_id, task_id, mod, type, fun, creation, status, start, progress, remaining, duration, sub_waiting, sub_tasks_all)
        ...
        class UserGroup(GreyCat.Object):
            ...
            def create(greycat: GreyCat, id: int, name: str, activated: bool) -> std.runtime.UserGroup:
                return std.runtime.UserGroup(greycat.libs_by_name[std.name_].mapped[50], id, name, activated)
        ...
        class SecurityEntity(GreyCat.Object):
            ...
            def create(greycat: GreyCat, id: int, name: str, activated: bool) -> std.runtime.SecurityEntity:
                return std.runtime.SecurityEntity(greycat.libs_by_name[std.name_].mapped[52], id, name, activated)
        ...
        class Runtime(GreyCat.Object):
            ...
            @staticmethod
            def abi_headers(greycat: GreyCat) -> std.core.Array:
                return GreyCat.call(greycat, "runtime::Runtime::abi_headers")
            ...
            def create(greycat: GreyCat) -> std.runtime.Runtime:
                return std.runtime.Runtime(greycat.libs_by_name[std.name_].mapped[53])
        ...
        class TaskStatus(GreyCat.Enum):
            ...
            def empty(greycat: GreyCat) -> std.runtime.TaskStatus:
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[54]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> std.runtime.TaskStatus:
                return std.runtime.TaskStatus(greycat.libs_by_name[std.name_].mapped[54])
        ...
        class User(GreyCat.Object):
            ...
            def create(greycat: GreyCat, id: int, name: str, activated: bool, full_name: str, email: str, role: str, permissions_flags: int, groups: std.core.Array, groups_flags: int, external: bool) -> std.runtime.User:
                return std.runtime.User(greycat.libs_by_name[std.name_].mapped[55], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external)
        ...
        class License(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, start: std.core.time, end: std.core.time, company: str, max_workers: int, max_memory: int, extra_1: int, extra_2: int, extra_3: int, extra_4: int) -> std.runtime.License:
                return std.runtime.License(greycat.libs_by_name[std.name_].mapped[56], name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4)
        ...
        class UserCredential(GreyCat.Object):
            ...
            def create(greycat: GreyCat, offset: int, pass_: str) -> std.runtime.UserCredential:
                return std.runtime.UserCredential(greycat.libs_by_name[std.name_].mapped[57], offset, pass_)
    ...
    class io:
        ...
        class CsvColumnDuration(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, mandatory: bool, unit: std.core.DurationUnit) -> std.io.CsvColumnDuration:
                return std.io.CsvColumnDuration(greycat.libs_by_name[std.name_].mapped[58], name, mandatory, unit)
        ...
        class File(GreyCat.Object):
            ...
            def create(greycat: GreyCat, path: str, size: int, last_modification: std.core.time) -> std.io.File:
                return std.io.File(greycat.libs_by_name[std.name_].mapped[59], path, size, last_modification)
        ...
        class SmtpMode(GreyCat.Enum):
            ...
            def plain(greycat: GreyCat) -> std.io.SmtpMode:
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[60]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> std.io.SmtpMode:
                return std.io.SmtpMode(greycat.libs_by_name[std.name_].mapped[60])
        ...
        class HttpHeader(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, value: str) -> std.io.HttpHeader:
                return std.io.HttpHeader(greycat.libs_by_name[std.name_].mapped[61], name, value)
        ...
        class CsvColumnBoolean(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnBoolean:
                return std.io.CsvColumnBoolean(greycat.libs_by_name[std.name_].mapped[62], name, mandatory)
        ...
        class CsvColumnIgnored(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnIgnored:
                return std.io.CsvColumnIgnored(greycat.libs_by_name[std.name_].mapped[63], name, mandatory)
        ...
        class CsvFormat(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, header_lines: int, infer: bool, separator: c_char, string_delimiter: c_char, decimal_separator: c_char, thousands_separator: c_char, columns: std.core.Array) -> std.io.CsvFormat:
                return std.io.CsvFormat(greycat.libs_by_name[std.name_].mapped[65], header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns)
        ...
        class Smtp(GreyCat.Object):
            ...
            def create(greycat: GreyCat, host: str, port: int, mode: std.io.SmtpMode, authenticate: std.io.SmtpAuth, user: str, pass_: str) -> std.io.Smtp:
                return std.io.Smtp(greycat.libs_by_name[std.name_].mapped[66], host, port, mode, authenticate, user, pass_)
        ...
        class Url(GreyCat.Object):
            ...
            def create(greycat: GreyCat, protocol: str, host: str, port: int, path: str, params: std.core.Map, hash: str) -> std.io.Url:
                return std.io.Url(greycat.libs_by_name[std.name_].mapped[67], protocol, host, port, path, params, hash)
        ...
        class CsvColumnString(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, mandatory: bool, trim: bool, try_number: bool, try_json: bool, values: std.core.Array, encoder: std.io.TextEncoder) -> std.io.CsvColumnString:
                return std.io.CsvColumnString(greycat.libs_by_name[std.name_].mapped[68], name, mandatory, trim, try_number, try_json, values, encoder)
        ...
        class CsvColumnFloat(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnFloat:
                return std.io.CsvColumnFloat(greycat.libs_by_name[std.name_].mapped[69], name, mandatory)
        ...
        class CsvColumnTime(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, mandatory: bool, unit: std.core.DurationUnit) -> std.io.CsvColumnTime:
                return std.io.CsvColumnTime(greycat.libs_by_name[std.name_].mapped[70], name, mandatory, unit)
        ...
        class Email(GreyCat.Object):
            ...
            def create(greycat: GreyCat, from_: str, subject: str, body: str, body_is_html: bool, to: std.core.Array, cc: std.core.Array, bcc: std.core.Array) -> std.io.Email:
                return std.io.Email(greycat.libs_by_name[std.name_].mapped[71], from_, subject, body, body_is_html, to, cc, bcc)
        ...
        class CsvColumn(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumn:
                return std.io.CsvColumn(greycat.libs_by_name[std.name_].mapped[72], name, mandatory)
        ...
        class SmtpAuth(GreyCat.Enum):
            ...
            def none(greycat: GreyCat) -> std.io.SmtpAuth:
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[73]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> std.io.SmtpAuth:
                return std.io.SmtpAuth(greycat.libs_by_name[std.name_].mapped[73])
        ...
        class CsvColumnInteger(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnInteger:
                return std.io.CsvColumnInteger(greycat.libs_by_name[std.name_].mapped[74], name, mandatory)
        ...
        class CsvColumnDate(GreyCat.Object):
            ...
            @staticmethod
            def create(greycat: GreyCat, name: str, mandatory: bool, format: str, tz: std.core.TimeZone, as_time: bool) -> std.io.CsvColumnDate:
                return std.io.CsvColumnDate(greycat.libs_by_name[std.name_].mapped[75], name, mandatory, format, tz, as_time)
        ...
        class TextEncoder(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.io.TextEncoder:
                return std.io.TextEncoder(greycat.libs_by_name[std.name_].mapped[76])
    ...
    class math:
        ...
        class MathConstants(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.math.MathConstants:
                return std.math.MathConstants(greycat.libs_by_name[std.name_].mapped[77])
    ...
    class util:
        ...
        class TimeWindow(std_n.util._TimeWindow):
            ...
            def create(greycat: GreyCat) -> std_n.util._TimeWindow:
                return std.util.TimeWindow(greycat.libs_by_name[std.name_].mapped[78])
        ...
        class Queue(Generic[__T], std_n.util._Queue[__T]):
            ...
            def create(greycat: GreyCat) -> std_n.util._Queue:
                return std.util.Queue(greycat.libs_by_name[std.name_].mapped[79])
        ...
        class Buffer(std_n.util._Buffer):
            ...
            def create(greycat: GreyCat) -> std_n.util._Buffer:
                return std.util.Buffer(greycat.libs_by_name[std.name_].mapped[80])
        ...
        class Random(GreyCat.Object):
            ...
            def create(greycat: GreyCat, seed: int, v: float) -> std.util.Random:
                return std.util.Random(greycat.libs_by_name[std.name_].mapped[81], seed, v)
        ...
        class BoxPlotFloat(GreyCat.Object):
            ...
            def create(greycat: GreyCat, min: float, max: float, whiskerLow: float, whiskerHigh: float, percentile1: float, percentile5: float, percentile25: float, percentile50: float, percentile75: float, percentile95: float, percentile99: float, countOutliersLow: int, countOutliersHigh: int, percentageOutliersLow: float, percentageOutliersHigh: float, sum: float, avg: float, std: float, size: int) -> std.util.BoxPlotFloat:
                return std.util.BoxPlotFloat(greycat.libs_by_name[std.name_].mapped[82], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size)
        ...
        class Crypto(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.util.Crypto:
                return std.util.Crypto(greycat.libs_by_name[std.name_].mapped[83])
        ...
        class Assert(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.util.Assert:
                return std.util.Assert(greycat.libs_by_name[std.name_].mapped[84])
        ...
        class GaussianProfile(std_n.util._GaussianProfile):
            ...
            def create(greycat: GreyCat) -> std_n.util._GaussianProfile:
                return std.util.GaussianProfile(greycat.libs_by_name[std.name_].mapped[85])
        ...
        class Gaussian(GreyCat.Object):
            ...
            def create(greycat: GreyCat, sum: float, sum_sq: float, count: int, min: float, max: float) -> std.util.Gaussian:
                return std.util.Gaussian(greycat.libs_by_name[std.name_].mapped[86], sum, sum_sq, count, min, max)
        ...
        class BoxPlotInt(GreyCat.Object):
            ...
            def create(greycat: GreyCat, min: int, max: int, whiskerLow: int, whiskerHigh: int, percentile1: int, percentile5: int, percentile25: int, percentile50: int, percentile75: int, percentile95: int, percentile99: int, countOutliersLow: int, countOutliersHigh: int, percentageOutliersLow: float, percentageOutliersHigh: float, sum: float, avg: float, std: float, size: int) -> std.util.BoxPlotInt:
                return std.util.BoxPlotInt(greycat.libs_by_name[std.name_].mapped[88], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size)
        ...
        class HistogramInt(std_n.util._HistogramInt):
            ...
            def create(greycat: GreyCat) -> std_n.util._HistogramInt:
                return std.util.HistogramInt(greycat.libs_by_name[std.name_].mapped[89])
        ...
        class Quantizer(std_n.util._Quantizer):
            ...
            def create(greycat: GreyCat) -> std_n.util._Quantizer:
                return std.util.Quantizer(greycat.libs_by_name[std.name_].mapped[90])
        ...
        class HistogramFloat(std_n.util._HistogramFloat):
            ...
            def create(greycat: GreyCat) -> std_n.util._HistogramFloat:
                return std.util.HistogramFloat(greycat.libs_by_name[std.name_].mapped[91])
        ...
        class ProgressTracker(GreyCat.Object):
            ...
            def create(greycat: GreyCat, start: std.core.time, total: int, counter: int, duration: std.core.duration, progress: float, speed: float, remaining: std.core.duration) -> std.util.ProgressTracker:
                return std.util.ProgressTracker(greycat.libs_by_name[std.name_].mapped[92], start, total, counter, duration, progress, speed, remaining)
        ...
        class SlidingWindow(std_n.util._SlidingWindow):
            ...
            def create(greycat: GreyCat) -> std_n.util._SlidingWindow:
                return std.util.SlidingWindow(greycat.libs_by_name[std.name_].mapped[93])
    ...
    def init(self, greycat: GreyCat) -> None:
        ...
        self.mapped[4].static_values = [greycat.create_geo(-85.0511287602, -179.9999999581), greycat.create_geo(85.0511287602, 179.9999999581)]
        self.mapped[7].resolve_generated_offset_with_values("fixed", 0, "fixed_reg", 1, "adaptative", 2, "dense", 3)
        self.mapped[9].resolve_generated_offsets("t", "v")
        ...
        self.mapped[18].resolve_generated_offset_with_values("microseconds", 1, "milliseconds", 1000, "seconds", 1000000, "minutes", 60000000, "hours", 3600000000, "days", 86400000000, "weeks", 604800000000, "months", 2628000000000, "years", 31536000000000)
        self.mapped[22].resolve_generated_offset_with_values("i32", 4, "i64", 8, "f32", 4, "f64", 8, "c64", 8, "c128", 16)
        ...
        self.mapped[30].resolve_generated_offsets("points")
        self.mapped[31].resolve_generated_offsets("size", "from", "to")
        self.mapped[32].static_values = [greycat.create_time(-9223372036854775808), greycat.create_time(9223372036854775807)]
        self.mapped[33].resolve_generated_offset_with_values("years", 0, "months", 1, "days", 2, "hours", 3, "minutes", 4, "seconds", 5, "microseconds", 6)
        self.mapped[35].resolve_generated_offsets("sw", "ne")
        self.mapped[36].resolve_generated_offsets("type", "size", "index", "min", "max", "avg", "std")
        self.mapped[37].resolve_generated_offsets("center", "radius")
        self.mapped[39].resolve_generated_offsets("name", "permissions")
        self.mapped[40].resolve_generated_offsets("version", "arch", "timezone", "license", "io_threads", "bg_threads", "fg_threads", "mem_total", "mem_worker", "nb_ctx", "store_stats")
        self.mapped[41].resolve_generated_offsets("entities", "credentials", "roles", "fields")
        self.mapped[42].resolve_generated_offsets("capacity_bytes", "allocated_bytes", "allocated_ratio", "remained_bytes", "remained_ratio", "used_bytes", "used_ratio", "available_bytes", "available_ratio")
        self.mapped[44].resolve_generated_offsets("user_id", "task_id", "mod", "type", "fun", "creation", "status")
        self.mapped[45].resolve_generated_offsets("url", "clientId")
        self.mapped[46].resolve_generated_offsets("name", "user_id", "args", "start", "every")
        self.mapped[47].resolve_generated_offsets("group_id", "type")
        self.mapped[48].resolve_generated_offset_with_values("read", 0, "write", 1, "execute", 2)
        self.mapped[49].resolve_generated_offsets("user_id", "task_id", "mod", "type", "fun", "creation", "status", "start", "progress", "remaining", "duration", "sub_waiting", "sub_tasks_all")
        self.mapped[50].resolve_generated_offsets("id", "name", "activated")
        self.mapped[51].resolve_generated_offsets("email", "name", "first_name", "last_name", "roles", "groups")
        self.mapped[52].resolve_generated_offsets("id", "name", "activated")
        self.mapped[54].resolve_generated_offset_with_values("empty", 0, "waiting", 1, "running", 2, "cancelled", 3, "error", 4, "ended", 5)
        self.mapped[55].resolve_generated_offsets("id", "name", "activated", "full_name", "email", "role", "permissions_flags", "groups", "groups_flags", "external")
        self.mapped[56].resolve_generated_offsets("name", "start", "end", "company", "max_workers", "max_memory", "extra_1", "extra_2", "extra_3", "extra_4")
        self.mapped[57].resolve_generated_offsets("offset", "pass")
        self.mapped[58].resolve_generated_offsets("name", "mandatory", "unit")
        self.mapped[59].resolve_generated_offsets("path", "size", "last_modification")
        self.mapped[60].resolve_generated_offset_with_values("plain", 0, "ssl_tls", 1, "starttls", 2)
        self.mapped[61].resolve_generated_offsets("name", "value")
        self.mapped[62].resolve_generated_offsets("name", "mandatory")
        self.mapped[63].resolve_generated_offsets("name", "mandatory")
        self.mapped[65].resolve_generated_offsets("header_lines", "infer", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "columns")
        self.mapped[66].resolve_generated_offsets("host", "port", "mode", "authenticate", "user", "pass")
        self.mapped[67].resolve_generated_offsets("protocol", "host", "port", "path", "params", "hash")
        self.mapped[68].resolve_generated_offsets("name", "mandatory", "trim", "try_number", "try_json", "values", "encoder")
        self.mapped[69].resolve_generated_offsets("name", "mandatory")
        self.mapped[70].resolve_generated_offsets("name", "mandatory", "unit")
        self.mapped[71].resolve_generated_offsets("from", "subject", "body", "body_is_html", "to", "cc", "bcc")
        self.mapped[72].resolve_generated_offsets("name", "mandatory")
        self.mapped[73].resolve_generated_offset_with_values("none", 0, "plain", 1, "login", 2)
        self.mapped[74].resolve_generated_offsets("name", "mandatory")
        self.mapped[75].resolve_generated_offsets("name", "mandatory", "format", "tz", "as_time")
        ...
        self.mapped[81].resolve_generated_offsets("seed", "v")
        self.mapped[82].resolve_generated_offsets("min", "max", "whiskerLow", "whiskerHigh", "percentile1", "percentile5", "percentile25", "percentile50", "percentile75", "percentile95", "percentile99", "countOutliersLow", "countOutliersHigh", "percentageOutliersLow", "percentageOutliersHigh", "sum", "avg", "std", "size")
        self.mapped[85].static_values = [0, 1, 2, 3, 4, 5, 6]
        self.mapped[86].resolve_generated_offsets("sum", "sum_sq", "count", "min", "max")
        ...
        self.mapped[91].static_values = [0, 1, 2, 3]
        self.mapped[92].resolve_generated_offsets("start", "total", "counter", "duration", "progress", "speed", "remaining")
