...
class std(GreyCat.Library):
    ...
    def init(self, greycat: GreyCat) -> None:
        ...
        self.mapped[23].resolve_generated_offsets("sw", "ne")
        ...
        self.mapped[26].resolve_generated_offsets("t", "v")
        self.mapped[28].resolve_generated_offsets("center", "radius")
        self.mapped[29].resolve_generated_offsets("points")
        self.mapped[30].resolve_generated_offsets("message", "stack")
        self.mapped[31].resolve_generated_offsets("module", "function", "line", "column")
        ...
        self.mapped[36].static_values = [greycat.create_time(-9223372036854775808), greycat.create_time(9223372036854775807)]
        ...
        self.mapped[44].resolve_generated_offset_with_values("none", 0, "interrupted", 1, "await", 2, "timeout", 6, "forbidden", 7, "runtime_error", 8)
        self.mapped[45].resolve_generated_offsets("email", "name", "first_name", "last_name", "roles", "groups")
        self.mapped[46].resolve_generated_offsets("name", "value")
        ...
        self.mapped[52].resolve_generated_offsets("entities", "credentials", "roles", "fields", "keys", "keys_last_refresh")
        self.mapped[53].resolve_generated_offsets("module", "line", "column")
        self.mapped[54].resolve_generated_offsets("id", "name", "activated")
        self.mapped[55].resolve_generated_offsets("level", "time", "user_id", "id", "id2", "src", "tag", "data")
        self.mapped[58].resolve_generated_offsets("name", "permissions")
        self.mapped[59].resolve_generated_offsets("group_id", "type")
        self.mapped[60].resolve_generated_offsets("id", "name", "activated", "full_name", "email", "role", "permissions_flags", "groups", "groups_flags", "external")
        self.mapped[61].resolve_generated_offsets("function", "arguments")
        self.mapped[62].resolve_generated_offsets("duration", "bytes_write_disk", "bytes_write_disk_raw", "bytes_read_disk", "bytes_read_disk_raw", "bytes_read_cache")
        self.mapped[64].resolve_generated_offsets("module", "function", "line", "column", "scope")
        self.mapped[65].resolve_generated_offsets("function", "user_id", "arguments", "start", "every")
        self.mapped[66].resolve_generated_offsets("name", "start", "end", "company", "max_memory", "extra_1", "extra_2", "type")
        self.mapped[67].resolve_generated_offset_with_values("error", None, "warn", None, "info", None, "perf", None, "trace", None)
        self.mapped[68].resolve_generated_offsets("url", "clientId")
        self.mapped[69].resolve_generated_offsets("capacity_bytes", "allocated_bytes", "allocated_ratio", "remained_bytes", "remained_ratio", "used_bytes", "used_ratio", "available_bytes", "available_ratio")
        self.mapped[70].resolve_generated_offset_with_values("community", 0, "enterprise", 1, "testing", 2)
        self.mapped[71].resolve_generated_offsets("user_id", "task_id", "mod", "type", "fun", "creation", "start", "duration", "status", "progress")
        self.mapped[72].resolve_generated_offset_with_values("empty", 0, "waiting", 1, "running", 2, "await", 3, "cancelled", 4, "error", 5, "ended", 6, "ended_with_errors", 7)
        self.mapped[73].resolve_generated_offsets("path")
        self.mapped[74].resolve_generated_offsets("header_lines", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "columns", "line_count", "fail_count", "file_count")
        self.mapped[75].resolve_generated_offsets("name", "example", "null_count", "bool_count", "int_count", "float_count", "string_count", "date_count", "date_format_count", "enumerable_count", "profile")
        self.mapped[77].resolve_generated_offsets("name", "value")
        ...
        self.mapped[81].resolve_generated_offsets("name", "mandatory", "offset", "trim", "try_number", "try_json", "values", "encoder")
        self.mapped[82].resolve_generated_offsets("name", "mandatory", "offset", "format", "tz", "as_time")
        self.mapped[83].resolve_generated_offsets("path", "append")
        self.mapped[84].resolve_generated_offsets("from", "subject", "body", "body_is_html", "to", "cc", "bcc")
        self.mapped[85].resolve_generated_offsets("name", "mandatory", "offset")
        self.mapped[86].resolve_generated_offsets("path", "append")
        self.mapped[87].resolve_generated_offsets("path", "size", "last_modification")
        self.mapped[88].resolve_generated_offsets("name", "mandatory", "offset")
        self.mapped[89].resolve_generated_offsets("name", "mandatory", "offset", "unit")
        self.mapped[90].resolve_generated_offsets("name", "mandatory", "offset")
        self.mapped[91].resolve_generated_offset_with_values("plain", 0, "ssl_tls", 1, "starttls", 2)
        self.mapped[92].resolve_generated_offsets("header_lines", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "row_limit", "enumerable_limit", "date_check_limit", "date_formats")
        self.mapped[92].static_values = [100, 100]
        self.mapped[93].resolve_generated_offsets("path", "pos")
        self.mapped[94].resolve_generated_offsets("config", "statistics")
        self.mapped[95].resolve_generated_offsets("path", "append", "format")
        self.mapped[96].resolve_generated_offset_with_values("plain", None, "base64", None, "base64url", None, "hexadecimal", None)
        self.mapped[97].resolve_generated_offsets("path", "pos", "format", "sharding")
        self.mapped[98].resolve_generated_offsets("path", "pos")
        ...
        self.mapped[101].resolve_generated_offsets("name", "mandatory", "offset", "unit")
        self.mapped[102].resolve_generated_offsets("path", "pos")
        self.mapped[103].resolve_generated_offsets("host", "port", "mode", "authenticate", "user", "pass")
        self.mapped[104].resolve_generated_offsets("line_count", "fail_count", "invalid_count")
        self.mapped[105].resolve_generated_offsets("path", "pos")
        self.mapped[106].resolve_generated_offsets("path", "append")
        self.mapped[107].resolve_generated_offset_with_values("none", 0, "plain", 1, "login", 2)
        self.mapped[108].resolve_generated_offsets("header_lines", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "columns_size", "columns")
        self.mapped[109].resolve_generated_offsets("id", "column", "modulo")
        self.mapped[111].resolve_generated_offsets("min", "max", "bins", "open")
        self.mapped[112].resolve_generated_offsets("min", "max", "bins", "open")
        self.mapped[113].resolve_generated_offsets("sum", "sumsq", "count")
        self.mapped[114].resolve_generated_offsets("start", "total", "counter", "duration", "progress", "speed", "remaining")
        self.mapped[115].resolve_generated_offsets("min", "max", "whisker_low", "whisker_high", "percentile1", "percentile5", "percentile25", "percentile50", "percentile75", "percentile95", "percentile99", "count_outliers_low", "count_outliers_high", "percentage_outliers_low", "percentage_outliers_high", "sum", "avg", "std", "size")
        self.mapped[116].resolve_generated_offsets("seed", "v")
        self.mapped[117].resolve_generated_offsets("quantizers")
        self.mapped[119].resolve_generated_offsets("min", "max", "center")
        self.mapped[120].resolve_generated_offsets("sum", "sumsq", "count", "min", "max")
        self.mapped[121].resolve_generated_offsets("values")
        self.mapped[122].resolve_generated_offsets("quantizer", "bins", "nb_rejected", "nb_accepted")
        self.mapped[123].resolve_generated_offsets("values", "span", "sum", "sumsq", "field")
        self.mapped[124].resolve_generated_offsets("min", "max", "step_starts", "open")
        self.mapped[126].resolve_generated_offsets("values", "capacity")
        self.mapped[127].resolve_generated_offsets("quantizer", "precision", "bins", "value_min", "nb_rejected")
