...
class std(GreyCat.Library):
    ...
    class util:
        ...
        class TimeWindow(std_n.util._TimeWindow):
            ...
            def create(greycat: GreyCat) -> std_n.util._TimeWindow:
                return std.util.TimeWindow(greycat.libs_by_name[std.name_].mapped[39])
        ...
        class Random(GreyCat.Object):
            ...
            def create(greycat: GreyCat, seed: int, v: float) -> std.util.Random:
                return std.util.Random(greycat.libs_by_name[std.name_].mapped[40], seed, v)
        ...
        class HistogramInt(std_n.util._HistogramInt):
            ...
            def create(greycat: GreyCat) -> std_n.util._HistogramInt:
                return std.util.HistogramInt(greycat.libs_by_name[std.name_].mapped[41])
        ...
        class Queue(Generic[__T], std_n.util._Queue[__T]):
            ...
            def create(greycat: GreyCat) -> std_n.util._Queue:
                return std.util.Queue(greycat.libs_by_name[std.name_].mapped[42])
        ...
        class HistogramFloat(std_n.util._HistogramFloat):
            ...
            def create(greycat: GreyCat) -> std_n.util._HistogramFloat:
                return std.util.HistogramFloat(greycat.libs_by_name[std.name_].mapped[43])
        ...
        class BoxPlotInt(GreyCat.Object):
            ...
            def create(greycat: GreyCat, min: int, max: int, whiskerLow: int, whiskerHigh: int, percentile1: int, percentile5: int, percentile25: int, percentile50: int, percentile75: int, percentile95: int, percentile99: int, countOutliersLow: int, countOutliersHigh: int, percentageOutliersLow: float, percentageOutliersHigh: float, sum: float, avg: float, std: float, size: int) -> std.util.BoxPlotInt:
                return std.util.BoxPlotInt(greycat.libs_by_name[std.name_].mapped[44], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size)
        ...
        class Buffer(std_n.util._Buffer):
            ...
            def create(greycat: GreyCat) -> std_n.util._Buffer:
                return std.util.Buffer(greycat.libs_by_name[std.name_].mapped[45])
        ...
        class Iban(std_n.util._Iban):
            ...
            def create(greycat: GreyCat) -> std_n.util._Iban:
                return std.util.Iban(greycat.libs_by_name[std.name_].mapped[46])
        ...
        class Crypto(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.util.Crypto:
                return std.util.Crypto(greycat.libs_by_name[std.name_].mapped[47])
        ...
        class Gaussian(GreyCat.Object):
            ...
            def create(greycat: GreyCat, sum: float, sum_sq: float, count: int, min: float, max: float) -> std.util.Gaussian:
                return std.util.Gaussian(greycat.libs_by_name[std.name_].mapped[48], sum, sum_sq, count, min, max)
        ...
        class Quantizer(std_n.util._Quantizer):
            ...
            def create(greycat: GreyCat) -> std_n.util._Quantizer:
                return std.util.Quantizer(greycat.libs_by_name[std.name_].mapped[49])
        ...
        class BoxPlotFloat(GreyCat.Object):
            ...
            def create(greycat: GreyCat, min: float, max: float, whiskerLow: float, whiskerHigh: float, percentile1: float, percentile5: float, percentile25: float, percentile50: float, percentile75: float, percentile95: float, percentile99: float, countOutliersLow: int, countOutliersHigh: int, percentageOutliersLow: float, percentageOutliersHigh: float, sum: float, avg: float, std: float, size: int) -> std.util.BoxPlotFloat:
                return std.util.BoxPlotFloat(greycat.libs_by_name[std.name_].mapped[50], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size)
        ...
        class GaussianProfile(std_n.util._GaussianProfile):
            ...
            def create(greycat: GreyCat) -> std_n.util._GaussianProfile:
                return std.util.GaussianProfile(greycat.libs_by_name[std.name_].mapped[51])
        ...
        class SlidingWindow(std_n.util._SlidingWindow):
            ...
            def create(greycat: GreyCat) -> std_n.util._SlidingWindow:
                return std.util.SlidingWindow(greycat.libs_by_name[std.name_].mapped[52])
        ...
        class ProgressTracker(GreyCat.Object):
            ...
            def create(greycat: GreyCat, start: std.core.time, total: int, counter: int, duration: std.core.duration, progress: float, speed: float, remaining: std.core.duration) -> std.util.ProgressTracker:
                return std.util.ProgressTracker(greycat.libs_by_name[std.name_].mapped[53], start, total, counter, duration, progress, speed, remaining)
        ...
        class Assert(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.util.Assert:
                return std.util.Assert(greycat.libs_by_name[std.name_].mapped[54])
    ...
    class math:
        ...
        class MathConstants(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.math.MathConstants:
                return std.math.MathConstants(greycat.libs_by_name[std.name_].mapped[55])
    ...
    class runtime:
        ...
        class SecurityFields(GreyCat.Object):
            ...
            def create(greycat: GreyCat, email: str, name: str, first_name: str, last_name: str, roles: std.core.Map, groups: std.core.Map) -> std.runtime.SecurityFields:
                return std.runtime.SecurityFields(greycat.libs_by_name[std.name_].mapped[60], email, name, first_name, last_name, roles, groups)
        ...
        class OpenIDConnect(GreyCat.Object):
            ...
            def create(greycat: GreyCat, url: str, clientId: str) -> std.runtime.OpenIDConnect:
                return std.runtime.OpenIDConnect(greycat.libs_by_name[std.name_].mapped[61], url, clientId)
        ...
        class System(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.runtime.System:
                return std.runtime.System(greycat.libs_by_name[std.name_].mapped[62])
        ...
        class TaskStatus(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.runtime.TaskStatus:
                return std.runtime.TaskStatus(greycat.libs_by_name[std.name_].mapped[63])
        ...
        class RuntimeInfo(GreyCat.Object):
            ...
            def create(greycat: GreyCat, version: str, arch: str, timezone: std.core.TimeZone, license: std.runtime.License, io_threads: int, bg_threads: int, fg_threads: int, mem_total: int, mem_worker: int, nb_ctx: int, store_stats: std.runtime.StoreStat) -> std.runtime.RuntimeInfo:
                return std.runtime.RuntimeInfo(greycat.libs_by_name[std.name_].mapped[64], version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats)
        ...
        class UserGroupPolicy(GreyCat.Object):
            ...
            def create(greycat: GreyCat, group_id: int, type: std.runtime.UserGroupPolicyType) -> std.runtime.UserGroupPolicy:
                return std.runtime.UserGroupPolicy(greycat.libs_by_name[std.name_].mapped[65], group_id, type)
        ...
        class SecurityPolicy(GreyCat.Object):
            ...
            def create(greycat: GreyCat, entities: std.core.Array, credentials: std.core.Map, roles: std.core.Map, fields: std.runtime.SecurityFields) -> std.runtime.SecurityPolicy:
                return std.runtime.SecurityPolicy(greycat.libs_by_name[std.name_].mapped[66], entities, credentials, roles, fields)
        ...
        class License(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, start: std.core.time, end: std.core.time, company: str, max_workers: int, max_memory: int, extra_1: int, extra_2: int, extra_3: int, extra_4: int) -> std.runtime.License:
                return std.runtime.License(greycat.libs_by_name[std.name_].mapped[67], name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4)
        ...
        class PeriodicTask(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, user_id: int, args: str, start: std.core.time, every: std.core.duration) -> std.runtime.PeriodicTask:
                return std.runtime.PeriodicTask(greycat.libs_by_name[std.name_].mapped[68], name, user_id, args, start, every)
        ...
        class UserGroupPolicyType(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.runtime.UserGroupPolicyType:
                return std.runtime.UserGroupPolicyType(greycat.libs_by_name[std.name_].mapped[69])
        ...
        class Task(GreyCat.Object):
            ...
            def create(greycat: GreyCat, user_id: int, task_id: int, mod: str, type: str, fun: str, creation: std.core.time, status: std.runtime.TaskStatus) -> std.runtime.Task:
                return std.runtime.Task(greycat.libs_by_name[std.name_].mapped[70], user_id, task_id, mod, type, fun, creation, status)
        ...
        class User(GreyCat.Object):
            ...
            def create(greycat: GreyCat, id: int, name: str, activated: bool, full_name: str, email: str, role: str, permissions_flags: int, groups: std.core.Array, groups_flags: int, external: bool) -> std.runtime.User:
                return std.runtime.User(greycat.libs_by_name[std.name_].mapped[71], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external)
        ...
        class StoreStat(GreyCat.Object):
            ...
            def create(greycat: GreyCat, capacity_bytes: int, allocated_bytes: int, allocated_ratio: float, remained_bytes: int, remained_ratio: float, used_bytes: int, used_ratio: float, available_bytes: int, available_ratio: float) -> std.runtime.StoreStat:
                return std.runtime.StoreStat(greycat.libs_by_name[std.name_].mapped[72], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio)
        ...
        class UserGroup(GreyCat.Object):
            ...
            def create(greycat: GreyCat, id: int, name: str, activated: bool) -> std.runtime.UserGroup:
                return std.runtime.UserGroup(greycat.libs_by_name[std.name_].mapped[73], id, name, activated)
        ...
        class Runtime(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.runtime.Runtime:
                return std.runtime.Runtime(greycat.libs_by_name[std.name_].mapped[74])
    ...
    class io:
        ...
        class CsvColumn(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumn:
                return std.io.CsvColumn(greycat.libs_by_name[std.name_].mapped[75], name, mandatory)
        ...
        class TextEncoder(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.io.TextEncoder:
                return std.io.TextEncoder(greycat.libs_by_name[std.name_].mapped[77])
        ...
        class CsvColumnBoolean(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnBoolean:
                return std.io.CsvColumnBoolean(greycat.libs_by_name[std.name_].mapped[78], name, mandatory)
        ...
        class CsvColumnIgnored(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnIgnored:
                return std.io.CsvColumnIgnored(greycat.libs_by_name[std.name_].mapped[81], name, mandatory)
        ...
        class SmtpMode(GreyCat.Enum):
            ...
            def plain(greycat: GreyCat) -> std.io.SmtpMode:
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[82]
                return t.enum_values[t.generated_offsets[0]]
            ...
            def create(greycat: GreyCat) -> std.io.SmtpMode:
                return std.io.SmtpMode(greycat.libs_by_name[std.name_].mapped[82])
        ...
        class CsvColumnTime(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, mandatory: bool, unit: std.core.DurationUnit) -> std.io.CsvColumnTime:
                return std.io.CsvColumnTime(greycat.libs_by_name[std.name_].mapped[83], name, mandatory, unit)
        ...
        class CsvColumnDate(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, mandatory: bool, format: str, tz: std.core.TimeZone, as_time: bool) -> std.io.CsvColumnDate:
                return std.io.CsvColumnDate(greycat.libs_by_name[std.name_].mapped[84], name, mandatory, format, tz, as_time)
        ...
        class CsvColumnFloat(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnFloat:
                return std.io.CsvColumnFloat(greycat.libs_by_name[std.name_].mapped[85], name, mandatory)
        ...
        class CsvColumnInteger(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, mandatory: bool) -> std.io.CsvColumnInteger:
                return std.io.CsvColumnInteger(greycat.libs_by_name[std.name_].mapped[86], name, mandatory)
        ...
        class SmtpAuth(GreyCat.Enum):
            ...
            def create(greycat: GreyCat) -> std.io.SmtpAuth:
                return std.io.SmtpAuth(greycat.libs_by_name[std.name_].mapped[87])
        ...
        class CsvColumnDuration(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, mandatory: bool, unit: std.core.DurationUnit) -> std.io.CsvColumnDuration:
                return std.io.CsvColumnDuration(greycat.libs_by_name[std.name_].mapped[89], name, mandatory, unit)
        ...
        class CsvColumnString(GreyCat.Object):
            ...
            def create(greycat: GreyCat, name: str, mandatory: bool, trim: bool, try_number: bool, try_json: bool, values: std.core.Array, encoder: std.io.TextEncoder) -> std.io.CsvColumnString:
                return std.io.CsvColumnString(greycat.libs_by_name[std.name_].mapped[90], name, mandatory, trim, try_number, try_json, values, encoder)
        ...
        class Url(GreyCat.Object):
            ...
            def create(greycat: GreyCat, protocol: str, host: str, port: int, path: str, params: std.core.Map, hash: str) -> std.io.Url:
                return std.io.Url(greycat.libs_by_name[std.name_].mapped[91], protocol, host, port, path, params, hash)
        ...
        class CsvFormat(GreyCat.Object):
            ...
            def create(greycat: GreyCat, header_lines: int, infer: bool, separator: c_char, string_delimiter: c_char, decimal_separator: c_char, thousands_separator: c_char, columns: std.core.Array) -> std.io.CsvFormat:
                return std.io.CsvFormat(greycat.libs_by_name[std.name_].mapped[92], header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns)
        ...
        class Http(GreyCat.Object):
            ...
            def create(greycat: GreyCat) -> std.io.Http:
                return std.io.Http(greycat.libs_by_name[std.name_].mapped[93])
    ...
    def init(self, greycat: GreyCat) -> None:
        ...
        self.mapped[40].resolve_generated_offsets("seed", "v")
        self.mapped[41].static_values = [0, 1, 2, 3]
        self.mapped[43].static_values = [0, 1, 2, 3]
        self.mapped[44].resolve_generated_offsets("min", "max", "whiskerLow", "whiskerHigh", "percentile1", "percentile5", "percentile25", "percentile50", "percentile75", "percentile95", "percentile99", "countOutliersLow", "countOutliersHigh", "percentageOutliersLow", "percentageOutliersHigh", "sum", "avg", "std", "size")
        self.mapped[48].resolve_generated_offsets("sum", "sum_sq", "count", "min", "max")
        self.mapped[50].resolve_generated_offsets("min", "max", "whiskerLow", "whiskerHigh", "percentile1", "percentile5", "percentile25", "percentile50", "percentile75", "percentile95", "percentile99", "countOutliersLow", "countOutliersHigh", "percentageOutliersLow", "percentageOutliersHigh", "sum", "avg", "std", "size")
        self.mapped[51].static_values = [0, 1, 2, 3, 4, 5, 6]
        self.mapped[53].resolve_generated_offsets("start", "total", "counter", "duration", "progress", "speed", "remaining")
        self.mapped[55].static_values = [2.7182818285, 1.4426950409, 0.4342944819, 0.6931471806, 2.302585093, 3.1415926536, 1.5707963268, 0.7853981634, 0.3183098862, 0.6366197724, 1.1283791671, 1.4142135624, 0.7071067812]
        ...
        self.mapped[60].resolve_generated_offsets("email", "name", "first_name", "last_name", "roles", "groups")
        self.mapped[61].resolve_generated_offsets("url", "clientId")
        self.mapped[63].resolve_generated_offset_with_values("empty", 0, "waiting", 1, "running", 2, "cancelled", 3, "error", 4, "ended", 5)
        self.mapped[64].resolve_generated_offsets("version", "arch", "timezone", "license", "io_threads", "bg_threads", "fg_threads", "mem_total", "mem_worker", "nb_ctx", "store_stats")
        self.mapped[65].resolve_generated_offsets("group_id", "type")
        self.mapped[66].resolve_generated_offsets("entities", "credentials", "roles", "fields")
        self.mapped[67].resolve_generated_offsets("name", "start", "end", "company", "max_workers", "max_memory", "extra_1", "extra_2", "extra_3", "extra_4")
        self.mapped[68].resolve_generated_offsets("name", "user_id", "args", "start", "every")
        self.mapped[69].resolve_generated_offset_with_values("read", 0, "write", 1, "execute", 2)
        self.mapped[70].resolve_generated_offsets("user_id", "task_id", "mod", "type", "fun", "creation", "status")
        self.mapped[71].resolve_generated_offsets("id", "name", "activated", "full_name", "email", "role", "permissions_flags", "groups", "groups_flags", "external")
        self.mapped[72].resolve_generated_offsets("capacity_bytes", "allocated_bytes", "allocated_ratio", "remained_bytes", "remained_ratio", "used_bytes", "used_ratio", "available_bytes", "available_ratio")
        self.mapped[73].resolve_generated_offsets("id", "name", "activated")
        self.mapped[75].resolve_generated_offsets("name", "mandatory")
        self.mapped[76].resolve_generated_offsets("name", "value")
        self.mapped[77].resolve_generated_offset_with_values("plain", None, "base64", None, "base64url", None, "hexadecimal", None)
        self.mapped[78].resolve_generated_offsets("name", "mandatory")
        ...
        self.mapped[81].resolve_generated_offsets("name", "mandatory")
        self.mapped[82].resolve_generated_offset_with_values("plain", 0, "ssl_tls", 1, "starttls", 2)
        self.mapped[83].resolve_generated_offsets("name", "mandatory", "unit")
        self.mapped[84].resolve_generated_offsets("name", "mandatory", "format", "tz", "as_time")
        self.mapped[85].resolve_generated_offsets("name", "mandatory")
        self.mapped[86].resolve_generated_offsets("name", "mandatory")
        self.mapped[87].resolve_generated_offset_with_values("none", 0, "plain", 1, "login", 2)
        self.mapped[88].resolve_generated_offsets("from", "subject", "body", "body_is_html", "to", "cc", "bcc")
        self.mapped[89].resolve_generated_offsets("name", "mandatory", "unit")
        self.mapped[90].resolve_generated_offsets("name", "mandatory", "trim", "try_number", "try_json", "values", "encoder")
        self.mapped[91].resolve_generated_offsets("protocol", "host", "port", "path", "params", "hash")
        self.mapped[92].resolve_generated_offsets("header_lines", "infer", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "columns")
