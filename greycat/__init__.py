...
class core:
    ...
    class VectorIndex(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, layers: core.nodeList, rng: util.Random, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[0]
            attributes: list = [layers, rng]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def layers(self) -> core.nodeList:
            return self._get(self.type_.generated_offsets[0])

        def set_layers(self, v: core.nodeList) -> None:
    ...
    class DurationUnit(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.DurationUnit:
            ...
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[3]
    ...
    class FloatPrecision(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.FloatPrecision:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[8]
    ...
    class TensorType(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.TensorType:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[22]
    ...
    class SamplingMode(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.SamplingMode:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[25]
    ...
    @final
    class Vector(GreyCat.Object):
        name_: Final[str] = "core::Vector"

        def __init__(self, buffer: core.Buffer, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[28]
            attributes: list = [buffer]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def buffer(self) -> core.Buffer:
            return self._get(self.type_.generated_offsets[0])

        def set_buffer(self, v: core.Buffer) -> None:
            self._set(self.type_.generated_offsets[0], v)
    ...
    class SortOrder(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.SortOrder:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[36]
    ...
    @final
    class VectorLeaf(Generic[__T], GreyCat.Object):
        name_: Final[str] = "core::VectorLeaf"

        def __init__(self, vector: core.Vector, list: core.Array, i: int, value: core.__T, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[46]
            attributes: list = [vector, list, i, value]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def vector(self) -> core.Vector:
            return self._get(self.type_.generated_offsets[0])

        def set_vector(self, v: core.Vector) -> None:
            self._set(self.type_.generated_offsets[0], v)

        def list(self) -> core.Array:
            return self._get(self.type_.generated_offsets[1])

        def set_list(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def i(self) -> int:
            return self._get(self.type_.generated_offsets[2])

        def set_i(self, v: int) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def value(self) -> core.__T:
            return self._get(self.type_.generated_offsets[3])

        def set_value(self, v: core.__T) -> None:
            self._set(self.type_.generated_offsets[3], v)
    ...
    class SmtpMode(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> io.SmtpMode:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[60]
    ...
    class SmtpAuth(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> io.SmtpAuth:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[74]
    ...
    class HttpMethod(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> io.HttpMethod:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[76]
    ...
    class SchemaFormat(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.SchemaFormat:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[94]
    ...
    class MergeStrategy(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.MergeStrategy:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[102]
    ...
    class OpenApiVersion(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.OpenApiVersion:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[112]
    ...
    class ResponseCode(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.ResponseCode:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[119]
    ...
    class LogLevel(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.LogLevel:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[120]
    ...
    class TaskStatus(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.TaskStatus:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[128]
    ...
    class DayOfWeek(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.DayOfWeek:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[129]
...
class _std(GreyCat.Library):
    ...
    def configure(self, loaders: dict[str, GreyCat.Loader], factories: dict[str, GreyCat.Factory]) -> None:
        ...
        factories[core.Vector.name_] = lambda _type, attributes: core.Vector(*attributes, _type=_type)
        ...
        factories[core.VectorLeaf.name_] = lambda _type, attributes: core.VectorLeaf(*attributes, _type=_type)
    ...
    def init(self, greycat: GreyCat) -> None:
        self.mapped: list[GreyCat.Type] = [
            ...
            greycat.types_by_name[core.Vector.name_],
            ...
            greycat.types_by_name[core.VectorLeaf.name_],
        ...
        self.mapped[64].resolve_generated_offsets("path", "size", "last_modification")
        self.mapped[65].resolve_generated_offsets("id", "column", "modulo")
        self.mapped[66].resolve_generated_offsets("path", "pos")
        self.mapped[67].resolve_generated_offsets("name", "example", "null_count", "bool_count", "int_count", "float_count", "string_count", "date_count", "date_format_count", "enumerable_count", "profile")
        self.mapped[68].resolve_generated_offsets("header_lines", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "trim", "format", "tz", "strict", "nearest_time")
        self.mapped[69].resolve_generated_offsets("header_lines", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "row_limit", "enumerable_limit", "date_check_limit", "date_formats")
        self.mapped[70].resolve_generated_offsets("from", "subject", "body", "body_is_html", "to", "cc", "bcc")
        self.mapped[71].resolve_generated_offsets("path", "append")
        self.mapped[72].resolve_generated_offsets("status_code", "headers", "content", "error_msg")
        ...
        self.mapped[75].resolve_generated_offsets("protocol", "host", "port", "path", "params", "hash")
        self.mapped[76].resolve_generated_offset_with_values("GET", None, "HEAD", None, "POST", None, "PUT", None, "DELETE", None, "CONNECT", None, "OPTIONS", None, "TRACE", None, "PATCH", None)
        self.mapped[77].resolve_generated_offsets("method", "url", "headers", "body")
        self.mapped[78].resolve_generated_offsets("id", "name", "activated")
        ...
        self.mapped[80].resolve_generated_offsets("days", "daily")
        self.mapped[81].resolve_generated_offsets("$ref", "type", "format", "nullable", "properties", "required", "items", "oneOf", "allOf", "minItems", "maxItems", "enum", "additionalProperties")
        self.mapped[82].resolve_generated_offsets("schema")
        self.mapped[83].resolve_generated_offsets("description", "required")
        self.mapped[84].resolve_generated_offsets("function", "periodicity", "options", "is_active", "next_execution", "execution_count")
        self.mapped[86].resolve_generated_offsets("every")
        self.mapped[87].resolve_generated_offsets("openapi", "info", "paths", "components")
        self.mapped[88].resolve_generated_offsets("id", "frames", "root")
        self.mapped[89].resolve_generated_offsets("group_id", "type")
        self.mapped[90].resolve_generated_offsets("dates", "timezone")
        self.mapped[91].resolve_generated_offsets("email", "name", "first_name", "last_name", "roles", "groups")
        self.mapped[92].resolve_generated_offsets("pid")
        self.mapped[94].resolve_generated_offset_with_values("int32", None, "int64", None, "float", None, "double", None, "byte", None, "binary", None, "date", None, "date-time", None, "password", None)
        self.mapped[95].resolve_generated_offsets("url", "clientId")
        self.mapped[97].resolve_generated_offset_with_values("read", None, "write", None, "execute", None)
        self.mapped[98].resolve_generated_offsets("id", "name", "activated", "full_name", "email", "role", "groups", "groups_flags", "external")
        self.mapped[99].resolve_generated_offsets("content", "required")
        self.mapped[100].resolve_generated_offsets("function", "arguments")
        self.mapped[101].resolve_generated_offsets("name", "value")
        self.mapped[102].resolve_generated_offset_with_values("strict", None, "first_wins", None, "last_wins", None)
        self.mapped[103].resolve_generated_offsets("read_bytes", "read_hits", "read_wasted", "write_bytes", "write_hits", "cache_bytes", "cache_hits")
        self.mapped[104].resolve_generated_offsets("title", "version")
        self.mapped[105].resolve_generated_offset_with_values("Jan", 0, "Feb", 1, "Mar", 2, "Apr", 3, "May", 4, "Jun", 5, "Jul", 6, "Aug", 7, "Sep", 8, "Oct", 9, "Nov", 10, "Dec", 11)
        self.mapped[107].resolve_generated_offset_with_values("community", None, "enterprise", None, "testing", None)
        self.mapped[108].resolve_generated_offsets("description", "post")
        self.mapped[109].resolve_generated_offsets("activated", "start", "max_duration")
        self.mapped[110].resolve_generated_offsets("name", "start", "end", "company", "max_memory", "extra_1", "extra_2", "type")
        self.mapped[111].resolve_generated_offsets("hour", "minute", "second", "timezone")
        self.mapped[112].resolve_generated_offset_with_values("3.0.4", None)
        self.mapped[113].resolve_generated_offsets("level", "time", "user_id", "id", "id2", "src", "data")
        self.mapped[114].resolve_generated_offsets("user_id", "task_id", "mod", "type", "fun", "creation", "start", "duration", "status", "progress")
        self.mapped[115].resolve_generated_offsets("description", "headers", "content")
        self.mapped[116].resolve_generated_offsets("id", "name", "activated")
        self.mapped[117].resolve_generated_offsets("entities", "credentials", "fields", "keys", "keys_last_refresh")
        self.mapped[118].resolve_generated_offsets("requestBody", "responses")
        self.mapped[119].resolve_generated_offset_with_values("200", None, "400", None, "404", None)
        self.mapped[120].resolve_generated_offset_with_values("error", None, "warn", None, "info", None, "perf", None, "trace", None)
        self.mapped[121].resolve_generated_offset_with_values("string", None, "number", None, "integer", None, "boolean", None, "object", None, "array", None)
        self.mapped[122].resolve_generated_offsets("offset", "pass")
        self.mapped[123].resolve_generated_offsets("name", "description")
        self.mapped[124].resolve_generated_offsets("name", "permissions")
        self.mapped[125].resolve_generated_offsets("days", "daily")
        self.mapped[126].resolve_generated_offsets("day", "month")
        self.mapped[128].resolve_generated_offset_with_values("empty", None, "waiting", None, "running", None, "await", None, "cancelled", None, "error", None, "ended", None, "ended_with_errors", None)
        self.mapped[129].resolve_generated_offset_with_values("Mon", 0, "Tue", 1, "Wed", 2, "Thu", 3, "Fri", 4, "Sat", 5, "Sun", 6)
        self.mapped[130].resolve_generated_offsets("schemas")
        self.mapped[131].resolve_generated_offsets("module", "type", "function", "src", "line", "column", "scope")
        self.mapped[132].resolve_generated_offsets("seed", "v")
        self.mapped[133].resolve_generated_offsets("min", "max", "bins", "open")
        self.mapped[134].resolve_generated_offsets("sum", "sumsq", "count", "min", "max")
        self.mapped[136].resolve_generated_offsets("values")
        self.mapped[137].resolve_generated_offsets("quantizers")
        self.mapped[138].resolve_generated_offsets("values", "capacity")
        self.mapped[139].resolve_generated_offsets("values", "span", "sum", "sumsq", "field")
        self.mapped[140].resolve_generated_offsets("min", "max", "step_starts", "open")
        self.mapped[141].resolve_generated_offsets("quantizer", "bins", "nb_rejected", "nb_accepted", "min", "max", "sum", "sumsq")
        self.mapped[144].resolve_generated_offsets("min", "max", "center")
        self.mapped[145].resolve_generated_offsets("sum", "sumsq", "count")
        self.mapped[146].resolve_generated_offsets("start", "total", "counter", "duration", "progress", "speed", "remaining")
        self.mapped[147].resolve_generated_offsets("bin", "count", "ratio", "cumulative_count", "cumulative_ratio")
        self.mapped[148].resolve_generated_offsets("min", "max", "whisker_low", "whisker_high", "percentile1", "percentile5", "percentile10", "percentile20", "percentile25", "percentile50", "percentile75", "percentile80", "percentile90", "percentile95", "percentile99", "sum", "avg", "std", "size")
        self.mapped[149].resolve_generated_offsets("values", "span", "sum", "sumsq", "field")
        self.mapped[150].resolve_generated_offsets("quantizer", "precision", "bins", "value_min", "nb_rejected")
