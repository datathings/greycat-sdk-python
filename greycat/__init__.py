    ...
    class TensorType(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.TensorType:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[26]
    ...
    class HttpMethod(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> io.HttpMethod:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[62]
    ...
    class OpenApiVersion(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.OpenApiVersion:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[96]
    ...
    class SchemaFormat(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.SchemaFormat:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[130]
    ...
    class MergeStrategy(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.MergeStrategy:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[131]
...
class _std(GreyCat.Library):
    ...
    def init(self, greycat: GreyCat) -> None:
        ...
        self.mapped[0].resolve_generated_offsets("center", "radius")
        self.mapped[1].resolve_generated_offsets("layers", "rng")
        self.mapped[4].resolve_generated_offsets("sw", "ne")
        ...
        self.mapped[7].resolve_generated_offsets("key", "value", "next")
        ...
        self.mapped[28].resolve_generated_offset_with_values("none", 0, "interrupted", 1, "await", 2, "timeout", 6, "forbidden", 7, "runtime_error", 8)
        self.mapped[29].resolve_generated_offsets("buffer")
        self.mapped[31].resolve_generated_offset_with_values("year", 0, "month", 1, "day", 2, "hour", 3, "minute", 4, "second", 5, "microsecond", 6)
        self.mapped[34].resolve_generated_offset_with_values("euclidean", None, "cosine", None)
        self.mapped[37].resolve_generated_offsets("x", "y")
        self.mapped[38].resolve_generated_offset_with_values("asc", None, "desc", None)
        ...
        self.mapped[49].resolve_generated_offsets("path", "pos")
        self.mapped[50].resolve_generated_offsets("path", "pos")
        self.mapped[51].resolve_generated_offsets("from", "subject", "body", "body_is_html", "to", "cc", "bcc")
        self.mapped[52].resolve_generated_offsets("status_code", "headers", "content", "error_msg")
        self.mapped[53].resolve_generated_offsets("path", "append")
        self.mapped[54].resolve_generated_offsets("name", "example", "null_count", "bool_count", "int_count", "float_count", "string_count", "date_count", "date_format_count", "enumerable_count", "profile")
        self.mapped[55].resolve_generated_offset_with_values("none", 0, "plain", 1, "login", 2)
        self.mapped[56].resolve_generated_offsets("id", "column", "modulo")
        self.mapped[57].resolve_generated_offsets("path", "pos")
        self.mapped[59].resolve_generated_offsets("method", "url", "headers", "body")
        self.mapped[60].resolve_generated_offsets("path")
        self.mapped[61].resolve_generated_offsets("header_lines", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "columns", "line_count", "fail_count", "file_count")
        self.mapped[62].resolve_generated_offset_with_values("GET", None, "HEAD", None, "POST", None, "PUT", None, "DELETE", None, "CONNECT", None, "OPTIONS", None, "TRACE", None, "PATCH", None)
        self.mapped[63].resolve_generated_offsets("path", "pos")
        self.mapped[64].resolve_generated_offsets("path", "pos", "format", "sharding")
        self.mapped[65].resolve_generated_offsets("header_lines", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "trim", "format", "tz", "strict", "nearest_time")
        self.mapped[66].resolve_generated_offsets("path", "append")
        self.mapped[67].resolve_generated_offsets("path", "append")
        self.mapped[69].resolve_generated_offsets("path", "append")
        self.mapped[70].resolve_generated_offsets("path", "append", "format")
        self.mapped[71].resolve_generated_offsets("header_lines", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "row_limit", "enumerable_limit", "date_check_limit", "date_formats")
        self.mapped[73].resolve_generated_offsets("path", "size", "last_modification")
        ...
        self.mapped[76].resolve_generated_offsets("host", "port", "mode", "authenticate", "user", "pass")
        self.mapped[77].resolve_generated_offsets("protocol", "host", "port", "path", "params", "hash")
        self.mapped[78].resolve_generated_offsets("name", "value")
        self.mapped[79].resolve_generated_offsets("id", "name", "activated")
        self.mapped[80].resolve_generated_offset_with_values("Mon", 0, "Tue", 1, "Wed", 2, "Thu", 3, "Fri", 4, "Sat", 5, "Sun", 6)
        self.mapped[81].resolve_generated_offset_with_values("200", None, "400", None, "404", None)
        self.mapped[82].resolve_generated_offsets("content", "required")
        self.mapped[83].resolve_generated_offset_with_values("string", None, "number", None, "integer", None, "boolean", None, "object", None, "array", None)
        self.mapped[84].resolve_generated_offsets("day", "month")
        self.mapped[85].resolve_generated_offset_with_values("community", None, "enterprise", None, "testing", None)
        self.mapped[86].resolve_generated_offsets("code", "stdout", "stderr")
        self.mapped[87].resolve_generated_offsets("description", "required")
        self.mapped[89].resolve_generated_offsets("every")
        self.mapped[90].resolve_generated_offsets("description", "headers", "content")
        self.mapped[91].resolve_generated_offsets("group_id", "type")
        self.mapped[92].resolve_generated_offsets("read_bytes", "read_hits", "read_wasted", "write_bytes", "write_hits", "cache_bytes", "cache_hits")
        self.mapped[94].resolve_generated_offsets("id", "name", "activated")
        self.mapped[95].resolve_generated_offsets("email", "name", "first_name", "last_name", "roles", "groups")
        self.mapped[96].resolve_generated_offset_with_values("3.0.4", None)
        self.mapped[97].resolve_generated_offsets("description", "post")
        self.mapped[98].resolve_generated_offsets("pid")
        self.mapped[99].resolve_generated_offsets("function", "arguments")
        self.mapped[100].resolve_generated_offset_with_values("error", None, "warn", None, "info", None, "perf", None, "trace", None)
        self.mapped[101].resolve_generated_offset_with_values("read", None, "write", None, "execute", None)
        self.mapped[102].resolve_generated_offsets("module", "type", "function", "src", "line", "column", "scope")
        self.mapped[103].resolve_generated_offsets("schema")
        self.mapped[105].resolve_generated_offsets("id", "frames", "root")
        self.mapped[106].resolve_generated_offsets("entities", "credentials", "fields", "keys", "keys_last_refresh")
        self.mapped[107].resolve_generated_offset_with_values("Jan", 0, "Feb", 1, "Mar", 2, "Apr", 3, "May", 4, "Jun", 5, "Jul", 6, "Aug", 7, "Sep", 8, "Oct", 9, "Nov", 10, "Dec", 11)
        ...
        self.mapped[109].resolve_generated_offsets("offset", "pass")
        self.mapped[110].resolve_generated_offsets("level", "time", "user_id", "id", "id2", "src", "data")
        self.mapped[111].resolve_generated_offsets("version", "program_version", "arch", "timezone", "license", "io_threads", "bg_threads", "fg_threads", "mem_total", "mem_worker", "disk_data_bytes")
        self.mapped[112].resolve_generated_offsets("schemas")
        self.mapped[113].resolve_generated_offsets("days", "daily")
        self.mapped[114].resolve_generated_offsets("requestBody", "responses")
        self.mapped[115].resolve_generated_offsets("name", "permissions")
        self.mapped[116].resolve_generated_offsets("title", "version")
        self.mapped[117].resolve_generated_offsets("name", "start", "end", "company", "max_memory", "extra_1", "extra_2", "type")
        self.mapped[118].resolve_generated_offsets("url", "clientId")
        self.mapped[119].resolve_generated_offsets("name", "description")
        self.mapped[121].resolve_generated_offsets("$ref", "type", "format", "nullable", "properties", "required", "items", "oneOf", "allOf", "minItems", "maxItems", "enum", "additionalProperties")
        self.mapped[122].resolve_generated_offsets("activated", "start", "max_duration")
        self.mapped[123].resolve_generated_offsets("hour", "minute", "second", "timezone")
        self.mapped[124].resolve_generated_offsets("user_id", "task_id", "mod", "type", "fun", "creation", "start", "duration", "status", "progress")
        self.mapped[126].resolve_generated_offsets("days", "daily")
        self.mapped[127].resolve_generated_offsets("function", "periodicity", "options", "is_active", "next_execution", "execution_count")
        self.mapped[128].resolve_generated_offsets("id", "name", "activated", "full_name", "email", "role", "groups", "groups_flags", "external")
        self.mapped[129].resolve_generated_offsets("openapi", "info", "paths", "components")
        self.mapped[130].resolve_generated_offset_with_values("int32", None, "int64", None, "float", None, "double", None, "byte", None, "binary", None, "date", None, "date-time", None, "password", None)
        self.mapped[131].resolve_generated_offset_with_values("strict", None, "first_wins", None, "last_wins", None)
        self.mapped[132].resolve_generated_offsets("dates", "timezone")
        self.mapped[133].resolve_generated_offsets("start", "total", "counter", "duration", "progress", "speed", "remaining")
        self.mapped[134].resolve_generated_offsets("sum", "sumsq", "count", "min", "max")
        self.mapped[135].resolve_generated_offsets("seed", "v")
        self.mapped[136].resolve_generated_offsets("values", "span", "sum", "sumsq", "field")
        self.mapped[137].resolve_generated_offsets("min", "max", "bins", "open")
        self.mapped[138].resolve_generated_offsets("values")
        self.mapped[139].resolve_generated_offsets("quantizer", "bins", "nb_rejected", "nb_accepted", "min", "max", "sum", "sumsq")
        self.mapped[140].resolve_generated_offsets("values", "capacity")
        self.mapped[141].resolve_generated_offsets("min", "max", "center")
        self.mapped[143].resolve_generated_offsets("min", "max", "step_starts", "open")
        self.mapped[144].resolve_generated_offsets("sum", "sumsq", "count")
        self.mapped[146].resolve_generated_offsets("bin", "count", "ratio", "cumulative_count", "cumulative_ratio")
        self.mapped[147].resolve_generated_offsets("quantizer", "precision", "bins", "value_min", "nb_rejected")
        self.mapped[149].resolve_generated_offsets("min", "max", "bins", "open")
        self.mapped[150].resolve_generated_offsets("values", "span", "sum", "sumsq", "field")
        self.mapped[151].resolve_generated_offsets("quantizers")
        self.mapped[153].resolve_generated_offsets("min", "max", "whisker_low", "whisker_high", "percentile1", "percentile5", "percentile10", "percentile20", "percentile25", "percentile50", "percentile75", "percentile80", "percentile90", "percentile95", "percentile99", "sum", "avg", "std", "size")
