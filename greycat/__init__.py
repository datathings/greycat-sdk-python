...
class core:
    ...
    @final
    class Chars(GreyCat.Object):
        name_: Final[str] = "core::Chars"

        def __init__(self, codepoints: core.Array, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[4]
            attributes: list = [codepoints]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def codepoints(self) -> core.Array:
            return self._get(self.type_.generated_offsets[0])

        def set_codepoints(self, v: core.Array) -> None:
    ...
    class ErrorCode(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.ErrorCode:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[5]
    ...
    class nodeTimeCursor(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, n: core.nodeTime, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
    ...
    class VectorVertex(GreyCat.Object):
        ...
        def __init__(self, vector: core.node, level_sizes: core.Array, neighbour_nodes: core.Array, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[19]
            attributes: list = [vector, level_sizes, neighbour_nodes]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def vector(self) -> core.node:
            return self._get(self.type_.generated_offsets[0])

        def set_vector(self, v: core.node) -> None:
            self._set(self.type_.generated_offsets[0], v)

        def level_sizes(self) -> core.Array:
            return self._get(self.type_.generated_offsets[1])

        def set_level_sizes(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def neighbour_nodes(self) -> core.Array:
            return self._get(self.type_.generated_offsets[2])

        def set_neighbour_nodes(self, v: core.Array) -> None:
    ...
    class SamplingMode(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.SamplingMode:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[23]
    ...
    class FloatPrecision(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.FloatPrecision:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[27]
    ...
    class CalendarUnit(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.CalendarUnit:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[34]
    ...
    class TimeZone(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> core.TimeZone:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[40]
    ...
    class VectorIndex(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, values: core.nodeIndex, count: int, max_level: int, entry_node_ref: core.node, rng: util.Random, distance: core.TensorDistance, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[41]
            attributes: list = [values, count, max_level, entry_node_ref, rng, distance]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def values(self) -> core.nodeIndex:
            return self._get(self.type_.generated_offsets[0])

        def set_values(self, v: core.nodeIndex) -> None:
            self._set(self.type_.generated_offsets[0], v)
        ...
        def entry_node_ref(self) -> core.node:
            return self._get(self.type_.generated_offsets[3])

        def set_entry_node_ref(self, v: core.node) -> None:
            self._set(self.type_.generated_offsets[3], v)
...
class io:
    ...
    class Csv(GreyCat.Object):
        ...
        @staticmethod
        def analyze(paths: core.Array, config: io.CsvAnalysisConfig, __greycat: Optional[GreyCat] = None) -> io.CsvStatistics:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("io::Csv::analyze", [paths, config, ])
    ...
    @final
    class S3Bucket(GreyCat.Object):
        name_: Final[str] = "io::S3Bucket"

        def __init__(self, name: str, creation_date: core.time, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[52]
            attributes: list = [name, creation_date]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def creation_date(self) -> core.time:
            return self._get(self.type_.generated_offsets[1])

        def set_creation_date(self, v: core.time) -> None:
            self._set(self.type_.generated_offsets[1], v)
    ...
    @final
    class S3BasicCredentials(GreyCat.Object):
        name_: Final[str] = "io::S3BasicCredentials"

        def __init__(self, access_key: str, secret_key: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[56]
            attributes: list = [access_key, secret_key]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def access_key(self) -> str:
            return self._get(self.type_.generated_offsets[0])

        def set_access_key(self, v: str) -> None:
            self._set(self.type_.generated_offsets[0], v)

        def secret_key(self) -> str:
            return self._get(self.type_.generated_offsets[1])

        def set_secret_key(self, v: str) -> None:
            self._set(self.type_.generated_offsets[1], v)
    ...
    class SmtpAuth(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> io.SmtpAuth:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[58]
            return t.enum_values[t.generated_offsets[io.SmtpAuth.__indices_by_values[key]]]

    @final
    class S3(GreyCat.Object):
        name_: Final[str] = "io::S3"

        def __init__(self, host: str, region: str, credentials: io.S3BasicCredentials, force_path_style: bool, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[59]
            attributes: list = [host, region, credentials, force_path_style]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def set_region(self, v: str) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def credentials(self) -> io.S3BasicCredentials:
            return self._get(self.type_.generated_offsets[2])

        def set_credentials(self, v: io.S3BasicCredentials) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def force_path_style(self) -> bool:
            return self._get(self.type_.generated_offsets[3])

        def set_force_path_style(self, v: bool) -> None:
            self._set(self.type_.generated_offsets[3], v)
    ...
    class SmtpMode(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> io.SmtpMode:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[63]
    ...
    @final
    class BinReader(GreyCat.Object):
        name_: Final[str] = "io::BinReader"
    ...
    class Url(GreyCat.Object):
        ...
        def __init__(self, protocol: str, host: str, port: int, path: str, user: str, password: str, params: core.Map, hash: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[69]
            attributes: list = [protocol, host, port, path, user, password, params, hash]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    @final
    class S3Object(GreyCat.Object):
        name_: Final[str] = "io::S3Object"

        def __init__(self, key: str, last_modified: core.time, size: int, etag: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[71]
            attributes: list = [key, last_modified, size, etag]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def last_modified(self) -> core.time:
            return self._get(self.type_.generated_offsets[1])

        def set_last_modified(self, v: core.time) -> None:
            self._set(self.type_.generated_offsets[1], v)
    ...
    class HttpRequest(GreyCat.Object):
        ...
        def __init__(self, method: io.HttpMethod, url: str, headers: core.Map, body: str, timeout: core.duration, max_response_size: int, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[73]
            attributes: list = [method, url, headers, body, timeout, max_response_size]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def timeout(self) -> core.duration:
            return self._get(self.type_.generated_offsets[4])

        def set_timeout(self, v: core.duration) -> None:
            self._set(self.type_.generated_offsets[4], v)

        def max_response_size(self) -> int:
            return self._get(self.type_.generated_offsets[5])

        def set_max_response_size(self, v: int) -> None:
            self._set(self.type_.generated_offsets[5], v)
...
class runtime:
    ...
    @final
    class McpTaskSupport(GreyCat.Enum):
        name_: Final[str] = "runtime::McpTaskSupport"
        __indices_by_values: dict[str, int] = {
            "forbidden": 0,
            "required": 1,
            "optional": 2,
        ...
        def __class_getitem__(cls, key) -> runtime.McpTaskSupport:
            greycat: GreyCat
            if isinstance(key, tuple):
                key, greycat = key
            else:
            ...
            return t.enum_values[t.generated_offsets[runtime.McpTaskSupport.__indices_by_values[key]]]

    @final
    class McpTasksResultParams(GreyCat.Object):
        name_: Final[str] = "runtime::McpTasksResultParams"

        def __init__(self, _meta: core.Map, taskId: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[80]
            attributes: list = [_meta, taskId]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def _meta(self) -> core.Map:
            return self._get(self.type_.generated_offsets[0])

        def set__meta(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[0], v)

        def taskId(self) -> str:
            return self._get(self.type_.generated_offsets[1])

        def set_taskId(self, v: str) -> None:
            self._set(self.type_.generated_offsets[1], v)

    @final
    class McpTaskStatus(GreyCat.Enum):
        name_: Final[str] = "runtime::McpTaskStatus"
        __indices_by_values: dict[str, int] = {
            "working": 0,
            "input_required": 1,
            "completed": 2,
        ...
        def __class_getitem__(cls, key) -> runtime.McpTaskStatus:
            greycat: GreyCat
            if isinstance(key, tuple):
                key, greycat = key
            else:
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[81]
            return t.enum_values[t.generated_offsets[runtime.McpTaskStatus.__indices_by_values[key]]]

    @final
    class McpInitializeParams(GreyCat.Object):
        name_: Final[str] = "runtime::McpInitializeParams"

        def __init__(self, _meta: core.Map, protocolVersion: str, capabilities: runtime.McpClientCapabilities, clientInfo: runtime.McpImplementation, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[82]
            attributes: list = [_meta, protocolVersion, capabilities, clientInfo]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def set_protocolVersion(self, v: str) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def capabilities(self) -> runtime.McpClientCapabilities:
            return self._get(self.type_.generated_offsets[2])

        def set_capabilities(self, v: runtime.McpClientCapabilities) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def clientInfo(self) -> runtime.McpImplementation:
            return self._get(self.type_.generated_offsets[3])

        def set_clientInfo(self, v: runtime.McpImplementation) -> None:
            self._set(self.type_.generated_offsets[3], v)

    @final
    class McpClientRoots(GreyCat.Object):
        name_: Final[str] = "runtime::McpClientRoots"

        def __init__(self, listChanged: bool, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[83]
            attributes: list = [listChanged]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def listChanged(self) -> bool:
            return self._get(self.type_.generated_offsets[0])

        def set_listChanged(self, v: bool) -> None:
            self._set(self.type_.generated_offsets[0], v)

    @final
    class McpImplementation(GreyCat.Object):
        name_: Final[str] = "runtime::McpImplementation"

        def __init__(self, name: str, title: str, version: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[84]
            attributes: list = [name, title, version]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    @final
    class McpClientCapabilities(GreyCat.Object):
        name_: Final[str] = "runtime::McpClientCapabilities"

        def __init__(self, experimental: core.Map, roots: runtime.McpClientRoots, sampling: core.Map, elicitation: core.Map, tasks: runtime.McpClientTasksCapabilities, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[87]
            attributes: list = [experimental, roots, sampling, elicitation, tasks]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def experimental(self) -> core.Map:
            return self._get(self.type_.generated_offsets[0])

        def set_experimental(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[0], v)

        def roots(self) -> runtime.McpClientRoots:
            return self._get(self.type_.generated_offsets[1])

        def set_roots(self, v: runtime.McpClientRoots) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def sampling(self) -> core.Map:
            return self._get(self.type_.generated_offsets[2])

        def set_sampling(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def elicitation(self) -> core.Map:
            return self._get(self.type_.generated_offsets[3])

        def set_elicitation(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[3], v)

        def tasks(self) -> runtime.McpClientTasksCapabilities:
            return self._get(self.type_.generated_offsets[4])

        def set_tasks(self, v: runtime.McpClientTasksCapabilities) -> None:
            self._set(self.type_.generated_offsets[4], v)
    ...
    class System(GreyCat.Object):
        ...
        @staticmethod
        def get_all_envs(__greycat: Optional[GreyCat] = None) -> core.Array:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::System::get_all_envs")

    @final
    class IdentityGrantType(GreyCat.Enum):
        name_: Final[str] = "runtime::IdentityGrantType"
        __indices_by_values: dict[str, int] = {
            "read": 0,
            "write": 1,
            "read_write": 2,
        ...
        def __class_getitem__(cls, key) -> runtime.IdentityGrantType:
            greycat: GreyCat
            if isinstance(key, tuple):
                key, greycat = key
            else:
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[89]
            return t.enum_values[t.generated_offsets[runtime.IdentityGrantType.__indices_by_values[key]]]
    ...
    class Runtime(GreyCat.Object):
        ...
        @staticmethod
        def backup_full(__greycat: Optional[GreyCat] = None) -> None:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Runtime::backup_full")
        ...
        @staticmethod
        def usage(__greycat: Optional[GreyCat] = None) -> runtime.RuntimeUsage:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Runtime::usage")
    ...
    @final
    class McpResourceContent(GreyCat.Object):
        name_: Final[str] = "runtime::McpResourceContent"

        def __init__(self, type: runtime.McpContentType, _meta: core.Map, annotations: runtime.McpAnnotations, uri: str, description: str, mimeType: str, size: int, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[91]
            attributes: list = [type, _meta, annotations, uri, description, mimeType, size]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def type(self) -> runtime.McpContentType:
            return self._get(self.type_.generated_offsets[0])

        def set_type(self, v: runtime.McpContentType) -> None:
            self._set(self.type_.generated_offsets[0], v)
        ...
        def annotations(self) -> runtime.McpAnnotations:
            return self._get(self.type_.generated_offsets[2])

        def set_annotations(self, v: runtime.McpAnnotations) -> None:
            self._set(self.type_.generated_offsets[2], v)
        ...
        def set_mimeType(self, v: str) -> None:
            self._set(self.type_.generated_offsets[5], v)
    ...
    @final
    class McpContentBlock(GreyCat.Object):
        name_: Final[str] = "runtime::McpContentBlock"

        def __init__(self, type: runtime.McpContentType, _meta: core.Map, annotations: runtime.McpAnnotations, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[92]
            attributes: list = [type, _meta, annotations]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    @final
    class McpServerToolsCapabilities(GreyCat.Object):
        name_: Final[str] = "runtime::McpServerToolsCapabilities"
    ...
    @final
    class McpServerResourcesCapabilities(GreyCat.Object):
        name_: Final[str] = "runtime::McpServerResourcesCapabilities"

        def __init__(self, subscribe: bool, listChanged: bool, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[95]
            attributes: list = [subscribe, listChanged]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def subscribe(self) -> bool:
            return self._get(self.type_.generated_offsets[0])

        def set_subscribe(self, v: bool) -> None:
            self._set(self.type_.generated_offsets[0], v)
    ...
    class MergeStrategy(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.MergeStrategy:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[99]
    ...
    class DayOfWeek(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.DayOfWeek:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[100]
            return t.enum_values[t.generated_offsets[runtime.DayOfWeek.__indices_by_values[key]]]

    @final
    class McpContentType(GreyCat.Enum):
        name_: Final[str] = "runtime::McpContentType"
        __indices_by_values: dict[str, int] = {
            "text": 0,
            "image": 1,
            "audio": 2,
        ...
        def __class_getitem__(cls, key) -> runtime.McpContentType:
            greycat: GreyCat
            if isinstance(key, tuple):
                key, greycat = key
            else:
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[101]
            return t.enum_values[t.generated_offsets[runtime.McpContentType.__indices_by_values[key]]]
    ...
    @final
    class McpTasksCreateResult(GreyCat.Object):
        name_: Final[str] = "runtime::McpTasksCreateResult"

        def __init__(self, _meta: core.Map, task: runtime.McpTask, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[104]
            attributes: list = [_meta, task]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def task(self) -> runtime.McpTask:
            return self._get(self.type_.generated_offsets[1])

        def set_task(self, v: runtime.McpTask) -> None:
            self._set(self.type_.generated_offsets[1], v)

    @final
    class McpClientTasksCapabilities(GreyCat.Object):
        name_: Final[str] = "runtime::McpClientTasksCapabilities"

        def __init__(self, list: core.Map, cancel: core.Map, requests: core.Map, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[105]
            attributes: list = [list, cancel, requests]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def list(self) -> core.Map:
            return self._get(self.type_.generated_offsets[0])

        def set_list(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[0], v)

        def cancel(self) -> core.Map:
            return self._get(self.type_.generated_offsets[1])

        def set_cancel(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def requests(self) -> core.Map:
            return self._get(self.type_.generated_offsets[2])

        def set_requests(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[2], v)
    ...
    class OperationObject(GreyCat.Object):
        ...
        def __init__(self, tags: core.Array, description: str, requestBody: runtime.RequestBodyObject, responses: core.Map, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[106]
            attributes: list = [tags, description, requestBody, responses]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def tags(self) -> core.Array:
            return self._get(self.type_.generated_offsets[0])

        def set_tags(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[0], v)
    ...
    @final
    class McpTasksCancelParams(GreyCat.Object):
        name_: Final[str] = "runtime::McpTasksCancelParams"
    ...
    @final
    class McpTasksListParams(GreyCat.Object):
        name_: Final[str] = "runtime::McpTasksListParams"

        def __init__(self, _meta: core.Map, cursor: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[109]
            attributes: list = [_meta, cursor]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    @final
    class IdentityGrant(GreyCat.Object):
        name_: Final[str] = "runtime::IdentityGrant"

        def __init__(self, name: str, grant: runtime.IdentityGrantType, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[110]
            attributes: list = [name, grant]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def grant(self) -> runtime.IdentityGrantType:
            return self._get(self.type_.generated_offsets[1])

        def set_grant(self, v: runtime.IdentityGrantType) -> None:
            self._set(self.type_.generated_offsets[1], v)
    ...
    class LicenseType(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.LicenseType:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[111]
            return t.enum_values[t.generated_offsets[runtime.LicenseType.__indices_by_values[key]]]

    @final
    class McpToolsListResult(GreyCat.Object):
        name_: Final[str] = "runtime::McpToolsListResult"

        def __init__(self, _meta: core.Map, tools: core.Array, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[112]
            attributes: list = [_meta, tools]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def tools(self) -> core.Array:
            return self._get(self.type_.generated_offsets[1])

        def set_tools(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[1], v)
    ...
    @final
    class RuntimeUsage(GreyCat.Object):
        name_: Final[str] = "runtime::RuntimeUsage"

        def __init__(self, os_total_bytes: int, os_used_bytes: int, proc_virt_bytes: int, proc_res_bytes: int, proc_shr_bytes: int, global_memory: int, memory_drift: int, workers: core.Array, zones: core.Array, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[114]
            attributes: list = [os_total_bytes, os_used_bytes, proc_virt_bytes, proc_res_bytes, proc_shr_bytes, global_memory, memory_drift, workers, zones]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def os_total_bytes(self) -> int:
            return self._get(self.type_.generated_offsets[0])

        def set_os_total_bytes(self, v: int) -> None:
            self._set(self.type_.generated_offsets[0], v)

        def os_used_bytes(self) -> int:
            return self._get(self.type_.generated_offsets[1])

        def set_os_used_bytes(self, v: int) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def proc_virt_bytes(self) -> int:
            return self._get(self.type_.generated_offsets[2])

        def set_proc_virt_bytes(self, v: int) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def proc_res_bytes(self) -> int:
            return self._get(self.type_.generated_offsets[3])

        def set_proc_res_bytes(self, v: int) -> None:
            self._set(self.type_.generated_offsets[3], v)

        def proc_shr_bytes(self) -> int:
            return self._get(self.type_.generated_offsets[4])

        def set_proc_shr_bytes(self, v: int) -> None:
            self._set(self.type_.generated_offsets[4], v)

        def global_memory(self) -> int:
            return self._get(self.type_.generated_offsets[5])

        def set_global_memory(self, v: int) -> None:
            self._set(self.type_.generated_offsets[5], v)

        def memory_drift(self) -> int:
            return self._get(self.type_.generated_offsets[6])

        def set_memory_drift(self, v: int) -> None:
            self._set(self.type_.generated_offsets[6], v)

        def workers(self) -> core.Array:
            return self._get(self.type_.generated_offsets[7])

        def set_workers(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[7], v)

        def zones(self) -> core.Array:
            return self._get(self.type_.generated_offsets[8])

        def set_zones(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[8], v)

    @final
    class McpPriority(GreyCat.Enum):
        name_: Final[str] = "runtime::McpPriority"
        __indices_by_values: dict[str, int] = {
            "MostImportant": 0,
            "LeastImportant": 1,
        }
        ...
        def __class_getitem__(cls, key) -> runtime.McpPriority:
            greycat: GreyCat
            if isinstance(key, tuple):
                key, greycat = key
            else:
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[115]
            return t.enum_values[t.generated_offsets[runtime.McpPriority.__indices_by_values[key]]]

    @final
    class WorkerUsage(GreyCat.Object):
        name_: Final[str] = "runtime::WorkerUsage"

        def __init__(self, memory: int, cache: int, writes: int, reads: int, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[116]
            attributes: list = [memory, cache, writes, reads]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def memory(self) -> int:
            return self._get(self.type_.generated_offsets[0])

        def set_memory(self, v: int) -> None:
            self._set(self.type_.generated_offsets[0], v)

        def cache(self) -> int:
            return self._get(self.type_.generated_offsets[1])

        def set_cache(self, v: int) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def writes(self) -> int:
            return self._get(self.type_.generated_offsets[2])

        def set_writes(self, v: int) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def reads(self) -> int:
            return self._get(self.type_.generated_offsets[3])

        def set_reads(self, v: int) -> None:
            self._set(self.type_.generated_offsets[3], v)
    ...
    class SchemaObject(GreyCat.Object):
        ...
        def __init__(self, __ref: str, __defs: core.Map, type: Any, format: runtime.SchemaFormat, description: str, nullable: bool, properties: core.Map, pattern: str, required: core.Array, items: runtime.SchemaObject, oneOf: core.Array, allOf: core.Array, anyOf: core.Array, minItems: int, maxItems: int, enum: core.Array, additionalProperties: runtime.SchemaObject, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[118]
            attributes: list = [__ref, __defs, type, format, description, nullable, properties, pattern, required, items, oneOf, allOf, anyOf, minItems, maxItems, enum, additionalProperties]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def __defs(self) -> core.Map:
            return self._get(self.type_.generated_offsets[1])

        def set___defs(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[1], v)
        ...
        def set_pattern(self, v: str) -> None:
            self._set(self.type_.generated_offsets[7], v)
        ...
        def anyOf(self) -> core.Array:
            return self._get(self.type_.generated_offsets[12])

        def set_anyOf(self, v: core.Array) -> None:
    ...
    @final
    class Identity(GreyCat.Object):
        name_: Final[str] = "runtime::Identity"

        def __init__(self, id: int, name: str, role: str, grants: core.Array, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[119]
            attributes: list = [id, name, role, grants]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def grants(self) -> core.Array:
            return self._get(self.type_.generated_offsets[3])

        def set_grants(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[3], v)

        @staticmethod
        def set_role(name: str, role: str, __greycat: Optional[GreyCat] = None) -> None:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::set_role", [name, role, ])

        @staticmethod
        def set_grants(name: str, grants: core.Array, __greycat: Optional[GreyCat] = None) -> None:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::set_grants", [name, grants, ])

        @staticmethod
        def set_password(name: str, pass_: str, __greycat: Optional[GreyCat] = None) -> bool:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::set_password", [name, pass_, ])

        @staticmethod
        def permissions(__greycat: Optional[GreyCat] = None) -> core.Array:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::permissions")

        @staticmethod
        def logout(__greycat: Optional[GreyCat] = None) -> None:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::logout")

        @staticmethod
        def login(login: str, password: str, __greycat: Optional[GreyCat] = None) -> str:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::login", [login, password, ])

        @staticmethod
        def token(id: int, ttl: core.duration, __greycat: Optional[GreyCat] = None) -> str:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::token", [id, ttl, ])

        @staticmethod
        def create(name: str, role: str, __greycat: Optional[GreyCat] = None) -> runtime.Identity:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::create", [name, role, ])

        @staticmethod
        def all(__greycat: Optional[GreyCat] = None) -> core.Array:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::all")

        @staticmethod
        def get_by_name(name: str, __greycat: Optional[GreyCat] = None) -> runtime.Identity:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::get_by_name", [name, ])

        @staticmethod
        def get_by_id(id: int, __greycat: Optional[GreyCat] = None) -> runtime.Identity:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::get_by_id", [id, ])

        @staticmethod
        def current(__greycat: Optional[GreyCat] = None) -> runtime.Identity:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::current")

        @staticmethod
        def current_id(__greycat: Optional[GreyCat] = None) -> int:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Identity::current_id")
    ...
    @final
    class McpTaskCreateParams(GreyCat.Object):
        name_: Final[str] = "runtime::McpTaskCreateParams"

        def __init__(self, ttl: core.duration, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[123]
            attributes: list = [ttl]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def ttl(self) -> core.duration:
            return self._get(self.type_.generated_offsets[0])

        def set_ttl(self, v: core.duration) -> None:
            self._set(self.type_.generated_offsets[0], v)
    ...
    class Task(GreyCat.Object):
        ...
        def __init__(self, user_id: int, user_name: str, task_id: int, mod: str, type: str, fun: str, creation: core.time, start: core.time, completion: core.time, status: runtime.TaskStatus, progress: float, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[125]
            attributes: list = [user_id, user_name, task_id, mod, type, fun, creation, start, completion, status, progress]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def set_user_name(self, v: str) -> None:
            self._set(self.type_.generated_offsets[1], v)
        ...
        def completion(self) -> core.time:
            return self._get(self.type_.generated_offsets[8])

        def set_completion(self, v: core.time) -> None:
            self._set(self.type_.generated_offsets[8], v)
        ...
        @staticmethod
        def tasks(ids: core.Array, __greycat: Optional[GreyCat] = None) -> core.Array:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Task::tasks", [ids, ])

        @staticmethod
        def live(ids: core.Array, __greycat: Optional[GreyCat] = None) -> core.Array:
            if __greycat is None:
                __greycat  = GreyCat._DEFAULT
            return __greycat.call("runtime::Task::live", [ids, ])
    ...
    class TaskStatus(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.TaskStatus:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[127]
            return t.enum_values[t.generated_offsets[runtime.TaskStatus.__indices_by_values[key]]]

    @final
    class McpTool(GreyCat.Object):
        name_: Final[str] = "runtime::McpTool"

        def __init__(self, name: str, title: str, description: str, inputSchema: runtime.SchemaObject, outputSchema: runtime.SchemaObject, annotations: core.Map, execution: runtime.McpToolExecution, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[128]
            attributes: list = [name, title, description, inputSchema, outputSchema, annotations, execution]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def inputSchema(self) -> runtime.SchemaObject:
            return self._get(self.type_.generated_offsets[3])

        def set_inputSchema(self, v: runtime.SchemaObject) -> None:
            self._set(self.type_.generated_offsets[3], v)

        def outputSchema(self) -> runtime.SchemaObject:
            return self._get(self.type_.generated_offsets[4])

        def set_outputSchema(self, v: runtime.SchemaObject) -> None:
            self._set(self.type_.generated_offsets[4], v)

        def annotations(self) -> core.Map:
            return self._get(self.type_.generated_offsets[5])

        def set_annotations(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[5], v)

        def execution(self) -> runtime.McpToolExecution:
            return self._get(self.type_.generated_offsets[6])

        def set_execution(self, v: runtime.McpToolExecution) -> None:
            self._set(self.type_.generated_offsets[6], v)
    ...
    @final
    class McpTasksGetParams(GreyCat.Object):
        name_: Final[str] = "runtime::McpTasksGetParams"
    ...
    class SchemaType(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.SchemaType:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[132]
            return t.enum_values[t.generated_offsets[runtime.SchemaType.__indices_by_values[key]]]

    @final
    class McpToolsListParams(GreyCat.Object):
        name_: Final[str] = "runtime::McpToolsListParams"
    ...
    @final
    class McpImageContent(GreyCat.Object):
        name_: Final[str] = "runtime::McpImageContent"

        def __init__(self, type: runtime.McpContentType, _meta: core.Map, annotations: runtime.McpAnnotations, data: str, mimeType: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[135]
            attributes: list = [type, _meta, annotations, data, mimeType]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    @final
    class McpRequestParams(GreyCat.Object):
        name_: Final[str] = "runtime::McpRequestParams"

        def __init__(self, _meta: core.Map, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[137]
            attributes: list = [_meta]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    @final
    class McpToolsCallParams(GreyCat.Object):
        name_: Final[str] = "runtime::McpToolsCallParams"

        def __init__(self, _meta: core.Map, name: str, arguments: Any, task: runtime.McpTaskCreateParams, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[139]
            attributes: list = [_meta, name, arguments, task]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def task(self) -> runtime.McpTaskCreateParams:
            return self._get(self.type_.generated_offsets[3])

        def set_task(self, v: runtime.McpTaskCreateParams) -> None:
            self._set(self.type_.generated_offsets[3], v)

    @final
    class McpRole(GreyCat.Enum):
        name_: Final[str] = "runtime::McpRole"
        __indices_by_values: dict[str, int] = {
            "user": 0,
            "assistant": 1,
        }
        ...
        def __class_getitem__(cls, key) -> runtime.McpRole:
            greycat: GreyCat
            if isinstance(key, tuple):
                key, greycat = key
            else:
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[140]
            return t.enum_values[t.generated_offsets[runtime.McpRole.__indices_by_values[key]]]
    ...
    @final
    class McpServerPromptsCapabilities(GreyCat.Object):
        name_: Final[str] = "runtime::McpServerPromptsCapabilities"
    ...
    @final
    class McpResult(GreyCat.Object):
        name_: Final[str] = "runtime::McpResult"
    ...
    @final
    class McpTasksListResult(GreyCat.Object):
        name_: Final[str] = "runtime::McpTasksListResult"

        def __init__(self, _meta: core.Map, tasks: core.Array, nextCursor: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[144]
            attributes: list = [_meta, tasks, nextCursor]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def tasks(self) -> core.Array:
            return self._get(self.type_.generated_offsets[1])

        def set_tasks(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def nextCursor(self) -> str:
            return self._get(self.type_.generated_offsets[2])

        def set_nextCursor(self, v: str) -> None:
            self._set(self.type_.generated_offsets[2], v)
    ...
    @final
    class McpToolsCallResult(GreyCat.Object):
        name_: Final[str] = "runtime::McpToolsCallResult"

        def __init__(self, _meta: core.Map, content: core.Array, structuredContent: Any, isError: bool, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[146]
            attributes: list = [_meta, content, structuredContent, isError]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def content(self) -> core.Array:
            return self._get(self.type_.generated_offsets[1])

        def set_content(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def structuredContent(self) -> Any:
            return self._get(self.type_.generated_offsets[2])

        def set_structuredContent(self, v: Any) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def isError(self) -> bool:
            return self._get(self.type_.generated_offsets[3])

        def set_isError(self, v: bool) -> None:
            self._set(self.type_.generated_offsets[3], v)
    ...
    class Month(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.Month:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[147]
    ...
    class ResponseCode(GreyCat.Enum):
        ...
        def __class_getitem__(cls, key) -> runtime.ResponseCode:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[148]
            return t.enum_values[t.generated_offsets[runtime.ResponseCode.__indices_by_values[key]]]

    @final
    class McpTextContent(GreyCat.Object):
        name_: Final[str] = "runtime::McpTextContent"

        def __init__(self, type: runtime.McpContentType, _meta: core.Map, annotations: runtime.McpAnnotations, text: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[149]
            attributes: list = [type, _meta, annotations, text]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    @final
    class McpAnnotations(GreyCat.Object):
        name_: Final[str] = "runtime::McpAnnotations"

        def __init__(self, audience: core.Array, priority: runtime.McpPriority, lastModified: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[151]
            attributes: list = [audience, priority, lastModified]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def audience(self) -> core.Array:
            return self._get(self.type_.generated_offsets[0])

        def set_audience(self, v: core.Array) -> None:
            self._set(self.type_.generated_offsets[0], v)

        def priority(self) -> runtime.McpPriority:
            return self._get(self.type_.generated_offsets[1])

        def set_priority(self, v: runtime.McpPriority) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def lastModified(self) -> str:
            return self._get(self.type_.generated_offsets[2])

        def set_lastModified(self, v: str) -> None:
            self._set(self.type_.generated_offsets[2], v)
    ...
    @final
    class McpServerTasksCapabilities(GreyCat.Object):
        name_: Final[str] = "runtime::McpServerTasksCapabilities"

        def __init__(self, list: core.Map, cancel: core.Map, requests: core.Map, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[153]
            attributes: list = [list, cancel, requests]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    class LogLevel(GreyCat.Enum):
        ...
        def __init__(self, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[154]
            attributes: list = []
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def __class_getitem__(cls, key) -> runtime.LogLevel:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[154]
    ...
    class OpenApiVersion(GreyCat.Enum):
        ...
        def __init__(self, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[155]
            attributes: list = []
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def __class_getitem__(cls, key) -> runtime.OpenApiVersion:
            ...
            if isinstance(key, tuple):
                ...
                greycat = GreyCat._DEFAULT
            t: Final[GreyCat.Type] = greycat.libs_by_name[_std._name].mapped[155]
            return t.enum_values[t.generated_offsets[runtime.OpenApiVersion.__indices_by_values[key]]]

    @final
    class McpToolExecution(GreyCat.Object):
        name_: Final[str] = "runtime::McpToolExecution"

        def __init__(self, taskSupport: runtime.McpTaskSupport, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[156]
            attributes: list = [taskSupport]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def taskSupport(self) -> runtime.McpTaskSupport:
            return self._get(self.type_.generated_offsets[0])

        def set_taskSupport(self, v: runtime.McpTaskSupport) -> None:
            self._set(self.type_.generated_offsets[0], v)
    ...
    class PeriodicOptions(GreyCat.Object):
        ...
        def __init__(self, immediate: bool, activated: bool, start: core.time, max_duration: core.duration, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[157]
            attributes: list = [immediate, activated, start, max_duration]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

        def immediate(self) -> bool:
            return self._get(self.type_.generated_offsets[0])

        def set_immediate(self, v: bool) -> None:
            self._set(self.type_.generated_offsets[0], v)
    ...
    @final
    class McpBaseMetadata(GreyCat.Object):
        name_: Final[str] = "runtime::McpBaseMetadata"

        def __init__(self, name: str, title: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[158]
            attributes: list = [name, title]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    @final
    class McpInitializeResult(GreyCat.Object):
        name_: Final[str] = "runtime::McpInitializeResult"

        def __init__(self, _meta: core.Map, protocolVersion: str, capabilities: runtime.McpServerCapabilities, serverInfo: runtime.McpImplementation, instructions: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[159]
            attributes: list = [_meta, protocolVersion, capabilities, serverInfo, instructions]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def capabilities(self) -> runtime.McpServerCapabilities:
            return self._get(self.type_.generated_offsets[2])

        def set_capabilities(self, v: runtime.McpServerCapabilities) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def serverInfo(self) -> runtime.McpImplementation:
            return self._get(self.type_.generated_offsets[3])

        def set_serverInfo(self, v: runtime.McpImplementation) -> None:
            self._set(self.type_.generated_offsets[3], v)

        def instructions(self) -> str:
            return self._get(self.type_.generated_offsets[4])

        def set_instructions(self, v: str) -> None:
            self._set(self.type_.generated_offsets[4], v)

    @final
    class ZoneUsage(GreyCat.Object):
        name_: Final[str] = "runtime::ZoneUsage"

        def __init__(self, size: int, committed_blocks: int, reserved_blocks: int, blocks: int, cache: int, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[160]
            attributes: list = [size, committed_blocks, reserved_blocks, blocks, cache]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def set_committed_blocks(self, v: int) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def reserved_blocks(self) -> int:
            return self._get(self.type_.generated_offsets[2])

        def set_reserved_blocks(self, v: int) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def blocks(self) -> int:
            return self._get(self.type_.generated_offsets[3])

        def set_blocks(self, v: int) -> None:
            self._set(self.type_.generated_offsets[3], v)
    ...
    @final
    class McpServerCapabilities(GreyCat.Object):
        name_: Final[str] = "runtime::McpServerCapabilities"

        def __init__(self, experimental: core.Map, logging: core.Map, completions: core.Map, prompts: runtime.McpServerPromptsCapabilities, resources: runtime.McpServerResourcesCapabilities, tools: runtime.McpServerToolsCapabilities, tasks: runtime.McpServerTasksCapabilities, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[161]
            attributes: list = [experimental, logging, completions, prompts, resources, tools, tasks]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def logging(self) -> core.Map:
            return self._get(self.type_.generated_offsets[1])

        def set_logging(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def completions(self) -> core.Map:
            return self._get(self.type_.generated_offsets[2])

        def set_completions(self, v: core.Map) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def prompts(self) -> runtime.McpServerPromptsCapabilities:
            return self._get(self.type_.generated_offsets[3])

        def set_prompts(self, v: runtime.McpServerPromptsCapabilities) -> None:
            self._set(self.type_.generated_offsets[3], v)

        def resources(self) -> runtime.McpServerResourcesCapabilities:
            return self._get(self.type_.generated_offsets[4])

        def set_resources(self, v: runtime.McpServerResourcesCapabilities) -> None:
            self._set(self.type_.generated_offsets[4], v)

        def tools(self) -> runtime.McpServerToolsCapabilities:
            return self._get(self.type_.generated_offsets[5])

        def set_tools(self, v: runtime.McpServerToolsCapabilities) -> None:
            self._set(self.type_.generated_offsets[5], v)

        def tasks(self) -> runtime.McpServerTasksCapabilities:
            return self._get(self.type_.generated_offsets[6])

        def set_tasks(self, v: runtime.McpServerTasksCapabilities) -> None:
            self._set(self.type_.generated_offsets[6], v)
    ...
    class HeaderObject(GreyCat.Object):
        ...
        def __init__(self, description: str, required: bool, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[162]
    ...
    @final
    class McpTask(GreyCat.Object):
        name_: Final[str] = "runtime::McpTask"

        def __init__(self, taskId: str, status: runtime.McpTaskStatus, statusMessage: str, createdAt: core.time, lastUpdatedAt: core.time, ttl: core.duration, pollInterval: core.duration, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[163]
            attributes: list = [taskId, status, statusMessage, createdAt, lastUpdatedAt, ttl, pollInterval]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def status(self) -> runtime.McpTaskStatus:
            return self._get(self.type_.generated_offsets[1])

        def set_status(self, v: runtime.McpTaskStatus) -> None:
            self._set(self.type_.generated_offsets[1], v)

        def statusMessage(self) -> str:
            return self._get(self.type_.generated_offsets[2])

        def set_statusMessage(self, v: str) -> None:
            self._set(self.type_.generated_offsets[2], v)

        def createdAt(self) -> core.time:
            return self._get(self.type_.generated_offsets[3])

        def set_createdAt(self, v: core.time) -> None:
            self._set(self.type_.generated_offsets[3], v)

        def lastUpdatedAt(self) -> core.time:
            return self._get(self.type_.generated_offsets[4])

        def set_lastUpdatedAt(self, v: core.time) -> None:
            self._set(self.type_.generated_offsets[4], v)
        ...
        def pollInterval(self) -> core.duration:
            return self._get(self.type_.generated_offsets[6])

        def set_pollInterval(self, v: core.duration) -> None:
            self._set(self.type_.generated_offsets[6], v)
    ...
    class Scheduler(GreyCat.Object):
        ...
        def __init__(self, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[164]
            attributes: list = []
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    class FixedPeriodicity(GreyCat.Object):
        ...
        def __init__(self, every: core.duration, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[165]
    ...
    @final
    class McpAudioContent(GreyCat.Object):
        name_: Final[str] = "runtime::McpAudioContent"

        def __init__(self, type: runtime.McpContentType, _meta: core.Map, annotations: runtime.McpAnnotations, data: str, mimeType: str, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[166]
            attributes: list = [type, _meta, annotations, data, mimeType]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    @staticmethod
    def mcp_initialize(params: runtime.McpInitializeParams, __greycat: Optional[GreyCat] = None) -> runtime.McpInitializeResult:
        if __greycat is None:
            __greycat  = GreyCat._DEFAULT
        return __greycat.call("runtime::mcp_initialize", [params, ])

    @staticmethod
    def mcp_tools_list(params: runtime.McpToolsListParams, __greycat: Optional[GreyCat] = None) -> runtime.McpToolsListResult:
        if __greycat is None:
            __greycat  = GreyCat._DEFAULT
        return __greycat.call("runtime::mcp_tools_list", [params, ])

    @staticmethod
    def mcp_tools_call(params: runtime.McpToolsCallParams, __greycat: Optional[GreyCat] = None) -> Any:
        if __greycat is None:
            __greycat  = GreyCat._DEFAULT
        return __greycat.call("runtime::mcp_tools_call", [params, ])

    @staticmethod
    def mcp_tasks_get(params: runtime.McpTasksGetParams, __greycat: Optional[GreyCat] = None) -> Any:
        if __greycat is None:
            __greycat  = GreyCat._DEFAULT
        return __greycat.call("runtime::mcp_tasks_get", [params, ])

    @staticmethod
    def mcp_tasks_result(params: runtime.McpTasksResultParams, __greycat: Optional[GreyCat] = None) -> runtime.McpToolsCallResult:
        if __greycat is None:
            __greycat  = GreyCat._DEFAULT
        return __greycat.call("runtime::mcp_tasks_result", [params, ])

    @staticmethod
    def mcp_tasks_list(params: runtime.McpTasksListParams, __greycat: Optional[GreyCat] = None) -> runtime.McpTasksListResult:
        if __greycat is None:
            __greycat  = GreyCat._DEFAULT
        return __greycat.call("runtime::mcp_tasks_list", [params, ])

    @staticmethod
    def mcp_tasks_cancel(params: runtime.McpTasksCancelParams, __greycat: Optional[GreyCat] = None) -> runtime.McpTask:
        if __greycat is None:
            __greycat  = GreyCat._DEFAULT
        return __greycat.call("runtime::mcp_tasks_cancel", [params, ])
...
class util:
    ...
    class TimeWindow(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, values: core.Table, span: core.duration, sum: float, sumsq: float, field: core.field, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[167]
    ...
    class LogQuantizer(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, min: util.__T, max: util.__T, bins: int, open: bool, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[168]
    ...
    class Random(GreyCat.Object):
        ...
        def __init__(self, seed: int, v: float, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[169]
    ...
    class Stack(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, values: core.Array, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[170]
    ...
    class SlidingWindow(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, values: core.Array, span: int, sum: float, sumsq: float, field: core.field, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[171]
            attributes: list = [values, span, sum, sumsq, field]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    class Assert(GreyCat.Object):
        ...
        def __init__(self, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[172]
            attributes: list = []
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    class HistogramStats(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, min: util.__T, max: util.__T, whisker_low: util.__T, whisker_high: util.__T, percentile1: util.__T, percentile5: util.__T, percentile10: util.__T, percentile20: util.__T, percentile25: util.__T, percentile50: util.__T, percentile75: util.__T, percentile80: util.__T, percentile90: util.__T, percentile95: util.__T, percentile99: util.__T, sum: float, avg: util.__T, std: util.__T, size: int, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[173]
    ...
    class QuantizerSlotBound(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, min: util.__T, max: util.__T, center: util.__T, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[174]
    ...
    class Crypto(GreyCat.Object):
        ...
        def __init__(self, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[175]
            attributes: list = []
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    class Quantizer(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[176]
            attributes: list = []
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])

    @final
    class Uuid(GreyCat.Object):
        name_: Final[str] = "util::Uuid"

        def __init__(self, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[177]
            attributes: list = []
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    class Histogram(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, quantizer: util.Quantizer, bins: core.Array, nb_rejected: int, nb_accepted: int, min: util.__T, max: util.__T, sum: float, sumsq: float, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[178]
    ...
    class Gaussian(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, sum: float, sumsq: float, count: int, min: util.__T, max: util.__T, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[179]
    ...
    class MultiQuantizer(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, quantizers: core.Array, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[180]
    ...
    class ProgressTracker(GreyCat.Object):
        ...
        def __init__(self, start: core.time, total: int, counter: int, duration: core.duration, progress: float, speed: float, remaining: core.duration, speed_smoothed: float, smoothing: float, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[181]
            attributes: list = [start, total, counter, duration, progress, speed, remaining, speed_smoothed, smoothing]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
        ...
        def speed_smoothed(self) -> float:
            return self._get(self.type_.generated_offsets[7])

        def set_speed_smoothed(self, v: float) -> None:
            self._set(self.type_.generated_offsets[7], v)

        def smoothing(self) -> float:
            return self._get(self.type_.generated_offsets[8])

        def set_smoothing(self, v: float) -> None:
            self._set(self.type_.generated_offsets[8], v)
    ...
    class GaussianProfile(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, quantizer: util.Quantizer, precision: core.FloatPrecision, bins: core.Table, value_min: float, nb_rejected: int, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[182]
    ...
    class HistogramBin(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, bin: util.QuantizerSlotBound, count: int, ratio: float, cumulative_count: int, cumulative_ratio: float, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[183]
    ...
    class GaussianProfileSlot(GreyCat.Object):
        ...
        def __init__(self, sum: int, sumsq: int, count: int, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[184]
    ...
    class Queue(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, values: core.Array, capacity: int, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[185]
    ...
    class LinearQuantizer(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, min: util.__T, max: util.__T, bins: int, open: bool, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[186]
            attributes: list = [min, max, bins, open]
            super().__init__(_type, [attributes[offset] for offset in _type.generated_offsets])
    ...
    class CustomQuantizer(Generic[__T], GreyCat.Object):
        ...
        def __init__(self, min: util.__T, max: util.__T, step_starts: core.Array, open: bool, *, _type: Optional[GreyCat.Type] = None):
            if _type is None:
                _type = GreyCat._DEFAULT.libs_by_name[_std._name].mapped[187]
...
class _std(GreyCat.Library):
    ...
    def configure(self, loaders: dict[str, GreyCat.Loader], factories: dict[str, GreyCat.Factory]) -> None:
        ...
        factories[core.Chars.name_] = lambda _type, attributes: core.Chars(*attributes, _type=_type)
        ...
        factories[io.S3Bucket.name_] = lambda _type, attributes: io.S3Bucket(*attributes, _type=_type)
        ...
        factories[io.S3BasicCredentials.name_] = lambda _type, attributes: io.S3BasicCredentials(*attributes, _type=_type)
        ...
        factories[io.S3.name_] = lambda _type, attributes: io.S3(*attributes, _type=_type)
        ...
        factories[io.BinReader.name_] = lambda _type, attributes: io.BinReader(*attributes, _type=_type)
        ...
        factories[io.S3Object.name_] = lambda _type, attributes: io.S3Object(*attributes, _type=_type)
        ...
        factories[runtime.McpTaskSupport.name_] = lambda _type, attributes: GreyCat.Enum(_type, attributes)
        factories[runtime.McpTasksResultParams.name_] = lambda _type, attributes: runtime.McpTasksResultParams(*attributes, _type=_type)
        factories[runtime.McpTaskStatus.name_] = lambda _type, attributes: GreyCat.Enum(_type, attributes)
        factories[runtime.McpInitializeParams.name_] = lambda _type, attributes: runtime.McpInitializeParams(*attributes, _type=_type)
        factories[runtime.McpClientRoots.name_] = lambda _type, attributes: runtime.McpClientRoots(*attributes, _type=_type)
        factories[runtime.McpImplementation.name_] = lambda _type, attributes: runtime.McpImplementation(*attributes, _type=_type)
        ...
        factories[runtime.McpClientCapabilities.name_] = lambda _type, attributes: runtime.McpClientCapabilities(*attributes, _type=_type)
        factories[runtime.System.name_] = lambda _type, attributes: runtime.System(*attributes, _type=_type)
        factories[runtime.IdentityGrantType.name_] = lambda _type, attributes: GreyCat.Enum(_type, attributes)
        factories[runtime.Runtime.name_] = lambda _type, attributes: runtime.Runtime(*attributes, _type=_type)
        factories[runtime.McpResourceContent.name_] = lambda _type, attributes: runtime.McpResourceContent(*attributes, _type=_type)
        factories[runtime.McpContentBlock.name_] = lambda _type, attributes: runtime.McpContentBlock(*attributes, _type=_type)
        factories[runtime.McpServerToolsCapabilities.name_] = lambda _type, attributes: runtime.McpServerToolsCapabilities(*attributes, _type=_type)
        factories[runtime.PathItemObject.name_] = lambda _type, attributes: runtime.PathItemObject(*attributes, _type=_type)
        factories[runtime.McpServerResourcesCapabilities.name_] = lambda _type, attributes: runtime.McpServerResourcesCapabilities(*attributes, _type=_type)
        ...
        factories[runtime.McpContentType.name_] = lambda _type, attributes: GreyCat.Enum(_type, attributes)
        ...
        factories[runtime.McpTasksCreateResult.name_] = lambda _type, attributes: runtime.McpTasksCreateResult(*attributes, _type=_type)
        factories[runtime.McpClientTasksCapabilities.name_] = lambda _type, attributes: runtime.McpClientTasksCapabilities(*attributes, _type=_type)
        factories[runtime.OperationObject.name_] = lambda _type, attributes: runtime.OperationObject(*attributes, _type=_type)
        factories[runtime.McpTasksCancelParams.name_] = lambda _type, attributes: runtime.McpTasksCancelParams(*attributes, _type=_type)
        factories[runtime.RuntimeInfo.name_] = lambda _type, attributes: runtime.RuntimeInfo(*attributes, _type=_type)
        factories[runtime.McpTasksListParams.name_] = lambda _type, attributes: runtime.McpTasksListParams(*attributes, _type=_type)
        factories[runtime.IdentityGrant.name_] = lambda _type, attributes: runtime.IdentityGrant(*attributes, _type=_type)
        factories[runtime.LicenseType.name_] = lambda _type, attributes: GreyCat.Enum(_type, attributes)
        factories[runtime.McpToolsListResult.name_] = lambda _type, attributes: runtime.McpToolsListResult(*attributes, _type=_type)
        factories[runtime.LogDataUsage.name_] = lambda _type, attributes: runtime.LogDataUsage(*attributes, _type=_type)
        factories[runtime.RuntimeUsage.name_] = lambda _type, attributes: runtime.RuntimeUsage(*attributes, _type=_type)
        factories[runtime.McpPriority.name_] = lambda _type, attributes: GreyCat.Enum(_type, attributes)
        factories[runtime.WorkerUsage.name_] = lambda _type, attributes: runtime.WorkerUsage(*attributes, _type=_type)
        ...
        factories[runtime.Identity.name_] = lambda _type, attributes: runtime.Identity(*attributes, _type=_type)
        ...
        factories[runtime.McpTaskCreateParams.name_] = lambda _type, attributes: runtime.McpTaskCreateParams(*attributes, _type=_type)
        ...
        factories[runtime.McpTool.name_] = lambda _type, attributes: runtime.McpTool(*attributes, _type=_type)
        ...
        factories[runtime.McpTasksGetParams.name_] = lambda _type, attributes: runtime.McpTasksGetParams(*attributes, _type=_type)
        factories[runtime.SchemaType.name_] = lambda _type, attributes: GreyCat.Enum(_type, attributes)
        factories[runtime.McpToolsListParams.name_] = lambda _type, attributes: runtime.McpToolsListParams(*attributes, _type=_type)
        factories[runtime.RequestBodyObject.name_] = lambda _type, attributes: runtime.RequestBodyObject(*attributes, _type=_type)
        factories[runtime.McpImageContent.name_] = lambda _type, attributes: runtime.McpImageContent(*attributes, _type=_type)
        factories[runtime.Log.name_] = lambda _type, attributes: runtime.Log(*attributes, _type=_type)
        factories[runtime.McpRequestParams.name_] = lambda _type, attributes: runtime.McpRequestParams(*attributes, _type=_type)
        factories[runtime.WeeklyPeriodicity.name_] = lambda _type, attributes: runtime.WeeklyPeriodicity(*attributes, _type=_type)
        factories[runtime.McpToolsCallParams.name_] = lambda _type, attributes: runtime.McpToolsCallParams(*attributes, _type=_type)
        factories[runtime.McpRole.name_] = lambda _type, attributes: GreyCat.Enum(_type, attributes)
        factories[runtime.Frame.name_] = lambda _type, attributes: runtime.Frame(*attributes, _type=_type)
        factories[runtime.McpServerPromptsCapabilities.name_] = lambda _type, attributes: runtime.McpServerPromptsCapabilities(*attributes, _type=_type)
        factories[runtime.McpResult.name_] = lambda _type, attributes: runtime.McpResult(*attributes, _type=_type)
        factories[runtime.McpTasksListResult.name_] = lambda _type, attributes: runtime.McpTasksListResult(*attributes, _type=_type)
        factories[runtime.ComponentsObject.name_] = lambda _type, attributes: runtime.ComponentsObject(*attributes, _type=_type)
        factories[runtime.McpToolsCallResult.name_] = lambda _type, attributes: runtime.McpToolsCallResult(*attributes, _type=_type)
        ...
        factories[runtime.McpTextContent.name_] = lambda _type, attributes: runtime.McpTextContent(*attributes, _type=_type)
        factories[runtime.Permission.name_] = lambda _type, attributes: runtime.Permission(*attributes, _type=_type)
        factories[runtime.McpAnnotations.name_] = lambda _type, attributes: runtime.McpAnnotations(*attributes, _type=_type)
        factories[runtime.Debug.name_] = lambda _type, attributes: runtime.Debug(*attributes, _type=_type)
        factories[runtime.McpServerTasksCapabilities.name_] = lambda _type, attributes: runtime.McpServerTasksCapabilities(*attributes, _type=_type)
        ...
        factories[runtime.McpToolExecution.name_] = lambda _type, attributes: runtime.McpToolExecution(*attributes, _type=_type)
        factories[runtime.PeriodicOptions.name_] = lambda _type, attributes: runtime.PeriodicOptions(*attributes, _type=_type)
        factories[runtime.McpBaseMetadata.name_] = lambda _type, attributes: runtime.McpBaseMetadata(*attributes, _type=_type)
        factories[runtime.McpInitializeResult.name_] = lambda _type, attributes: runtime.McpInitializeResult(*attributes, _type=_type)
        factories[runtime.ZoneUsage.name_] = lambda _type, attributes: runtime.ZoneUsage(*attributes, _type=_type)
        factories[runtime.McpServerCapabilities.name_] = lambda _type, attributes: runtime.McpServerCapabilities(*attributes, _type=_type)
        factories[runtime.HeaderObject.name_] = lambda _type, attributes: runtime.HeaderObject(*attributes, _type=_type)
        factories[runtime.McpTask.name_] = lambda _type, attributes: runtime.McpTask(*attributes, _type=_type)
        ...
        factories[runtime.McpAudioContent.name_] = lambda _type, attributes: runtime.McpAudioContent(*attributes, _type=_type)
        ...
        factories[util.Uuid.name_] = lambda _type, attributes: util.Uuid(*attributes, _type=_type)
    ...
    def init(self, greycat: GreyCat) -> None:
        self.mapped: list[GreyCat.Type] = [
            ...
            greycat.types_by_name[core.Chars.name_],
            ...
            greycat.types_by_name[io.S3Bucket.name_],
            ...
            greycat.types_by_name[io.S3BasicCredentials.name_],
            greycat.types_by_name[io.Email.name_],
            greycat.types_by_name[io.SmtpAuth.name_],
            greycat.types_by_name[io.S3.name_],
            ...
            greycat.types_by_name[io.BinReader.name_],
            ...
            greycat.types_by_name[io.S3Object.name_],
            ...
            greycat.types_by_name[runtime.McpTaskSupport.name_],
            greycat.types_by_name[runtime.McpTasksResultParams.name_],
            greycat.types_by_name[runtime.McpTaskStatus.name_],
            greycat.types_by_name[runtime.McpInitializeParams.name_],
            greycat.types_by_name[runtime.McpClientRoots.name_],
            greycat.types_by_name[runtime.McpImplementation.name_],
            greycat.types_by_name[runtime.SchemaFormat.name_],
            greycat.types_by_name[runtime.ChildProcess.name_],
            greycat.types_by_name[runtime.McpClientCapabilities.name_],
            greycat.types_by_name[runtime.System.name_],
            greycat.types_by_name[runtime.IdentityGrantType.name_],
            greycat.types_by_name[runtime.Runtime.name_],
            greycat.types_by_name[runtime.McpResourceContent.name_],
            greycat.types_by_name[runtime.McpContentBlock.name_],
            greycat.types_by_name[runtime.McpServerToolsCapabilities.name_],
            greycat.types_by_name[runtime.PathItemObject.name_],
            greycat.types_by_name[runtime.McpServerResourcesCapabilities.name_],
            ...
            greycat.types_by_name[runtime.McpContentType.name_],
            greycat.types_by_name[runtime.OpenApi.name_],
            greycat.types_by_name[runtime.Periodicity.name_],
            greycat.types_by_name[runtime.McpTasksCreateResult.name_],
            greycat.types_by_name[runtime.McpClientTasksCapabilities.name_],
            greycat.types_by_name[runtime.OperationObject.name_],
            greycat.types_by_name[runtime.McpTasksCancelParams.name_],
            greycat.types_by_name[runtime.RuntimeInfo.name_],
            greycat.types_by_name[runtime.McpTasksListParams.name_],
            greycat.types_by_name[runtime.IdentityGrant.name_],
            greycat.types_by_name[runtime.LicenseType.name_],
            greycat.types_by_name[runtime.McpToolsListResult.name_],
            greycat.types_by_name[runtime.LogDataUsage.name_],
            greycat.types_by_name[runtime.RuntimeUsage.name_],
            greycat.types_by_name[runtime.McpPriority.name_],
            greycat.types_by_name[runtime.WorkerUsage.name_],
            greycat.types_by_name[runtime.Variable.name_],
            greycat.types_by_name[runtime.SchemaObject.name_],
            greycat.types_by_name[runtime.Identity.name_],
            ...
            greycat.types_by_name[runtime.McpTaskCreateParams.name_],
            ...
            greycat.types_by_name[runtime.McpTool.name_],
            greycat.types_by_name[runtime.Job.name_],
            greycat.types_by_name[runtime.ChildProcessResult.name_],
            greycat.types_by_name[runtime.McpTasksGetParams.name_],
            greycat.types_by_name[runtime.SchemaType.name_],
            greycat.types_by_name[runtime.McpToolsListParams.name_],
            greycat.types_by_name[runtime.RequestBodyObject.name_],
            greycat.types_by_name[runtime.McpImageContent.name_],
            greycat.types_by_name[runtime.Log.name_],
            greycat.types_by_name[runtime.McpRequestParams.name_],
            greycat.types_by_name[runtime.WeeklyPeriodicity.name_],
            greycat.types_by_name[runtime.McpToolsCallParams.name_],
            greycat.types_by_name[runtime.McpRole.name_],
            greycat.types_by_name[runtime.Frame.name_],
            greycat.types_by_name[runtime.McpServerPromptsCapabilities.name_],
            greycat.types_by_name[runtime.McpResult.name_],
            greycat.types_by_name[runtime.McpTasksListResult.name_],
            greycat.types_by_name[runtime.ComponentsObject.name_],
            greycat.types_by_name[runtime.McpToolsCallResult.name_],
            greycat.types_by_name[runtime.Month.name_],
            greycat.types_by_name[runtime.ResponseCode.name_],
            greycat.types_by_name[runtime.McpTextContent.name_],
            greycat.types_by_name[runtime.Permission.name_],
            greycat.types_by_name[runtime.McpAnnotations.name_],
            greycat.types_by_name[runtime.Debug.name_],
            greycat.types_by_name[runtime.McpServerTasksCapabilities.name_],
            greycat.types_by_name[runtime.LogLevel.name_],
            greycat.types_by_name[runtime.OpenApiVersion.name_],
            greycat.types_by_name[runtime.McpToolExecution.name_],
            greycat.types_by_name[runtime.PeriodicOptions.name_],
            greycat.types_by_name[runtime.McpBaseMetadata.name_],
            greycat.types_by_name[runtime.McpInitializeResult.name_],
            greycat.types_by_name[runtime.ZoneUsage.name_],
            greycat.types_by_name[runtime.McpServerCapabilities.name_],
            greycat.types_by_name[runtime.HeaderObject.name_],
            greycat.types_by_name[runtime.McpTask.name_],
            greycat.types_by_name[runtime.Scheduler.name_],
            greycat.types_by_name[runtime.FixedPeriodicity.name_],
            greycat.types_by_name[runtime.McpAudioContent.name_],
            ...
            greycat.types_by_name[util.Uuid.name_],
        ...
        self.mapped[55].resolve_generated_offsets("path")
        self.mapped[56].resolve_generated_offsets("access_key", "secret_key")
        self.mapped[57].resolve_generated_offsets("from", "subject", "body", "body_is_html", "to", "cc", "bcc")
        self.mapped[58].resolve_generated_offset_with_values("none", 0, "plain", 1, "login", 2)
        self.mapped[59].resolve_generated_offsets("host", "region", "credentials", "force_path_style")
        self.mapped[60].resolve_generated_offsets("path", "size", "last_modification")
        self.mapped[61].resolve_generated_offsets("path", "append")
        self.mapped[62].resolve_generated_offsets("path", "pos")
        self.mapped[63].resolve_generated_offset_with_values("plain", 0, "ssl_tls", 1, "starttls", 2)
        self.mapped[64].resolve_generated_offsets("name", "example", "null_count", "bool_count", "int_count", "float_count", "string_count", "date_count", "date_format_count", "enumerable_count", "profile")
        self.mapped[65].resolve_generated_offsets("path", "pos")
        self.mapped[66].resolve_generated_offsets("path", "pos")
        self.mapped[67].resolve_generated_offsets("path", "append")
        self.mapped[68].resolve_generated_offsets("header_lines", "separator", "string_delimiter", "decimal_separator", "thousands_separator", "columns", "line_count", "fail_count", "file_count")
        self.mapped[69].resolve_generated_offsets("protocol", "host", "port", "path", "user", "password", "params", "hash")
        self.mapped[71].resolve_generated_offsets("key", "last_modified", "size", "etag")
        self.mapped[72].resolve_generated_offsets("path", "pos")
        self.mapped[73].resolve_generated_offsets("method", "url", "headers", "body", "timeout", "max_response_size")
        self.mapped[74].resolve_generated_offsets("id", "column", "modulo")
        self.mapped[75].resolve_generated_offsets("path", "pos")
        self.mapped[76].resolve_generated_offsets("title", "version")
        self.mapped[77].resolve_generated_offsets("hour", "minute", "second", "timezone")
        self.mapped[78].resolve_generated_offsets("name", "start", "end", "company", "max_memory", "extra_1", "extra_2", "type")
        self.mapped[79].resolve_generated_offset_with_values("forbidden", None, "required", None, "optional", None)
        self.mapped[80].resolve_generated_offsets("_meta", "taskId")
        self.mapped[81].resolve_generated_offset_with_values("working", None, "input_required", None, "completed", None, "failed", None, "cancelled", None)
        self.mapped[82].resolve_generated_offsets("_meta", "protocolVersion", "capabilities", "clientInfo")
        self.mapped[83].resolve_generated_offsets("listChanged")
        self.mapped[84].resolve_generated_offsets("name", "title", "version")
        self.mapped[85].resolve_generated_offset_with_values("int32", None, "int64", None, "float", None, "double", None, "byte", None, "binary", None, "date", None, "date-time", None, "password", None)
        self.mapped[86].resolve_generated_offsets("pid")
        self.mapped[87].resolve_generated_offsets("experimental", "roots", "sampling", "elicitation", "tasks")
        self.mapped[89].resolve_generated_offset_with_values("read", None, "write", None, "read_write", None, "none", None)
        self.mapped[91].resolve_generated_offsets("type", "_meta", "annotations", "uri", "description", "mimeType", "size")
        self.mapped[92].resolve_generated_offsets("type", "_meta", "annotations")
        self.mapped[93].resolve_generated_offsets("listChanged")
        self.mapped[94].resolve_generated_offsets("description", "post")
        self.mapped[95].resolve_generated_offsets("subscribe", "listChanged")
        self.mapped[96].resolve_generated_offsets("dates", "timezone")
        self.mapped[97].resolve_generated_offsets("schema")
        self.mapped[98].resolve_generated_offsets("days", "daily")
        self.mapped[99].resolve_generated_offset_with_values("strict", None, "first_wins", None, "last_wins", None)
        self.mapped[100].resolve_generated_offset_with_values("Mon", 0, "Tue", 1, "Wed", 2, "Thu", 3, "Fri", 4, "Sat", 5, "Sun", 6)
        self.mapped[101].resolve_generated_offset_with_values("text", None, "image", None, "audio", None, "resource_link", None, "resource", None)
        self.mapped[104].resolve_generated_offsets("_meta", "task")
        self.mapped[105].resolve_generated_offsets("list", "cancel", "requests")
        self.mapped[106].resolve_generated_offsets("tags", "description", "requestBody", "responses")
        self.mapped[107].resolve_generated_offsets("_meta", "taskId")
        self.mapped[108].resolve_generated_offsets("version", "program_version", "arch", "timezone", "license", "io_threads", "bg_threads", "fg_threads", "mem_total", "mem_worker", "disk_data_bytes")
        self.mapped[109].resolve_generated_offsets("_meta", "cursor")
        self.mapped[110].resolve_generated_offsets("name", "grant")
        self.mapped[111].resolve_generated_offset_with_values("community", None, "enterprise", None, "testing", None)
        self.mapped[112].resolve_generated_offsets("_meta", "tools")
        self.mapped[113].resolve_generated_offsets("read_bytes", "read_hits", "read_wasted", "write_bytes", "write_hits", "cache_bytes", "cache_hits")
        self.mapped[114].resolve_generated_offsets("os_total_bytes", "os_used_bytes", "proc_virt_bytes", "proc_res_bytes", "proc_shr_bytes", "global_memory", "memory_drift", "workers", "zones")
        self.mapped[115].resolve_generated_offset_with_values("MostImportant", 1, "LeastImportant", 0)
        self.mapped[116].resolve_generated_offsets("memory", "cache", "writes", "reads")
        self.mapped[117].resolve_generated_offsets("name", "value")
        self.mapped[118].resolve_generated_offsets("$ref", "$defs", "type", "format", "description", "nullable", "properties", "pattern", "required", "items", "oneOf", "allOf", "anyOf", "minItems", "maxItems", "enum", "additionalProperties")
        self.mapped[119].resolve_generated_offsets("id", "name", "role", "grants")
        self.mapped[120].resolve_generated_offsets("description", "headers", "content")
        self.mapped[121].resolve_generated_offsets("function", "periodicity", "options", "is_active", "next_execution", "execution_count")
        self.mapped[122].resolve_generated_offsets("day", "month")
        self.mapped[123].resolve_generated_offsets("ttl")
        self.mapped[124].resolve_generated_offsets("name", "permissions")
        self.mapped[125].resolve_generated_offsets("user_id", "user_name", "task_id", "mod", "type", "fun", "creation", "start", "completion", "status", "progress")
        self.mapped[126].resolve_generated_offsets("openapi", "info", "paths", "components")
        self.mapped[127].resolve_generated_offset_with_values("empty", None, "waiting", None, "running", None, "await", None, "cancelled", None, "error", None, "ended", None, "ended_with_errors", None, "breakpoint", None)
        self.mapped[128].resolve_generated_offsets("name", "title", "description", "inputSchema", "outputSchema", "annotations", "execution")
        self.mapped[129].resolve_generated_offsets("function", "arguments")
        self.mapped[130].resolve_generated_offsets("code", "stdout", "stderr")
        self.mapped[131].resolve_generated_offsets("_meta", "taskId")
        self.mapped[132].resolve_generated_offset_with_values("string", None, "number", None, "integer", None, "boolean", None, "object", None, "array", None, "null", None)
        self.mapped[133].resolve_generated_offsets("_meta", "cursor")
        self.mapped[134].resolve_generated_offsets("content", "required")
        self.mapped[135].resolve_generated_offsets("type", "_meta", "annotations", "data", "mimeType")
        self.mapped[136].resolve_generated_offsets("level", "time", "user_id", "id", "id2", "src", "data")
        self.mapped[137].resolve_generated_offsets("_meta")
        self.mapped[138].resolve_generated_offsets("days", "daily")
        self.mapped[139].resolve_generated_offsets("_meta", "name", "arguments", "task")
        self.mapped[140].resolve_generated_offset_with_values("user", None, "assistant", None)
        self.mapped[141].resolve_generated_offsets("module", "type", "function", "src", "line", "column", "scope")
        self.mapped[142].resolve_generated_offsets("listChanged")
        self.mapped[143].resolve_generated_offsets("_meta")
        self.mapped[144].resolve_generated_offsets("_meta", "tasks", "nextCursor")
        self.mapped[145].resolve_generated_offsets("schemas")
        self.mapped[146].resolve_generated_offsets("_meta", "content", "structuredContent", "isError")
        self.mapped[147].resolve_generated_offset_with_values("Jan", 0, "Feb", 1, "Mar", 2, "Apr", 3, "May", 4, "Jun", 5, "Jul", 6, "Aug", 7, "Sep", 8, "Oct", 9, "Nov", 10, "Dec", 11)
        self.mapped[148].resolve_generated_offset_with_values("200", None, "400", None, "404", None)
        self.mapped[149].resolve_generated_offsets("type", "_meta", "annotations", "text")
        self.mapped[150].resolve_generated_offsets("name", "description")
        self.mapped[151].resolve_generated_offsets("audience", "priority", "lastModified")
        self.mapped[152].resolve_generated_offsets("id", "frames", "root")
        self.mapped[153].resolve_generated_offsets("list", "cancel", "requests")
        self.mapped[154].resolve_generated_offset_with_values("error", None, "warn", None, "info", None, "perf", None, "trace", None)
        self.mapped[155].resolve_generated_offset_with_values("3.0.4", None, "3.1.0", None)
        self.mapped[156].resolve_generated_offsets("taskSupport")
        self.mapped[157].resolve_generated_offsets("immediate", "activated", "start", "max_duration")
        self.mapped[158].resolve_generated_offsets("name", "title")
        self.mapped[159].resolve_generated_offsets("_meta", "protocolVersion", "capabilities", "serverInfo", "instructions")
        self.mapped[160].resolve_generated_offsets("size", "committed_blocks", "reserved_blocks", "blocks", "cache")
        self.mapped[161].resolve_generated_offsets("experimental", "logging", "completions", "prompts", "resources", "tools", "tasks")
        self.mapped[162].resolve_generated_offsets("description", "required")
        self.mapped[163].resolve_generated_offsets("taskId", "status", "statusMessage", "createdAt", "lastUpdatedAt", "ttl", "pollInterval")
        self.mapped[165].resolve_generated_offsets("every")
        self.mapped[166].resolve_generated_offsets("type", "_meta", "annotations", "data", "mimeType")
        self.mapped[167].resolve_generated_offsets("values", "span", "sum", "sumsq", "field")
        self.mapped[168].resolve_generated_offsets("min", "max", "bins", "open")
        self.mapped[169].resolve_generated_offsets("seed", "v")
        self.mapped[170].resolve_generated_offsets("values")
        self.mapped[171].resolve_generated_offsets("values", "span", "sum", "sumsq", "field")
        self.mapped[173].resolve_generated_offsets("min", "max", "whisker_low", "whisker_high", "percentile1", "percentile5", "percentile10", "percentile20", "percentile25", "percentile50", "percentile75", "percentile80", "percentile90", "percentile95", "percentile99", "sum", "avg", "std", "size")
        self.mapped[174].resolve_generated_offsets("min", "max", "center")
        self.mapped[178].resolve_generated_offsets("quantizer", "bins", "nb_rejected", "nb_accepted", "min", "max", "sum", "sumsq")
        self.mapped[179].resolve_generated_offsets("sum", "sumsq", "count", "min", "max")
        self.mapped[180].resolve_generated_offsets("quantizers")
        self.mapped[181].resolve_generated_offsets("start", "total", "counter", "duration", "progress", "speed", "remaining", "speed_smoothed", "smoothing")
        self.mapped[182].resolve_generated_offsets("quantizer", "precision", "bins", "value_min", "nb_rejected")
        self.mapped[183].resolve_generated_offsets("bin", "count", "ratio", "cumulative_count", "cumulative_ratio")
        self.mapped[184].resolve_generated_offsets("sum", "sumsq", "count")
        self.mapped[185].resolve_generated_offsets("values", "capacity")
        self.mapped[186].resolve_generated_offsets("min", "max", "bins", "open")
        self.mapped[187].resolve_generated_offsets("min", "max", "step_starts", "open")
