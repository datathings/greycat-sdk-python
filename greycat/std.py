...
class std(GreyCat.Library):
    ...
    class core:
        ...
        class ErrorCode(GreyCat.Enum):
            ...
            def __class_getitem__(cls, key) -> std.core.ErrorCode:
                ...
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[0]
            ...
            def create(greycat: GreyCat | None = None) -> std.core.ErrorCode:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.ErrorCode(greycat.libs_by_name[std.name_].mapped[0], [])
        ...
        class t4(std_n.core._t4):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._t4:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.t4(greycat.libs_by_name[std.name_].mapped[1], [])
        ...
        class Table(Generic[__T], std_n.core._Table[__T]):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._Table:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.Table(greycat.libs_by_name[std.name_].mapped[3], [])
        ...
        class nodeGeo(Generic[__T], std_n.core._nodeGeo[__T]):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._nodeGeo:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.nodeGeo(greycat.libs_by_name[std.name_].mapped[4], [])
        ...
        class t3(std_n.core._t3):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._t3:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.t3(greycat.libs_by_name[std.name_].mapped[5], [])
        ...
        class nodeIndex(Generic[__K, __V], std_n.core._nodeIndex[__K, __V]):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._nodeIndex:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.nodeIndex(greycat.libs_by_name[std.name_].mapped[6], [])
        ...
        class GeoCircle(GreyCat.Object):
            ...
            def create(center: std.core.geo, radius: float, greycat: GreyCat | None = None) -> std.core.GeoCircle:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.GeoCircle(greycat.libs_by_name[std.name_].mapped[7], [center, radius])
        ...
        class node(Generic[__T], std_n.core._node[__T]):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._node:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.node(greycat.libs_by_name[std.name_].mapped[8], [])
        ...
        class DurationUnit(GreyCat.Enum):
            ...
            def create(greycat: GreyCat | None = None) -> std.core.DurationUnit:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.DurationUnit(greycat.libs_by_name[std.name_].mapped[9], [])
        ...
        class TimeZone(GreyCat.Enum):
            ...
            def __class_getitem__(cls, key) -> std.core.TimeZone:
                ...
                if isinstance(key, tuple):
                    ...
                    greycat = GreyCat._DEFAULT
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[10]
                return t.enum_values[t.generated_offsets[std.core.TimeZone.__indices_by_values[key]]]
            ...
            def create(greycat: GreyCat | None = None) -> std.core.TimeZone:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.TimeZone(greycat.libs_by_name[std.name_].mapped[10], [])
        ...
        class TableColumnMapping(GreyCat.Object):
            ...
            def create(column: int, extractors: std.core.Array, greycat: GreyCat | None = None) -> std.core.TableColumnMapping:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.TableColumnMapping(greycat.libs_by_name[std.name_].mapped[11], [column, extractors])
        ...
        class TensorType(GreyCat.Enum):
            ...
            def __class_getitem__(cls, key) -> std.core.TensorType:
                ...
                if isinstance(key, tuple):
                    ...
                    greycat = GreyCat._DEFAULT
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[12]
                return t.enum_values[t.generated_offsets[std.core.TimeZone.__indices_by_values[key]]]
            ...
            def create(greycat: GreyCat | None = None) -> std.core.TensorType:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.TensorType(greycat.libs_by_name[std.name_].mapped[12], [])
        ...
        class t2(std_n.core._t2):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._t2:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.t2(greycat.libs_by_name[std.name_].mapped[14], [])
        ...
        class time(std_n.core._time):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._time:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.time(greycat.libs_by_name[std.name_].mapped[15], [])
        ...
        class String(std_n.core._String):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._String:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.String(greycat.libs_by_name[std.name_].mapped[16], [])
        ...
        class GeoBox(GreyCat.Object):
            ...
            def create(sw: std.core.geo, ne: std.core.geo, greycat: GreyCat | None = None) -> std.core.GeoBox:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.GeoBox(greycat.libs_by_name[std.name_].mapped[17], [sw, ne])
        ...
        class t4f(std_n.core._t4f):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._t4f:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.t4f(greycat.libs_by_name[std.name_].mapped[18], [])
        ...
        class ErrorFrame(GreyCat.Object):
            ...
            def create(module: str, function: str, line: int, column: int, greycat: GreyCat | None = None) -> std.core.ErrorFrame:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.ErrorFrame(greycat.libs_by_name[std.name_].mapped[19], [module, function, line, column])
        ...
        class field(std_n.core._field):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._field:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.field(greycat.libs_by_name[std.name_].mapped[20], [])
        ...
        class CalendarUnit(GreyCat.Enum):
            ...
            def create(greycat: GreyCat | None = None) -> std.core.CalendarUnit:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.CalendarUnit(greycat.libs_by_name[std.name_].mapped[21], [])
        ...
        class Buffer(std_n.core._Buffer):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._Buffer:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.Buffer(greycat.libs_by_name[std.name_].mapped[22], [])
        ...
        class Array(Generic[__T], std_n.core._Array[__T]):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._Array:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.Array(greycat.libs_by_name[std.name_].mapped[24], [])
        ...
        class GeoPoly(GreyCat.Object):
            ...
            def create(points: std.core.Array, greycat: GreyCat | None = None) -> std.core.GeoPoly:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.GeoPoly(greycat.libs_by_name[std.name_].mapped[25], [points])
        ...
        class FloatPrecision(GreyCat.Enum):
            ...
            def create(greycat: GreyCat | None = None) -> std.core.FloatPrecision:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.FloatPrecision(greycat.libs_by_name[std.name_].mapped[26], [])
        ...
        class nodeTime(Generic[__T], std_n.core._nodeTime[__T]):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._nodeTime:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.nodeTime(greycat.libs_by_name[std.name_].mapped[27], [])
        ...
        class t2f(std_n.core._t2f):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._t2f:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.t2f(greycat.libs_by_name[std.name_].mapped[28], [])
        ...
        class Tensor(std_n.core._Tensor):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._Tensor:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.Tensor(greycat.libs_by_name[std.name_].mapped[29], [])
        ...
        class duration(std_n.core._duration):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._duration:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.duration(greycat.libs_by_name[std.name_].mapped[30], [])
        ...
        class nodeTimeSingleton(GreyCat.Object):
            ...
            def create(t: std.core.time, v: Any, greycat: GreyCat | None = None) -> std.core.nodeTimeSingleton:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.nodeTimeSingleton(greycat.libs_by_name[std.name_].mapped[31], [t, v])
        ...
        class Date(GreyCat.Object):
            ...
            def create(year: int, month: int, day: int, hour: int, minute: int, second: int, microsecond: int, greycat: GreyCat | None = None) -> std.core.Date:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.Date(greycat.libs_by_name[std.name_].mapped[32], [year, month, day, hour, minute, second, microsecond])
        ...
        class SortOrder(GreyCat.Enum):
            ...
            def __class_getitem__(cls, key) -> std.core.SortOrder:
                ...
                if isinstance(key, tuple):
                    ...
                    greycat = GreyCat._DEFAULT
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[33]
                return t.enum_values[t.generated_offsets[std.core.TimeZone.__indices_by_values[key]]]
            ...
            def create(greycat: GreyCat | None = None) -> std.core.SortOrder:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.SortOrder(greycat.libs_by_name[std.name_].mapped[33], [])
        ...
        class NodeInfo(Generic[__T], GreyCat.Object):
            ...
            def create(size: int, from_: std.core.__, to: std.core.__, greycat: GreyCat | None = None) -> std.core.NodeInfo[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.NodeInfo(greycat.libs_by_name[std.name_].mapped[34], [size, from_, to])
        ...
        class function(std_n.core._function):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._function:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.function(greycat.libs_by_name[std.name_].mapped[35], [])
        ...
        class MathConstants(GreyCat.Object):
            ...
            def create(greycat: GreyCat | None = None) -> std.core.MathConstants:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.MathConstants(greycat.libs_by_name[std.name_].mapped[36], [])
        ...
        class t3f(std_n.core._t3f):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._t3f:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.t3f(greycat.libs_by_name[std.name_].mapped[37], [])
        ...
        class str(std_n.core._str):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._str:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.str(greycat.libs_by_name[std.name_].mapped[38], [])
        ...
        class SamplingMode(GreyCat.Enum):
            ...
            def create(greycat: GreyCat | None = None) -> std.core.SamplingMode:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.SamplingMode(greycat.libs_by_name[std.name_].mapped[40], [])
        ...
        class geo(std_n.core._geo):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._geo:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.geo(greycat.libs_by_name[std.name_].mapped[41], [])
        ...
        class Error(GreyCat.Object):
            ...
            def create(message: str, stack: std.core.Array, greycat: GreyCat | None = None) -> std.core.Error:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.Error(greycat.libs_by_name[std.name_].mapped[42], [message, stack])
        ...
        class Map(Generic[__K, __V], std_n.core._Map[__K, __V]):
            ...
            def create(greycat: GreyCat | None = None) -> std_n.core._Map:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.core.Map(greycat.libs_by_name[std.name_].mapped[43], [])
    ...
    class io:
        ...
        class SmtpAuth(GreyCat.Enum):
            ...
            def create(greycat: GreyCat | None = None) -> std.io.SmtpAuth:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.SmtpAuth(greycat.libs_by_name[std.name_].mapped[44], [])
        ...
        class Url(GreyCat.Object):
            ...
            def create(protocol: str, host: str, port: int, path: str, params: std.core.Map, hash: str, greycat: GreyCat | None = None) -> std.io.Url:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.Url(greycat.libs_by_name[std.name_].mapped[45], [protocol, host, port, path, params, hash])
        ...
        class File(GreyCat.Object):
            ...
            def create(path: str, size: int, last_modification: std.core.time, greycat: GreyCat | None = None) -> std.io.File:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.File(greycat.libs_by_name[std.name_].mapped[46], [path, size, last_modification])
        ...
        class CsvAnalysisConfig(GreyCat.Object):
            ...
            def create(header_lines: int, separator: c_char, string_delimiter: c_char, decimal_separator: c_char, thousands_separator: c_char, row_limit: int, enumerable_limit: int, date_check_limit: int, date_formats: std.core.Array, greycat: GreyCat | None = None) -> std.io.CsvAnalysisConfig:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.CsvAnalysisConfig(greycat.libs_by_name[std.name_].mapped[47], [header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats])
        ...
        class Writer(Generic[__T], GreyCat.Object):
            ...
            def create(path: str, append: bool, greycat: GreyCat | None = None) -> std.io.Writer[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.Writer(greycat.libs_by_name[std.name_].mapped[48], [path, append])
        ...
        class GcbWriter(Generic[__T], GreyCat.Object):
            ...
            def create(path: str, append: bool, greycat: GreyCat | None = None) -> std.io.GcbWriter[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.GcbWriter(greycat.libs_by_name[std.name_].mapped[49], [path, append])
        ...
        class TextWriter(Generic[__T], GreyCat.Object):
            ...
            def create(path: str, append: bool, greycat: GreyCat | None = None) -> std.io.TextWriter[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.TextWriter(greycat.libs_by_name[std.name_].mapped[50], [path, append])
        ...
        class GcbReader(Generic[__T], GreyCat.Object):
            ...
            def create(path: str, pos: int, greycat: GreyCat | None = None) -> std.io.GcbReader[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.GcbReader(greycat.libs_by_name[std.name_].mapped[51], [path, pos])
        ...
        class SmtpMode(GreyCat.Enum):
            ...
            def create(greycat: GreyCat | None = None) -> std.io.SmtpMode:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.SmtpMode(greycat.libs_by_name[std.name_].mapped[52], [])
        ...
        class CsvColumnStatistics(GreyCat.Object):
            ...
            def create(name: str, example: Any, null_count: int, bool_count: int, int_count: int, float_count: int, string_count: int, date_count: int, date_format_count: std.core.Map, enumerable_count: std.core.Map, profile: std.util.Gaussian, greycat: GreyCat | None = None) -> std.io.CsvColumnStatistics:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.CsvColumnStatistics(greycat.libs_by_name[std.name_].mapped[53], [name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, enumerable_count, profile])
        ...
        class CsvFormat(GreyCat.Object):
            ...
            def create(header_lines: int, separator: c_char, string_delimiter: c_char, decimal_separator: c_char, thousands_separator: c_char, trim: bool, format: str, tz: std.core.TimeZone, strict: bool, nearest_time: bool, greycat: GreyCat | None = None) -> std.io.CsvFormat:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.CsvFormat(greycat.libs_by_name[std.name_].mapped[54], [header_lines, separator, string_delimiter, decimal_separator, thousands_separator, trim, format, tz, strict, nearest_time])
        ...
        class CsvSharding(GreyCat.Object):
            ...
            def create(id: int, column: int, modulo: int, greycat: GreyCat | None = None) -> std.io.CsvSharding:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.CsvSharding(greycat.libs_by_name[std.name_].mapped[55], [id, column, modulo])
        ...
        class Email(GreyCat.Object):
            ...
            def create(from_: str, subject: str, body: str, body_is_html: bool, to: std.core.Array, cc: std.core.Array, bcc: std.core.Array, greycat: GreyCat | None = None) -> std.io.Email:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.Email(greycat.libs_by_name[std.name_].mapped[56], [from_, subject, body, body_is_html, to, cc, bcc])
        ...
        class CsvReader(Generic[__T], GreyCat.Object):
            ...
            def create(path: str, pos: int, format: std.io.CsvFormat, sharding: std.io.CsvSharding, greycat: GreyCat | None = None) -> std.io.CsvReader[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.CsvReader(greycat.libs_by_name[std.name_].mapped[57], [path, pos, format, sharding])
        ...
        class Reader(Generic[__T], GreyCat.Object):
            ...
            def create(path: str, pos: int, greycat: GreyCat | None = None) -> std.io.Reader[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.Reader(greycat.libs_by_name[std.name_].mapped[58], [path, pos])
        ...
        class Http(GreyCat.Object):
            ...
            def create(greycat: GreyCat | None = None) -> std.io.Http:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.Http(greycat.libs_by_name[std.name_].mapped[59], [])
        ...
        class CsvWriter(Generic[__T], GreyCat.Object):
            ...
            def create(path: str, append: bool, format: std.io.CsvFormat, greycat: GreyCat | None = None) -> std.io.CsvWriter[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.CsvWriter(greycat.libs_by_name[std.name_].mapped[60], [path, append, format])
        ...
        class TextReader(GreyCat.Object):
            ...
            def create(path: str, pos: int, greycat: GreyCat | None = None) -> std.io.TextReader:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.TextReader(greycat.libs_by_name[std.name_].mapped[61], [path, pos])
        ...
        class CsvStatistics(GreyCat.Object):
            ...
            def create(header_lines: int, separator: c_char, string_delimiter: c_char, decimal_separator: c_char, thousands_separator: c_char, columns: std.core.Array, line_count: int, fail_count: int, file_count: int, greycat: GreyCat | None = None) -> std.io.CsvStatistics:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.CsvStatistics(greycat.libs_by_name[std.name_].mapped[62], [header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns, line_count, fail_count, file_count])
        ...
        class JsonWriter(Generic[__T], GreyCat.Object):
            ...
            def create(path: str, append: bool, greycat: GreyCat | None = None) -> std.io.JsonWriter[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.JsonWriter(greycat.libs_by_name[std.name_].mapped[63], [path, append])
        ...
        class JsonReader(Generic[__T], GreyCat.Object):
            ...
            def create(path: str, pos: int, greycat: GreyCat | None = None) -> std.io.JsonReader[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.JsonReader(greycat.libs_by_name[std.name_].mapped[64], [path, pos])
        ...
        class Json(Generic[__T], GreyCat.Object):
            ...
            def create(greycat: GreyCat | None = None) -> std.io.Json[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.Json(greycat.libs_by_name[std.name_].mapped[65], [])
        ...
        class Csv(GreyCat.Object):
            ...
            def create(greycat: GreyCat | None = None) -> std.io.Csv:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.Csv(greycat.libs_by_name[std.name_].mapped[66], [])
        ...
        class Smtp(GreyCat.Object):
            ...
            def create(host: str, port: int, mode: std.io.SmtpMode, authenticate: std.io.SmtpAuth, user: str, pass_: str, greycat: GreyCat | None = None) -> std.io.Smtp:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.Smtp(greycat.libs_by_name[std.name_].mapped[67], [host, port, mode, authenticate, user, pass_])
        ...
        class FileWalker(GreyCat.Object):
            ...
            def create(path: str, greycat: GreyCat | None = None) -> std.io.FileWalker:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.FileWalker(greycat.libs_by_name[std.name_].mapped[68], [path])
        ...
        class HttpHeader(GreyCat.Object):
            ...
            def create(name: str, value: str, greycat: GreyCat | None = None) -> std.io.HttpHeader:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.io.HttpHeader(greycat.libs_by_name[std.name_].mapped[69], [name, value])
    ...
    class runtime:
        ...
        class Variable(GreyCat.Object):
            ...
            def create(name: str, value: Any, greycat: GreyCat | None = None) -> std.runtime.Variable:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.Variable(greycat.libs_by_name[std.name_].mapped[70], [name, value])
        ...
        class OpenIDConnect(GreyCat.Object):
            ...
            def create(url: str, clientId: str, greycat: GreyCat | None = None) -> std.runtime.OpenIDConnect:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.OpenIDConnect(greycat.libs_by_name[std.name_].mapped[71], [url, clientId])
        ...
        class UserGroupPolicy(GreyCat.Object):
            ...
            def create(group_id: int, type: std.runtime.UserGroupPolicyType, greycat: GreyCat | None = None) -> std.runtime.UserGroupPolicy:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.UserGroupPolicy(greycat.libs_by_name[std.name_].mapped[72], [group_id, type])
        ...
        class License(GreyCat.Object):
            ...
            def create(name: str, start: std.core.time, end: std.core.time, company: str, max_memory: int, extra_1: int, extra_2: int, type: std.runtime.LicenseType, greycat: GreyCat | None = None) -> std.runtime.License:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.License(greycat.libs_by_name[std.name_].mapped[73], [name, start, end, company, max_memory, extra_1, extra_2, type])
        ...
        class User(GreyCat.Object):
            ...
            def create(id: int, name: str, activated: bool, full_name: str, email: str, role: str, groups: std.core.Array, groups_flags: int, external: bool, greycat: GreyCat | None = None) -> std.runtime.User:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.User(greycat.libs_by_name[std.name_].mapped[74], [id, name, activated, full_name, email, role, groups, groups_flags, external])
        ...
        class LogLevel(GreyCat.Enum):
            ...
            def create(greycat: GreyCat | None = None) -> std.runtime.LogLevel:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.LogLevel(greycat.libs_by_name[std.name_].mapped[75], [])
        ...
        class Job(Generic[__T], GreyCat.Object):
            ...
            def create(function: std.core.function, arguments: std.core.Array, greycat: GreyCat | None = None) -> std.runtime.Job[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.Job(greycat.libs_by_name[std.name_].mapped[76], [function, arguments])
        ...
        class SecurityFields(GreyCat.Object):
            ...
            def create(email: str, name: str, first_name: str, last_name: str, roles: std.core.Map, groups: std.core.Map, greycat: GreyCat | None = None) -> std.runtime.SecurityFields:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.SecurityFields(greycat.libs_by_name[std.name_].mapped[77], [email, name, first_name, last_name, roles, groups])
        ...
        class TaskStatus(GreyCat.Enum):
            ...
            def __class_getitem__(cls, key) -> std.runtime.TaskStatus:
                ...
                if isinstance(key, tuple):
                    ...
                    greycat = GreyCat._DEFAULT
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[78]
                return t.enum_values[t.generated_offsets[std.core.TimeZone.__indices_by_values[key]]]
            ...
            def create(greycat: GreyCat | None = None) -> std.runtime.TaskStatus:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.TaskStatus(greycat.libs_by_name[std.name_].mapped[78], [])
        ...
        class RuntimeInfo(GreyCat.Object):
            ...
            def create(version: str, program_version: str, arch: str, timezone: std.core.TimeZone, license: std.runtime.License, io_threads: int, bg_threads: int, fg_threads: int, mem_total: int, mem_worker: int, disk_data_bytes: int, greycat: GreyCat | None = None) -> std.runtime.RuntimeInfo:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.RuntimeInfo(greycat.libs_by_name[std.name_].mapped[79], [version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, disk_data_bytes])
        ...
        class LicenseType(GreyCat.Enum):
            ...
            def create(greycat: GreyCat | None = None) -> std.runtime.LicenseType:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.LicenseType(greycat.libs_by_name[std.name_].mapped[80], [])
        ...
        class Frame(GreyCat.Object):
            ...
            def create(module: str, type: str, function: str, src: str, line: int, column: int, scope: std.core.Array, greycat: GreyCat | None = None) -> std.runtime.Frame:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.Frame(greycat.libs_by_name[std.name_].mapped[81], [module, type, function, src, line, column, scope])
        ...
        class UserGroup(GreyCat.Object):
            ...
            def create(id: int, name: str, activated: bool, greycat: GreyCat | None = None) -> std.runtime.UserGroup:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.UserGroup(greycat.libs_by_name[std.name_].mapped[82], [id, name, activated])
        ...
        class CallPerf(GreyCat.Object):
            ...
            def create(duration: std.core.duration, bytes_write_disk: int, bytes_write_disk_raw: int, bytes_read_disk: int, bytes_read_disk_raw: int, bytes_read_cache: int, greycat: GreyCat | None = None) -> std.runtime.CallPerf:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.CallPerf(greycat.libs_by_name[std.name_].mapped[83], [duration, bytes_write_disk, bytes_write_disk_raw, bytes_read_disk, bytes_read_disk_raw, bytes_read_cache])
        ...
        class SecurityPolicy(GreyCat.Object):
            ...
            def create(entities: std.core.Array, credentials: std.core.Map, fields: std.runtime.SecurityFields, keys: std.core.Map, keys_last_refresh: std.core.time, greycat: GreyCat | None = None) -> std.runtime.SecurityPolicy:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.SecurityPolicy(greycat.libs_by_name[std.name_].mapped[84], [entities, credentials, fields, keys, keys_last_refresh])
        ...
        class SecurityEntity(GreyCat.Object):
            ...
            def create(id: int, name: str, activated: bool, greycat: GreyCat | None = None) -> std.runtime.SecurityEntity:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.SecurityEntity(greycat.libs_by_name[std.name_].mapped[85], [id, name, activated])
        ...
        class Runtime(GreyCat.Object):
            ...
            def create(greycat: GreyCat | None = None) -> std.runtime.Runtime:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.Runtime(greycat.libs_by_name[std.name_].mapped[86], [])
        ...
        class Debug(GreyCat.Object):
            ...
            def create(id: int, frames: std.core.Array, root: Any, greycat: GreyCat | None = None) -> std.runtime.Debug:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.Debug(greycat.libs_by_name[std.name_].mapped[87], [id, frames, root])
        ...
        class PeriodicTask(GreyCat.Object):
            ...
            def create(function: std.core.function, user_id: int, arguments: std.core.Array, start: std.core.time, every: std.core.duration, greycat: GreyCat | None = None) -> std.runtime.PeriodicTask:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.PeriodicTask(greycat.libs_by_name[std.name_].mapped[88], [function, user_id, arguments, start, every])
        ...
        class UserGroupPolicyType(GreyCat.Enum):
            ...
            def __class_getitem__(cls, key) -> std.runtime.UserGroupPolicyType:
                ...
                if isinstance(key, tuple):
                    ...
                    greycat = GreyCat._DEFAULT
                t: Final[GreyCat.Type] = greycat.libs_by_name[std.name_].mapped[89]
                return t.enum_values[t.generated_offsets[std.core.TimeZone.__indices_by_values[key]]]
            ...
            def create(greycat: GreyCat | None = None) -> std.runtime.UserGroupPolicyType:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.UserGroupPolicyType(greycat.libs_by_name[std.name_].mapped[89], [])
        ...
        class System(GreyCat.Object):
            ...
            def create(greycat: GreyCat | None = None) -> std.runtime.System:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.System(greycat.libs_by_name[std.name_].mapped[90], [])
        ...
        class UserCredential(GreyCat.Object):
            ...
            def create(offset: int, pass_: str, greycat: GreyCat | None = None) -> std.runtime.UserCredential:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.UserCredential(greycat.libs_by_name[std.name_].mapped[91], [offset, pass_])
        ...
        class Role(GreyCat.Object):
            ...
            def create(name: str, permissions: std.core.Array, greycat: GreyCat | None = None) -> std.runtime.Role:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.Role(greycat.libs_by_name[std.name_].mapped[92], [name, permissions])
        ...
        class Log(GreyCat.Object):
            ...
            def create(level: std.runtime.LogLevel, time: std.core.time, user_id: int, id: int, id2: int, src: str, tag: str, data: Any, greycat: GreyCat | None = None) -> std.runtime.Log:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.Log(greycat.libs_by_name[std.name_].mapped[93], [level, time, user_id, id, id2, src, tag, data])
        ...
        class Permission(GreyCat.Object):
            ...
            def create(name: str, description: str, greycat: GreyCat | None = None) -> std.runtime.Permission:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.Permission(greycat.libs_by_name[std.name_].mapped[94], [name, description])
        ...
        class Task(GreyCat.Object):
            ...
            def create(user_id: int, task_id: int, mod: str, type: str, fun: str, creation: std.core.time, start: std.core.time, duration: std.core.duration, status: std.runtime.TaskStatus, progress: float, greycat: GreyCat | None = None) -> std.runtime.Task:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.runtime.Task(greycat.libs_by_name[std.name_].mapped[95], [user_id, task_id, mod, type, fun, creation, start, duration, status, progress])
    ...
    class util:
        ...
        class LinearQuantizer(Generic[__T], GreyCat.Object):
            ...
            def create(min: std.util.__, max: std.util.__, bins: int, open: bool, greycat: GreyCat | None = None) -> std.util.LinearQuantizer[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.LinearQuantizer(greycat.libs_by_name[std.name_].mapped[96], [min, max, bins, open])
        ...
        class Gaussian(Generic[__T], GreyCat.Object):
            ...
            @staticmethod
            def create(sum: float, sumsq: float, count: int, min: std.util.__, max: std.util.__, greycat: GreyCat | None = None) -> std.util.Gaussian[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.Gaussian(greycat.libs_by_name[std.name_].mapped[97], [sum, sumsq, count, min, max])
        ...
        class Stack(Generic[__T], GreyCat.Object):
            ...
            def create(values: std.core.Array, greycat: GreyCat | None = None) -> std.util.Stack[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.Stack(greycat.libs_by_name[std.name_].mapped[98], [values])
        ...
        class GaussianProfile(Generic[__T], GreyCat.Object):
            ...
            def create(quantizer: std.util.Quantizer, precision: std.core.FloatPrecision, bins: std.core.Table, value_min: float, nb_rejected: int, greycat: GreyCat | None = None) -> std.util.GaussianProfile[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.GaussianProfile(greycat.libs_by_name[std.name_].mapped[99], [quantizer, precision, bins, value_min, nb_rejected])
        ...
        class ProgressTracker(GreyCat.Object):
            ...
            def create(start: std.core.time, total: int, counter: int, duration: std.core.duration, progress: float, speed: float, remaining: std.core.duration, greycat: GreyCat | None = None) -> std.util.ProgressTracker:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.ProgressTracker(greycat.libs_by_name[std.name_].mapped[100], [start, total, counter, duration, progress, speed, remaining])
        ...
        class HistogramStats(Generic[__T], GreyCat.Object):
            ...
            def whisker_low(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[2])

            def set_whisker_low(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[2], v)

            def whisker_high(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[3])

            def set_whisker_high(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[3], v)

            def percentile1(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[4])

            def set_percentile1(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[4], v)

            def percentile5(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[5])

            def set_percentile5(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[5], v)

            def percentile10(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[6])

            def set_percentile10(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[6], v)

            def percentile20(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[7])

            def set_percentile20(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[7], v)

            def percentile25(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[8])

            def set_percentile25(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[8], v)

            def percentile50(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[9])

            def set_percentile50(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[9], v)

            def percentile75(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[10])

            def set_percentile75(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[10], v)

            def percentile80(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[11])

            def set_percentile80(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[11], v)

            def percentile90(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[12])

            def set_percentile90(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[12], v)

            def percentile95(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[13])

            def set_percentile95(self, v: std.util.__) -> None:
                self._set(self.type_.generated_offsets[13], v)

            def percentile99(self) -> std.util.__:
                return self._get(self.type_.generated_offsets[14])

            def set_percentile99(self, v: std.util.__) -> None:
            ...
            @staticmethod
            def create(min: std.util.__, max: std.util.__, whisker_low: std.util.__, whisker_high: std.util.__, percentile1: std.util.__, percentile5: std.util.__, percentile10: std.util.__, percentile20: std.util.__, percentile25: std.util.__, percentile50: std.util.__, percentile75: std.util.__, percentile80: std.util.__, percentile90: std.util.__, percentile95: std.util.__, percentile99: std.util.__, sum: float, avg: std.util.__, std: std.util.__, size: int, greycat: GreyCat | None = None) -> std.util.HistogramStats[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.HistogramStats(greycat.libs_by_name[std.name_].mapped[103], [min, max, whisker_low, whisker_high, percentile1, percentile5, percentile10, percentile20, percentile25, percentile50, percentile75, percentile80, percentile90, percentile95, percentile99, sum, avg, std, size])
        ...
        class Crypto(GreyCat.Object):
            ...
            def create(greycat: GreyCat | None = None) -> std.util.Crypto:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.Crypto(greycat.libs_by_name[std.name_].mapped[104], [])
        ...
        class TimeWindow(Generic[__T], GreyCat.Object):
            ...
            def create(values: std.core.Table, span: std.core.duration, sum: float, sumsq: float, field: std.core.field, greycat: GreyCat | None = None) -> std.util.TimeWindow[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.TimeWindow(greycat.libs_by_name[std.name_].mapped[105], [values, span, sum, sumsq, field])
        ...
        class QuantizerSlotBound(Generic[__T], GreyCat.Object):
            ...
            def create(min: std.util.__, max: std.util.__, center: std.util.__, greycat: GreyCat | None = None) -> std.util.QuantizerSlotBound[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.QuantizerSlotBound(greycat.libs_by_name[std.name_].mapped[108], [min, max, center])
        ...
        class GaussianProfileSlot(GreyCat.Object):
            ...
            def create(sum: int, sumsq: int, count: int, greycat: GreyCat | None = None) -> std.util.GaussianProfileSlot:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.GaussianProfileSlot(greycat.libs_by_name[std.name_].mapped[109], [sum, sumsq, count])
        ...
        class SlidingWindow(Generic[__T], GreyCat.Object):
            ...
            def create(values: std.core.Array, span: int, sum: float, sumsq: float, field: std.core.field, greycat: GreyCat | None = None) -> std.util.SlidingWindow[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.SlidingWindow(greycat.libs_by_name[std.name_].mapped[110], [values, span, sum, sumsq, field])
        ...
        class HistogramBin(Generic[__T], GreyCat.Object):
            ...
            def bin(self) -> std.util.QuantizerSlotBound:
                return self._get(self.type_.generated_offsets[0])

            def set_bin(self, v: std.util.QuantizerSlotBound) -> None:
                self._set(self.type_.generated_offsets[0], v)
            ...
            @staticmethod
            def create(bin: std.util.QuantizerSlotBound, count: int, ratio: float, cumulative_count: int, cumulative_ratio: float, greycat: GreyCat | None = None) -> std.util.HistogramBin[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.HistogramBin(greycat.libs_by_name[std.name_].mapped[111], [bin, count, ratio, cumulative_count, cumulative_ratio])
        ...
        class Random(GreyCat.Object):
            ...
            def create(seed: int, v: float, greycat: GreyCat | None = None) -> std.util.Random:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.Random(greycat.libs_by_name[std.name_].mapped[112], [seed, v])
        ...
        class Histogram(Generic[__T], GreyCat.Object):
            ...
            @staticmethod
            def create(quantizer: std.util.Quantizer, bins: std.core.Array, nb_rejected: int, nb_accepted: int, min: std.util.__, max: std.util.__, sum: float, sumsq: float, greycat: GreyCat | None = None) -> std.util.Histogram[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.Histogram(greycat.libs_by_name[std.name_].mapped[114], [quantizer, bins, nb_rejected, nb_accepted, min, max, sum, sumsq])
        ...
        class Quantizer(Generic[__T], GreyCat.Object):
            ...
            def create(greycat: GreyCat | None = None) -> std.util.Quantizer[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.Quantizer(greycat.libs_by_name[std.name_].mapped[115], [])
        ...
        class Queue(Generic[__T], GreyCat.Object):
            ...
            def create(values: std.core.Array, capacity: int, greycat: GreyCat | None = None) -> std.util.Queue[TypeVar("T")]:
                if greycat is None:
                    greycat = GreyCat._DEFAULT
                return std.util.Queue(greycat.libs_by_name[std.name_].mapped[116], [values, capacity])
    ...
    def configure(self, loaders: dict[str, GreyCat.Loader], factories: dict[str, GreyCat.Factory]) -> None:
        ...
        factories[std.util.HistogramBin.name_] = lambda type, attributes: std.util.HistogramBin(type, attributes)
    ...
    def init(self, greycat: GreyCat) -> None:
        self.mapped: list[GreyCat.Type] = [
            ...
            greycat.types_by_name[std.util.HistogramBin.name_],
        ...
        self.mapped[70].resolve_generated_offsets("name", "value")
        self.mapped[71].resolve_generated_offsets("url", "clientId")
        self.mapped[72].resolve_generated_offsets("group_id", "type")
        self.mapped[73].resolve_generated_offsets("name", "start", "end", "company", "max_memory", "extra_1", "extra_2", "type")
        self.mapped[74].resolve_generated_offsets("id", "name", "activated", "full_name", "email", "role", "groups", "groups_flags", "external")
        self.mapped[75].resolve_generated_offset_with_values("error", None, "warn", None, "info", None, "perf", None, "trace", None)
        self.mapped[76].resolve_generated_offsets("function", "arguments")
        self.mapped[77].resolve_generated_offsets("email", "name", "first_name", "last_name", "roles", "groups")
        self.mapped[78].resolve_generated_offset_with_values("empty", None, "waiting", None, "running", None, "await", None, "cancelled", None, "error", None, "ended", None, "ended_with_errors", None)
        self.mapped[79].resolve_generated_offsets("version", "program_version", "arch", "timezone", "license", "io_threads", "bg_threads", "fg_threads", "mem_total", "mem_worker", "disk_data_bytes")
        self.mapped[80].resolve_generated_offset_with_values("community", None, "enterprise", None, "testing", None)
        self.mapped[81].resolve_generated_offsets("module", "type", "function", "src", "line", "column", "scope")
        self.mapped[82].resolve_generated_offsets("id", "name", "activated")
        self.mapped[83].resolve_generated_offsets("duration", "bytes_write_disk", "bytes_write_disk_raw", "bytes_read_disk", "bytes_read_disk_raw", "bytes_read_cache")
        self.mapped[84].resolve_generated_offsets("entities", "credentials", "fields", "keys", "keys_last_refresh")
        self.mapped[85].resolve_generated_offsets("id", "name", "activated")
        self.mapped[87].resolve_generated_offsets("id", "frames", "root")
        self.mapped[88].resolve_generated_offsets("function", "user_id", "arguments", "start", "every")
        self.mapped[89].resolve_generated_offset_with_values("read", None, "write", None, "execute", None)
        self.mapped[91].resolve_generated_offsets("offset", "pass")
        self.mapped[92].resolve_generated_offsets("name", "permissions")
        self.mapped[93].resolve_generated_offsets("level", "time", "user_id", "id", "id2", "src", "tag", "data")
