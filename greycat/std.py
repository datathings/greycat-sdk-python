...
class std(GreyCat.Library):
    ...
    def init(self, greycat: GreyCat) -> None:
        ...
        self.mapped[12].resolve_generated_offsets("x", "y")
        self.mapped[13].resolve_generated_offsets("x", "y")
        self.mapped[27].resolve_generated_offsets("size", "from", "to")
        self.mapped[37].resolve_generated_offsets("size", "from", "to")
        self.mapped[39].resolve_generated_offsets("x", "y")
        self.mapped[41].resolve_generated_offsets("size", "from", "to")
        self.mapped[59].resolve_generated_offsets("path", "pos")
        self.mapped[60].resolve_generated_offsets("min", "max", "center")
